...
/**
 * Implements the Alerter Channel for ALE.
 * @author Sun MicroSystems
 */
public class AlerterChannelProcessor implements Processor {
    ...
    public void execute(TaleRequest request) throws TaleException {
        // To Do: Implement the AlerterChannel logic here
    }
