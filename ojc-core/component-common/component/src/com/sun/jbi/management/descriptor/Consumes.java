...
public class Consumes implements EndpointIdentifier {
    ...
    Consumes(QName ifName, QName serviceName, String endpointName, String linkType) {
    ...
    Consumes(QName ifName, QName serviceName, String endpointName, String linkType, String appConfigName) {
        this.interfaceName = ifName;
        this.serviceName = serviceName;
        this.endpointName = endpointName;
        this.linkType = linkType;
