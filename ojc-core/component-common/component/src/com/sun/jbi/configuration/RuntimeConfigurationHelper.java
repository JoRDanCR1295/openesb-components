...
//        this.name = componentName;
     ...
     /**
     * Create an instance, providing an MBeanServer to use.This constructor
     * used to create a composite application specific service unit 
     * configuration mbean
     */
    public RuntimeConfigurationHelper(String componentType, String componentName, 
         MBeanServer mbeanServer,String suid) throws MalformedObjectNameException {
        super();
        this.objectName = constructObjectName(componentType, 
                componentName,suid);
        this.connection = mbeanServer;
    }
     ...
     * configuration mbean
     */
    public RuntimeConfigurationHelper(ObjectName objName, 
     ...
     * @throws MalformedObjectNameException if the resulting object name is invalid
     */
    public static ObjectName constructObjectName(String componentType, 
            String componentName, String serviceUnitId) 
