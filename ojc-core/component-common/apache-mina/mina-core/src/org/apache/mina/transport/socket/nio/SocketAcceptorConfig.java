 ...
 * @version $Rev: 471549 $, $Date: 2007/05/02 15:24:39 $
 */
public class SocketAcceptorConfig extends BaseIoAcceptorConfig
{
    ...
    public SocketAcceptorConfig()
    {
        ...
        {
            s = new ServerSocket();
			//Glassfish server is throwing null pointer exception when s.getReuseAddress() is called on the created serversocket. Forcibly setting reuseAddress to false.
