...
public class WSDLReaderImpl implements WSDLReader
{
  ...
  /**
   * Sets the entity resolver to be used
   */
            ...
            else
            {
              ...
              url = StringUtils.getURL(contextURL, locationURI);
                ...
                if (entityResolver != null) {
                    inputSource = entityResolver.resolveEntity(null, locationURI);
  	      ...
  	      else
   	      {
  	  	    ...
  	  	    location = url.toExternalForm();
                            ...
                            if (entityResolver != null) {
                                ...
                                inputSource = entityResolver.resolveEntity(null, schemaRef.getSchemaLocationURI());
                                if (inputSource != null && inputSource.getSystemId() != null) {
                                    url = contextURL.toURI().resolve(
                                            StringUtils.getURL(null,
                                                    inputSource.getSystemId()).toURI()).toURL();
