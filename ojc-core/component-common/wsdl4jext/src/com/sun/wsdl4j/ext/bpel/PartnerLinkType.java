...
/**
 * An instance of this interface represents a partner link type.
 * 
 * @author Jun Xu
...
public interface PartnerLinkType extends ExtensibilityElement {
    ...
    /**
     * Gets the qualified name of the partner link type.
     * 
     * @return the qualified name of the partner link type
     */
    QName getName();
    
    /**
     * Gets a role using an NCName.
     * 
     * @param name the NCName
     * @return An partner link role. If the named role cannot be found,
     *          <code>null</code> is returned.
     */
    PartnerLinkRole getRole(String name);
    
    /**
     * Gets a collection (at most two) of roles.
     * 
     * @return A collection (at most two) of roles. The return
     *         value is never <code>null</code>
     */
    Collection<PartnerLinkRole> getRoles();
