...
* Inclusion in CRL simplifies the component's bootstrap classpath due to
	...
	protected String t(String msg, Object... args) {
	  try {
	      ...
	      if (!matcher.matches() || matcher.groupCount() <= 1) {
	          ...
	          return (Util.isEmpty(mPrefix)) ? "I18N: "+ format(msg, args)
	        		  						 : mPrefix + ": " + format(msg, args);
	      } 
	      else {
	          ...
	          String localizedmsg;
	          try {
	              localizedmsg = mBundle.getString(msgid);
	          } catch (Exception e) {
