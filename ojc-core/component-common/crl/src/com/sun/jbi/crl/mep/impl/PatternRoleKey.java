...
import com.sun.jbi.crl.mep.ExchangeRouter.RouterKey;
 ...
 */
public enum PatternRoleKey implements RouterKey {
    ...
    PatternRoleKey(ExchangePattern pattern, Role role) {
        mPattern = pattern;
        mRole = role;
    }
    ...
    /**
     * Resolves the specified {@link MessageExchange} to a {@link PatternRoleKey} enum.
     * 
     * @param msg A message exchange.
     * @return A <code>PatternRoleKey</code> enum or <code>null</code>.
     */
    public static PatternRoleKey toKey(MessageExchange msg) {
        if (msg == null) return null;
        
        ExchangePattern patt =  ExchangePattern.valueOf(msg); 
        for (PatternRoleKey key : PatternRoleKey.values()) {
