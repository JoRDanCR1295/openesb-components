...
import com.sun.jbi.component.alerter.Event;
...
//		return buff.toString();
	...
	/** @see com.sun.jbi.component.alerter.Event#getComponentName() */
	public String getComponentName() {
		return mCompName;
	}

	/** @see com.sun.jbi.component.alerter.Event#getComponentProjectPathName() */
	public String getComponentProjectPathName() {
		return mCompProjectPath;
	}

	/** @see com.sun.jbi.component.alerter.Event#getComponentType() */
	public ComponentType getComponentType() {
		return mCompType;
	}

	/** @see com.sun.jbi.component.alerter.Event#getDeploymentName() */
	public String getDeploymentName() {
		return mDeploymentName;
	}

	/** @see com.sun.jbi.component.alerter.Event#getEnvironmentName() */
	public String getEnvironmentName() {
		return mEnvironmentName;
	}

	/** @see com.sun.jbi.component.alerter.Event#getId() */
	public long getId() {
		return mId;
	}

	/** @see com.sun.jbi.component.alerter.Event#getLogicalHostName() */
	public String getLogicalHostName() {
		return mLogicalHost;
	}

	/** @see com.sun.jbi.component.alerter.Event#getPhysicalHostName() */
	public String getPhysicalHostName() {
		return mPhysicalHost;
	}

	/** @see com.sun.jbi.component.alerter.Event#getServerName() */
	public String getServerName() {
		return mServerName;
	}

	/** @see com.sun.jbi.component.alerter.Event#getServerType() */
	public String getServerType() {
		return mServerType;
	}

	/** @see com.sun.jbi.component.alerter.Event#getTimeStamp() */
	public long getTimeStamp() {
		return mTimestamp;
	}

	/** @see com.sun.jbi.component.alerter.Event#setComponentName(java.lang.String) */
	public void setComponentName(String componentName) {
		mCompName = componentName;
	}

	/** @see com.sun.jbi.component.alerter.Event#setComponentProjectPathName(java.lang.String) */
	public void setComponentProjectPathName(String componentProjectPathName) {
		mCompProjectPath = componentProjectPathName;
	}

	/** @see com.sun.jbi.component.alerter.Event#setComponentType(com.sun.jbi.component.alerter.NotificationEvent.ComponentType) */
	public void setComponentType(ComponentType componentType) {
		mCompType = componentType;
	}

	/** @see com.sun.jbi.component.alerter.Event#setDeploymentName(java.lang.String) */
	public void setDeploymentName(String deploymentName) {
		mDeploymentName = deploymentName;
	}

	/** @see com.sun.jbi.component.alerter.Event#setEnvironmentName(java.lang.String) */
	public void setEnvironmentName(String environmentName) {
		mEnvironmentName = environmentName;
	}

	/** @see com.sun.jbi.component.alerter.Event#setLogicalHostName(java.lang.String) */
	public void setLogicalHostName(String logicalHostName) {
		mLogicalHost = logicalHostName;
	}

	/** @see com.sun.jbi.component.alerter.Event#setPhysicalHostName(java.lang.String) */
	public void setPhysicalHostName(String physicalHostName) {
		mPhysicalHost = physicalHostName;
	}

	/** @see com.sun.jbi.component.alerter.Event#setServerName(java.lang.String) */
	public void setServerName(String serverName) {
		mServerName = serverName;
	}

	/** @see com.sun.jbi.component.alerter.Event#setServerType(java.lang.String) */
	public void setServerType(String serverType) {
		mServerType = serverType;
	}

	/** @see com.sun.jbi.component.alerter.Event#setTimeStamp() */
	public void setTimeStamp() {
		setTimeStamp((new Date()).getTime());
	}

	/** @see com.sun.jbi.component.alerter.Event#setTimeStamp(long) */
