...
public class EventFactoryImpl implements EventFactory {
	...
	/** @see com.sun.jbi.component.alerter.EventFactory#createEvent() */
	public Event createEvent() {
		return new EventImpl();
	}

	/** @see com.sun.jbi.component.alerter.EventFactory#createDataConverter() */
	public EventDataConverter createDataConverter() {
		return new EventDataConverterImpl(/*this*/);
	}

	/** @see com.sun.jbi.component.alerter.EventFactory#createNotificationEvent() */
