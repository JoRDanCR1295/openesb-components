 ...
 */
public class IdentificationHandler extends JbiHandler<Identification> {
	...
	public void endElement(String uri, String localName, String name)
			throws SAXException {
		// set value
		if (localName.equals(JbiDescriptor.IDENTIFICATION_ELEM)) {
			setValue(new Identification(mName, mDescription));
		}
		else if (localName.equals(JbiDescriptor.NAME_ELEM)) {
			mName = getContent();
		}
		else if (localName.equals(JbiDescriptor.DESCRIPTION_ELEM)) {
			mDescription = getContent();
		}
	}
}
