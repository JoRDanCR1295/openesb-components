...
/**
 * Internationalization utility for common-util.
...
public class I18n extends LocalizationSupport {
	...
	protected I18n() {
		super(Pattern.compile("(UTIL-[4-7]\\d\\d\\d)(: )(.*)", Pattern.DOTALL),
			  "", null);
	}

	/**
	 * Creates a localized message for the Common Util library.
