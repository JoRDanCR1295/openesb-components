...
/**
 * Describes the binding &lt;input&gt; element.
 *
 * @author Sun Microsystems
 * @version 
 */
public interface BindingInput extends WSDLExtensibleElement {
    ...
    /** Setter for the name of the binding input element.
     * @param   name    Value of the name for binding input element.
     */
    void setName(String name);
    
    /** Setter for the name of the binding input element.
     * @param   qName   Qualified name of the binding input element.
     * @param   name    Value of the name for binding input element.
     */
