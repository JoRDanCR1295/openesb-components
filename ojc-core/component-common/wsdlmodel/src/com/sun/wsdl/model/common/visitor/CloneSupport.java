...
public class CloneSupport implements VisitorSupport {
    ...
    private static final Messages MESSAGES = 
            Messages.getMessages(CloneSupport.class);
    private static final Logger LOGGER = 
            Messages.getLogger(CloneSupport.class);
    ...
    public void cloneAttributes(XMLElement orig, XMLElement copy) {
        try {
            ...
            throw new XMLWriteVisitorException(
                MESSAGES.getString("CloneSupport.CANT_CLONE_ATTRIBS"), trw);
        }
    }
        ...
        if (origNode instanceof XMLElement) {
            ...
            if (dupElemTopOwnerDoc.getDocumentElement() != null) {
                ...
                throw new EInsightModelException(
                        MESSAGES.getString(
                        "CloneSupport.ADD_ROOT_ELEM_TO_OWNING_XML_DOC_FIRST"));
            }
        }
    }
}
