 ...
 */
public class WSDLDocumentationImpl extends WSDLElementImpl implements WSDLDocumentation {
	public WSDLDocumentationImpl(XMLDocument d) {
		 super(d);
		    initDocumentation();
    }
    ...
    private void initDocumentation() {
        setLocalName(WSDLDocumentation.TAG);
    }
