 ...
 */
public abstract class NamedWSDLElementImpl extends WSDLElementImpl implements NamedWSDLElement {
	
	/** Creates a new instance of NamedWSDLElementImpl */
    public NamedWSDLElementImpl() {
        super();
    }
     ...
     */
    public NamedWSDLElementImpl(XMLDocument d) {
        super(d);
    }
