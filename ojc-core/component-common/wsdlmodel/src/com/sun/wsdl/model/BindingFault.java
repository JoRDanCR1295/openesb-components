...
/**
 * Describes the binding operation &lt;fault&gt; element.
 *
 * @author Sun Microsystems
 * @version 
 */
public interface BindingFault extends WSDLExtensibleElement {
    ...
    /** Getter for the name of the binding fault element.
     * @return  Name of binding fault element.
     */
    String getName();
    
    /** Setter for the name of the binding fault element.
     * @param   name    Value of the name for binding fault element.
     */
