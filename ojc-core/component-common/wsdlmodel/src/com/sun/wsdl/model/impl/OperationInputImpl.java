...
/**
 * Implements the portType operation &lt;input&gt; element.
 *
...
public class OperationInputImpl
    ...
    private static Logger mLogger =
        Logger.getLogger(OperationInputImpl.class.getName());
    
    
    /**
     * Creates a new instance of OperationInputImpl.
     * @param   d   Owner document.
     */
    public OperationInputImpl(XMLDocument d) {
        super(d);
        initOperationInput();
    }
     ...
     */
    private void initOperationInput() {
        setLocalName(OperationInput.TAG);
