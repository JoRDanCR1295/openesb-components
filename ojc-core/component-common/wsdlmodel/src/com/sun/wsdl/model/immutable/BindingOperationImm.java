 ...
 * @since   5.1.0
 */
public interface BindingOperationImm extends WSDLElementImm {
     ...
     */
    BindingInputImm getBindingInput();
    
    /** Getter for the binding operation output element.
     * @return  The binding operation output element.
     */
    BindingOutputImm getBindingOutput();
    
    /** Getter for the binding operation fault element models.
     * @return Read-only list of binding operation fault element models.
     */
    List getBindingFaults();
}
