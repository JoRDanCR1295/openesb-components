...
/**
 * Describes the SOAP body extension.
 *
 * @author Sun Microsystems
 * @version 
 */
public interface SOAPBody extends ExtensibilityElement, SOAPConstants {
    ...
    /** Ordinal position for parts attribute */
    public static final int PARTS = 0;
    
    /** Ordinal position for use attribute */
    public static final int USE = PARTS + 1;
     ...
     * @return  The parts attribute.
     */
    String getParts();
    
    /** Sets the parts attribute for this SOAP body.
     * @param   parts   Value of the parts attribute.
     */
     ...
     * @param   parts   Value of the parts attribute.
     */
    void setParts(String qName, String parts);
    
    /** Gets the use attribute of this SOAP body.
     * @return  The use attribute.
     */
    String getUse();
    
    /** Sets the use attribute of this SOAP body.
    ...
    /** Gets the encoding style of this SOAP body.
     * @return  SOAP body encoding style.
     */
    String getEncodingStyle();
    
    /** Sets the encoding style of this SOAP body.
    ...
    /** Gets the namespace attribute of this SOAP body.
     * @return  The namespace attribute.
     */
    String getNamespaceURI();
    
    /** Sets the namespace attribute of this SOAP body.
