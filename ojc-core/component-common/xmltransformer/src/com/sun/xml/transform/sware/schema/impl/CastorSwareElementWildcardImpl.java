 ...
 * @version 
 */
class CastorSwareElementWildcardImpl extends CastorSwareParticleImpl
        implements SwareElementWildcard {

    private final Wildcard mWildcard;
    
    /**
     * Constructs from a castor specific wildcard declaration object.
     * @param wildcard a castor specific wildcard declaration object
     */
    CastorSwareElementWildcardImpl(Wildcard wildcard) {
        super(wildcard);
