...
public class OjcIssuesTest extends TestCase {
    ...
    public void testIssue237() {
        try {
            String fileName =
                "/com/sun/bpel/model/ojcIssuesTest/237/PM2GProcess.bpel";
            ...
            SchemaGlobalElement elem = loader.findElement(
                    new QName("http://trajet.utbm.fr/", "getTrajet"));
            assertNotNull(elem);
            SchemaType xmlType = loader.findType(
                    new QName("http://www.utbm.fr/schema/GPSPointSchema", "GPSPoint"));
