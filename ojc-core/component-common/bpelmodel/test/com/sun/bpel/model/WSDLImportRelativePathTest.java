...
/*
 * @(#)WSDLImportRelativePathTest.java 
 *
...
public class WSDLImportRelativePathTest extends TestCase {
    ...
    public void testWSDLImportedFromSubDirectory() {
        try {
            String fileName = "/com/sun/bpel/model/relativePathTest/bpelImportingWsdlFromSubDirectory.bpel";
    ...
    public void testWSDLImportedFromOneProjectToAnother() {
        try {
            String fileName = "/com/sun/bpel/model/relativePathTest/projectA/bank/bpelImportingWsdlFromProjectB.bpel";
            URL url = getClass().getResource(fileName);
            URI uri = url.toURI();
