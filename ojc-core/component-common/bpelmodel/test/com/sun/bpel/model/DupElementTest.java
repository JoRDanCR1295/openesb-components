...
public class DupElementTest extends TestCase {
    ...
    public void testCase1() {
        try {
            String fileName =
                "/com/sun/bpel/model/dupElementTest/case1/TestHL7Encoder.bpel";
            ...
            SchemaGlobalElement elem = loader.findElement(
                    new QName("urn:hl7-org:v2xml", "ADT_A01"));
            assertNotNull(elem);
            SchemaType xmlType = loader.findType(
                    new QName("urn:hl7-org:v2xml", "ADT_A01.CONTENT"));
    ...
    public void testCase2() {
        try {
            String fileName =
                "/com/sun/bpel/model/dupElementTest/case2/newProcessDocumentLiteral.bpel";
            URL url = getClass().getResource(fileName);
            URI uri = url.toURI();
            ...
            SchemaTypeLoader loader = process.getSchemaTypeLoader();
            SchemaGlobalElement elem = loader.findElement(
                    new QName("http://xml.netbeans.org/schema/newXmlSchema", "elementA"));
            assertNotNull(elem);
            SchemaType xmlType = loader.findType(
                    new QName("abc", "rpctypeA"));
            assertNotNull(xmlType);
