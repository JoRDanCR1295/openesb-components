...
public class ImportInlineSchemaTest extends TestCase {
    ...
    public void testInlineSchemasImportEachOther() {
        try {
            String fileName =
                "/com/sun/bpel/model/importInlineSchemaTest/Changer.bpel";
            ...
            SchemaType xmlType = loader.findType(
                    new QName("http://docs.oasis-open.org/wsrf/bf-2", "BaseFaultType"));
