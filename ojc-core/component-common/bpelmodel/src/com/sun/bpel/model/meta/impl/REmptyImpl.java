...
import com.sun.bpel.model.impl.EmptyImpl;
...
/**
 * Runtime Empty implementation
 *
 * @author Sun Microsystems
 */
public class REmptyImpl extends EmptyImpl implements RActivity {
    private long mUniqueID;
    private RActivity mNextAct;

    /**
     * Creates a new instance of REmptyImpl
     *
     * @param bpeldoc runtime BPEL document
     * @param id unique ID
     */
    public REmptyImpl(RBPELDocumentImpl bpeldoc, long id) {
        super(bpeldoc);
        mUniqueID = id;
    }
