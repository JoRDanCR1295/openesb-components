...
import com.sun.bpel.model.impl.AssignImpl;
 ...
 */
public class RAssignImpl extends AssignImpl implements RActivity {
    private long mUniqueID;
    private RActivity mNextAct;

    /**
     * Creates a new instance of RAssignImpl
     *
     * @param bpeldoc runtime BPEL document
     * @param id unique ID
     */
    public RAssignImpl(RBPELDocumentImpl bpeldoc, long id) {
        super(bpeldoc);
        mUniqueID = id;
    }
