...
import com.sun.bpel.model.impl.ElseIfImpl;
...
public class RElseIfImpl extends ElseIfImpl implements RActivityHolder,
RExpressionElement {
    ...
    public RElseIfImpl(RBPELDocumentImpl impl) {
    ...
    public void setXPathExpression(String expression) throws Exception {
        XpathVariablePropertyInfo varPropInfo = Utility.parseExprForVariables(
                expression, this);
