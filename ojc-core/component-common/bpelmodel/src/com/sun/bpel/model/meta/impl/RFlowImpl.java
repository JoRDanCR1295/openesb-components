...
import com.sun.bpel.model.impl.FlowImpl;
 ...
 */
public class RFlowImpl extends FlowImpl implements RActivity, RActivityHolder, RPersistable {
    private RActivity mChildAct = null;
    private long mUniqueID;
    private RActivity mNextAct;

    /**
     * Creates a new RFlowImpl object.
     *
     * @param bpeldoc runtime BPEL document
     * @param id unique ID
     */
    public RFlowImpl(RBPELDocumentImpl bpeldoc, long id) {
        super(bpeldoc);
        mUniqueID = id;
    }
