...
import com.sun.bpel.model.impl.OnAlarmImpl;
 ...
 */
public class ROnAlarmImpl extends OnAlarmImpl implements ROnAlarm, RExpressionElement {

    /** MessageManager for localized strings. */    
    private static MessageManager MESSAGES = MessageManager.getManager(ROnAlarmImpl.class);
     ...
     * @param id unique ID
     */
    public ROnAlarmImpl(RBPELDocumentImpl bpeldoc, long id) {
        super(bpeldoc);
        mUniqueID = id;
    }
    ...
    public void setChildActivity(RActivity act) {
        throw new UnsupportedOperationException(MESSAGES.getString("ROnAlarmImpl_NOT_SUPPORTED")); //$NON-NLS-1$
    }
