...
import com.sun.bpel.model.impl.RepeatUntilImpl;
...
public class RRepeatUntilImpl extends RepeatUntilImpl implements RActivity, RActivityHolder, RExpressionElement {
    ...
    public RRepeatUntilImpl(RBPELDocumentImpl impl, long id) {
