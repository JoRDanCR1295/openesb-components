...
import com.sun.bpel.model.impl.PickImpl;
...
/**
 * Runtime Pick implementation
 *
 * @author Sun Microsystems
 */
public class RPickImpl extends PickImpl implements RActivity, RPersistable {
    private long mUniqueID;
    private RActivity mNextAct;

    /**
     * Creates a new instance of RPickImpl
     *
     * @param bpeldoc runtime BPEL document
     * @param id unique ID
     */
    public RPickImpl(RBPELDocumentImpl bpeldoc, long id) {
        super(bpeldoc);
        mUniqueID = id;
    }
