...
public abstract class XMLDocumentImpl extends XMLElementImpl implements XMLDocument {
    ...
    public void setDocumentElement(XMLDocumentElement r) {
    	XMLDocumentElement oldElement = this.rootElement;
    	rootElement = r;
    	super.replaceChild(oldElement, r);
    }
    ...
    /**
     * @see com.sun.bpel.xml.common.model.XMLDocument#getBaseURI
     */
    ...
    /**
     * @see com.sun.bpel.xml.common.model.XMLDocument#setBaseURI
     */
