...
public class XmlOptions implements java.io.Serializable
{
    ...
    /**
     * By default, XmlBeans throws exception when duplicate global components
     * are encountered unless MDef namespaces are defined that cover the
     * duplicate components.  By setting this flag, all duplicate global
     * components will be ignored.  Whichever comes in first to the type
     * system being built will be the one being used.
     *  
     * @see XmlObject.Factory#parse(java.io.File, XmlOptions)
     */
    public XmlOptions setLoadIgnoreDuplicates() {
        return set(LOAD_IGNORE_DUPLICATES);
    }
    ...
    /** @exclude */
    public static final String LOAD_IGNORE_DUPLICATES          = "LOAD_IGNORE_DUPLICATES";
