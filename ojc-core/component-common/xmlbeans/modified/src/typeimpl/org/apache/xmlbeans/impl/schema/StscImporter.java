...
public class StscImporter
{
    ...
    public static class DownloadTable
    {
        ...
        private Schema downloadSchema(XmlObject referencedBy, String targetNamespace, String locationURL)
        {
            ...
            download: try
            {
                XmlObject xdoc = downloadDocument(state.getS4SLoader(), targetNamespace, absoluteURL, locationURL);
        ...
        static XmlObject downloadDocument(SchemaTypeLoader loader, String namespace, String absoluteURL, String locationURL)
                throws MalformedURLException, IOException, XmlException
        {
            StscState state = StscState.get();
            ...
            if (resolver != null)
            {
                ...
                try
                {
                    locationURL = (locationURL != null) ? locationURL : absoluteURL;
                    source = resolver.resolveEntity(namespace, locationURL);
                }
