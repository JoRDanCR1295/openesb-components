...
//         setGivenTypeSystemName(system.getName().substring(14));
    ...
    public void setOptions(XmlOptions options)
    {
        ...
        _ignoreDup = options.hasOption(XmlOptions.LOAD_IGNORE_DUPLICATES) ? true :
            !"true".equals(SystemProperties.getProperty("xmlbean.failonduplicates", "true"));
