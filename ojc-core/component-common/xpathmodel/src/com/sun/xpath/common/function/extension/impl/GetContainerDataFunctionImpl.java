...
/*
 * @(#)GetContainerDataFunctionImpl.java 
 *
 ...
 *
 */
public class GetContainerDataFunctionImpl extends XPathExtensionFunctionImpl implements GetContainerDataFunction {

	public GetContainerDataFunctionImpl(String name) {
        super(name);
    }
