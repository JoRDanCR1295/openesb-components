...
public abstract class AbstractBootstrap implements Bootstrap {
     ...
     */
    protected abstract Object initInstallMBean(ComponentContext ctx) throws JBIException;
    ...
    public void init(InstallationContext installContext) throws JBIException {
        mLogger = Util.getLogger(installContext.getContext(), 
        ...
        try {
            ...
            setMBean(initInstallMBean(installContext.getContext()));
            // register MBean
            ...
            throw error(de, "COMPTK-6001: Failed to parse component descriptor: {0}", de.getMessage());
        }
        catch (JBIException je) {
            throw error(je, "COMPTK-6002: Failed to initialize component bootstrap: {0}", je.getMessage());
        }
        catch (Exception e) {
            throw error(e, "COMPTK-6003: Failed to register component bootstrap: {0}", e.getMessage());
        }
    }
