...
public class Agent {
	...
	private static transient final Logger mLogger = Logger.getLogger(Agent.class.getName());
        ...
        private static final Messages mMessages = Messages.getMessages(Agent.class);
	/**
	 * rmi registry port
	 */
	...
	public Agent(boolean startJmxConnector) throws Exception {
		try {
			...
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0189.JMXAgent_could_not_be_started",e));
			throw e;
		}
	}
	...
	private void startRmiRegistry() throws RemoteException {
		...
		try {
			...
			registry.list();
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0190.RMIRegistry_started",rmiRegistryPort));
		} catch (RemoteException e) {
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0191.RMIRegistry_running",rmiRegistryPort));
			;
		}
	}
	...
	private void startJmxConnectorServer() throws MalformedURLException, IOException {
		...
		cs.start();
		mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0192.JMXConnectorServer_started",url));
	}
	...
	private void startHtmlAdapter() {
		try {
			...
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0193.HTMLadapter_server_started",htmlAdapterPort));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0194.cannot_start_HTML_adapter_server",htmlAdapterPort));
			// e.printStackTrace();
		}
	}
