...
public class ETLMonitor implements ETLMonitorMBean, Serializable {
    ...
    private static final Messages mMessages = Messages.getMessages(ETLMonitor.class);
    ...
    public Map deleteRecords(String anOlderThanDate) {
        ...
        try {
            ...
            if (mLoggingContextName != null) {
                mLogger.log(Level.FINE,mMessages.getString("ETLSE-F0315.entering_deleteRecords"));
            }
            ...
            if (mLoggingContextName != null) {
                mLogger.log(Level.FINE,mMessages.getString("ETLSE-F0316.exiting_deleteRecords"));
            }
        }
        return ret;
    }
    ...
    public Map truncateRecords() {
        ...
        try {
            // Set logging context for this request.
            if (mLoggingContextName != null) {
               mLogger.log(Level.FINE,mMessages.getString("ETLSE-F0317.entering_truncateRecords"));
            }
            ...
            // Notify logging system to pop our context off the stack and publish it.
            if (mLoggingContextName != null) {
                mLogger.log(Level.FINE, mMessages.getString("ETLSE-F0318.exiting_truncateRecords"));
            }
        }
        return ret;
    }
    ...
    public Map executeDetailCountQuery(String aTargetTableName, String aWhereCondition) {
        ...
        try {
            // Set logging context for this request.
            if (mLoggingContextName != null) {
                mLogger.log(Level.FINE, mMessages.getString("ETLSE-F0319.entering_executeDetailCountQuery"));
            }
            ...
            // Notify logging system to pop our context off the stack and publish it.
                mLogger.log(Level.FINE,mMessages.getString("ETLSE-F0320.exiting_executeDetailCountQuery"));
        }
    ...
    public Map executeDetailQuery(String aTargetTableName, String aWhereCondition, String aGroupBy, String anOrderBy, Integer aLimit, Integer anOffset) {
        ...
        try {
            // Set logging context for this request.
            if (mLoggingContextName != null) {
               mLogger.log(Level.FINE, mMessages.getString("ETLSE-F0321.entering_executeDetailQuery"));
            }
    ...
    public Map executeSummaryCountQuery(String aWhereCondition) {
        ...
        try {
            // 	Set logging context for this request.
            mLogger.log(Level.FINE,mMessages.getString("ETLSE-F0322.entering_executeSummaryCountQuery"));
            ...
            // Notify logging system to pop our context off the stack and publish it.
            mLogger.log(Level.FINE, mMessages.getString("ETLSE-F0323.exiting_executeSummaryCountQuery"));
        }
    ...
    public Map executeSummaryQuery(String aWhereCondition, String aGroupBy, String anOrderBy, Integer aLimit, Integer anOffset) {
        ...
        try {
            // Set logging context for this request.
            mLogger.log(Level.FINE, mMessages.getString("ETLSE-F0324.entering_executeSummaryQuery"));
            ...
            // Notify logging system to pop our context off the stack and publish it.
            mLogger.log(Level.FINE, mMessages.getString("ETLSE-F0325.exiting_executeSummaryQuery"));
        }
    ...
    public Map executeSummaryTotalQuery(String aWhereCondition) {
        ...
        try {
            // Set logging context for this request.
            mLogger.log(Level.FINE, mMessages.getString("ETLSE-F0326.entering_executeSummaryTotalQuery"));
            String summaryTableName = this.mETLMbeanConfig.getSummaryTableName();
            StringBuffer summaryQuery = new StringBuffer("SELECT ");
            ...
            // Notify logging system to pop our context off the stack and publish it.
            mLogger.log(Level.FINE, mMessages.getString("ETLSE-F0327.exiting_executeSummaryTotalQuery"));
        }
    ...
    public Map getPurgeInfo(String anOlderThanDate, String filterByTgtTable) {
        ...
        try {
            // Set logging context for this request.
            mLogger.log(Level.FINE,mMessages.getString("ETLSE-F0328.entering_getPurgeInfo"));
            // Get the summary counts
            ...
            // Notify logging system to pop our context off the stack and publish it.
            mLogger.log(Level.FINE,mMessages.getString("ETLSE-F0329.exiting_getPurgeInfo"));
        }
        return ret;
    }
    ...
    public Map getTableContent(String aTargetTableName, String aWhereCondition, String aFlag) {
        ...
        try {
            // Set logging context for this request.
            mLogger.log(Level.FINE,mMessages.getString("ETLSE-F0330.entering_getTableContent"));
            ...
            // Notify logging system to pop our context off the stack and publish it.
            mLogger.log(Level.FINE, mMessages.getString("ETLSE-F0331.exiting_getTableContent"));
        }
	...
	public synchronized void start() {
		if (isStartable().booleanValue()){		
			if (this.mMBeanServer != null) {
				...
				if (exception){
					throw new UnsupportedOperationException(mMessages.getString("ETLSE-E0475.exception_starting_connectors"));
				}else{
					this.properties.setProperty(ATTR_STATUS, STATUS_UP);					
				}
			}
		}else{
			throw new IllegalStateException(mMessages.getString("ETLSE-E0473.Cannot_Start"));
		}		
	}
	 ...
	 */
	public void restart(){
		throw new UnsupportedOperationException(mMessages.getString("ETLSE-E0474.Restart_not_supported"));
	}
	...
	public synchronized void stop(){
		if (isStoppable().booleanValue()){		
			...
			throw new IllegalStateException(mMessages.getString("ETLSE-E0476.Cannot_Stop"));
		}
	}
