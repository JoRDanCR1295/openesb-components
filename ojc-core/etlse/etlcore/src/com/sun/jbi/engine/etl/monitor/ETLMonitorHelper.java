...
public class ETLMonitorHelper {
	...
	private static transient final Logger mLogger = Logger.getLogger(ETLMonitorHelper.class.getName());
        ...
        private static final Messages mMessages = Messages.getMessages(ETLMonitorHelper.class);
	...
	public void registerMbean(EtlMapEntry etlMapEntry, String serviceUnitName) {
		...
		if (monitorConnStr == null) {
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0162.Monitoring_support"));
			return;
		}
		...
		try {
			...
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0163.Registered_mbean",objName));
		} catch (Exception e) {
	...
	public void unregisterMbean(EtlMapEntry etlMapEntry) {
		...
		try {
			if (on != null) {
				...
				mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0164.unRegistered_mbean"),on);
			}
		} catch (Exception e) {
			mLogger.log(Level.INFO,e.getMessage());	
		}
