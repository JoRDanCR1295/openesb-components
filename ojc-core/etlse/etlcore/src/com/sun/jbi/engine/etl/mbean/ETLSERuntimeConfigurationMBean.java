...
public interface ETLSERuntimeConfigurationMBean {
     ...
     */
    public void setAxiondbDataDirectory(String axiondbInstanceName) throws InvalidAttributeValueException, MBeanException;
    ...
    public void setRetryMaxInterval(int val) throws InvalidAttributeValueException, MBeanException;
    ...
    public void setAppConfigEndPointMap(Map endPointToAppConfig) throws MBeanException;
    
    public Map retrieveAppConfigEndPointMap() throws MBeanException;
        public void setExternalConnectionProvider(String spiImplClassName) throws InvalidAttributeValueException,MBeanException;
