...
public class ETLSEServiceUnitManager implements ServiceUnitManager {
    ...
    private static final Messages mMessages = Messages.getMessages(ETLSEServiceUnitManager.class);
    ...
    public String deploy(String serviceUnitName, String serviceUnitRootPath)
        ...
        mLogger.log(Level.INFO, mMessages.getString("ETLSE-I0148.Deploying_SU_Successful",new Object[]{ serviceUnitName, serviceUnitRootPath}));
        return retMsg;
    }
    ...
    public String undeploy(String serviceUnitName, String serviceUnitRootPath)
        ...
        mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0150.UnDeploying_SU_Successful",new Object[]{ serviceUnitName, serviceUnitRootPath}));
        return retMsg;
    }
    ...
    public void init(String serviceUnitName, String serviceUnitRootPath) throws DeploymentException {
        ...
        if (mDeployedId.contains(serviceUnitName)) {
            String extMsg = createExceptionMessage(mContext.getComponentName(), taskName, "FAILED",
                    "EtlSum_Init_1", serviceUnitName, mMessages.getString("ETLSE-E0407.su_Already_Deployed"),
                    null);
        ...
        try {
            ...
            for (int i=0; i<pds.length; i++) { 
                mLogger.info("ETL Provide[" + i + " ]: " + pds[i].getServiceName()+", "+pds[i].getEndpointName()); 
                String serviceName = pds[i].getServiceName().toString();
                String endPointName = pds[i].getEndpointName();
                String configName = pds[i].getApplicationConfigurationName();
                endPointMap.put(serviceName+"-"+endPointName, configName);
            }
            
            Map oldMap = this.mRuntimeConfig.retrieveAppConfigEndPointMap();
            
            oldMap.putAll(endPointMap);
            this.mRuntimeConfig.setAppConfigEndPointMap(oldMap);
                ...
                if (entry.getRole().equalsIgnoreCase(PARTNER_MYROLE)) {
                    ...
                    for (int i = 0, I = list.size(); i < I; i++) {
                        ...
                        if (partnerLink.equals(etlPartnerLink)) {
                            ...
                            mLogger.log(Level.INFO, mMessages.getString("ETLSE-I0103.Setting_outputValue",new Object[]{ etlMapEntry.getFile(), etlMapEntry.getPortType(), etlMapEntry.getOperation(), serviceName}));
                        }
                    }
                    continue;
                }
                if (entry.getRole().equalsIgnoreCase(PARTNER_PARTNERROLE)) {
                    ...
                    for (int i = 0, I = list.size(); i < I; i++) {
                        ...
                        if (partnerLink.equals(etlOutPartnerLink)) {
                            ...
                            mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0153.Set_OutboundService",new Object[]{serviceName, etlMapEntry.getFile(), etlMapEntry.getOutPortType(), etlMapEntry.getOutOperation()}));
                        }
                    }
                    continue;
                }
            ...
            this.mComponent.setETLMapEntryTable(mEtlMapEntryTable);
        } catch (Exception e) {
            String extMsg = createExceptionMessage(mContext.getComponentName(), taskName, "FAILED",
                    "EtlSeSum_Init_2", serviceUnitName, mMessages.getString("ETLSE-E0408.SU_initError"), e);
        ...
        this.queue.restore(this.mRuntimeConfig.getNonXaDSJndiName());
        mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0154.Initializing_SU_Successful",new Object[]{ serviceUnitName, serviceUnitRootPath}));
    }
        ...
        if (wsdlFiles != null) {
            for (int i = 0; i < wsdlFiles.length; i++) {
                try {
                    ...
                    mLogger.log(Level.INFO, mMessages.getString("ETLSE-I0103.Setting_outputValue",new Object[]{def.getTargetNamespace(), wsdlFiles[i].getName()}));
                } catch (Exception e) {
                    String msg = mMessages.getString("ETLSE-E0409.Unable_to_read_WSDLFile") + wsdlFiles[i] + " : " + e.getMessage();
    ...
    public void shutDown(String serviceUnitName) throws DeploymentException {
        ...
        if (!mDeployedId.contains(serviceUnitName)) {
            String extMsg = createExceptionMessage(mContext.getComponentName(), taskName, "FAILED",
                    "EtlSeSum_ShutDown_1", serviceUnitName,mMessages.getString("ETLSE-E0410.SU_has_not_been_deployed"),
                    null);
            throw new DeploymentException(extMsg);
        }
        try {
            ...
            String extMsg = createExceptionMessage(mContext.getComponentName(), taskName, "FAILED",
                    "EtlSeSum_ShutDown_2", serviceUnitName, mMessages.getString("ETLSE-E0411.SU_shutDown_error"), e);
            AlertsUtil.getAlerter().critical(extMsg,
                    ETLSELifeCycle.SHORT_DISPLAY_NAME,
                    serviceUnitName,
                    AlertsUtil.getServerType(),
        ...
        mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0157.Shuttingdown_service_unit_Successful", serviceUnitName));
    }
    ...
    public void start(String serviceUnitName) throws DeploymentException {
        ...
        mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0159.SU_Started", serviceUnitName));
    }
    ...
    public void stop(java.lang.String serviceUnitName) throws DeploymentException {
        ...
        mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0161.SU_Stopped_Successfully", serviceUnitName));
    }
