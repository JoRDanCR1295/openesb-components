...
public class MonitorClient {
	...
	private static transient final Logger mLogger = Logger.getLogger(MonitorClient.class.getName());
        private static final Messages mMessages = Messages.getMessages(MonitorClient.class);
	...
	protected String getStatus(String collabName) {
		...
		try {
			...
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0178.MonitorClient.getStatus")+ex);
		}
	...
	public SummaryTotalData getSummaryTotal(String collabName, FilterDate filter) {
		...
		try {
			...
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0179.getSummaryTotal")+e);
		}
	...
	public SummaryDataList getSummary(String collabName, FilterDate filter) {
		...
		try {
			...
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0180.getSummary")+e);
		}
	...
	public List getCollabList() {
		...
		try {
			...
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0181.getCollabList")+e);
		}
	...
	public void purge(String collab, Date olderThanDate, boolean purgeAll) {
		...
		if (purgeAll) {
			try {
				...
				mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0182.MonitorClient.purge")+e);
			}
