...
public class PipelineTask extends SimpleTask {
    ...
    private static final Messages mMessages = Messages.getMessages(PipelineTask.class);
    ...
    private SQLPart getTransformSQLPart(ETLTaskNode node) throws ETLException {
        ...
        if (transformSQLPart == null) {
            throw new ETLException(mMessages.getString("ETLSE-E0441.No_SQL_to_execute"));
        }
