...
public class CommitTask extends SimpleTask {
    ...
    private static final Messages mMessages = Messages.getMessages(CommitTask.class);
    ...
    public void handleException(ETLException ex) {
        ...
        Logger.printThrowable(Logger.ERROR, LOG_CATEGORY, this,mMessages.getString("ETLSE-E0417.exception_processing_commitTask"), ex);
    }
    ...
    public String process(ETLTaskNode node) throws ETLException {
        if (node != null) {
            ...
            throw new ETLException(mMessages.getString("ETLSE-E0418.cannot_obtain_commitList"));
        }
