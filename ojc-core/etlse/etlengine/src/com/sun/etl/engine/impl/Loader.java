...
public class Loader extends SimpleTask {
    ...
    private static final Messages mMessages = Messages.getMessages(Loader.class);
    ...
    public String process(ETLTaskNode node) throws ETLException {
		...
		mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0170.Loader",msg));
        ...
        try {
			...
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0170.Loader",successMsg));
			...
			mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0170.Loader",failureMsg));
           //node.fireETLEngineLogEvent(failureMsg, Logger.DEBUG);
            //Logger.printThrowable(Logger.DEBUG, LOG_CATEGORY, this, DN + failureMsg, ex);
            mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0170.Loader",DN + failureMsg), ex);
    ...
    private class PartitionReader implements Runnable {
        ...
        public PartitionReader(long start, long end,
            ...
            try {
				...
				mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0171.global"), ex);
        ...
        public void run() {
            ...
            try {
				...
				mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0170.Loader",insertStartMsg));
				...
				mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0170.Loader",prepStmtMsg));
                //taskNode.fireETLEngineLogEvent(prepStmtMsg, Logger.DEBUG);
                if (prepStmt == null) {
                    String errMsg = MSG_MGR.getString("MSG_extractor_invalid_insert");
					mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0170.Loader",errMsg));
                ...
                while (true) {
                    ...
                    try {
                        if (batchSize > 1) {
                            ...
                            if (localBatchSize == batchSize) {
                                ...
                                if (engineState != null && engineState.trim().equalsIgnoreCase("not-active")) { //NOI18N
                                    prepStmt.close();
                                    throw new ETLException(mMessages.getString("ETLSE-E0445.Engine_is_Inactive")); // -- engine no longer active
                                }
						...
						mLogger.log(Level.INFO,mMessages.getString("ETLSE-I0170.Loader",se.getMessage()), se);
    ...
    private class BatchProcessingConsumer implements Callable<Long> {
        ...
        public Long call() throws Exception {
            ...
            System.out.println(mMessages.getString("ETLSE-E0446.ConsumerThread_exiting"));
            return insertCount;
        }
