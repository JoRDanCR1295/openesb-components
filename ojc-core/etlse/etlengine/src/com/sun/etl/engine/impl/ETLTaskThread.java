...
public class ETLTaskThread extends TimerTask {
    ...
    private static final Messages mMessages = Messages.getMessages(ETLTaskThread.class);
    ...
    public void run() {
        ...
        if (taskType == START_TASK) {
            ...
            if (context != null) {
                ...
                Logger.print(Logger.ERROR, LOG_CATEGORY, "" + mMessages.getString("ETLSE-E0436.Couldnot_locate_statistics_object"));
            }
                    ...
                    synchronized (taskManager) {
                        if (!taskManager.isTaskThreadExists(nextTaskId)) {
                            if (taskManager.isActive()) {
                                ...
                                if (nextTask == null) {
                                    throw new RuntimeException(mMessages.getString("ETLSE-E0437.Problem_executing_eTLengine"));
                                }
                            } else {
