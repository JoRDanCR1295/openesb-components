...
public class ETLEngineImpl implements ETLEngine {
    ...
    private static final Messages mMessages = Messages.getMessages(ETLEngineImpl.class);
    ...
    public ETLTaskNode createETLTaskNode(String taskType) {
        if (START.equals(taskType) || END.equals(taskType)) {
            throw new IllegalArgumentException(mMessages.getString("ETLSE-E0427.Cannot_create_START/END_task"));
        }
    ...
    public final int exec(ETLEngineListener theExecListener) {
        ...
        try {
            ...
            //Logger.print(Logger.infoLevel(), LOG_CATEGORY, mMessages.getString("ETLSE-I0169.Starting_ETLEngineThread"));
            startThread = new ETLTaskThread(taskManager, startETLTaskNode);

            if (startThread == null) {
                throw new RuntimeException(mMessages.getString("ETLSE-E0428.Can't_instantiate_eTL"));
            }
            return 0;
        } catch (Exception t) {
    ...
    public void parseXML(Element element) throws BaseException {
        if (element == null) {
            throw new BaseException(mMessages.getString("ETLSE-E0429.null_ElementRef"));
        }
        ...
        try {
            ...
            Logger.print(Logger.ERROR, LOG_CATEGORY, mMessages.getString("ETLSE-E0430.Failed_to_parse_ConnectionDefinition"), e);
            throw new BaseException(mMessages.getString("ETLSE-E0430.Failed_to_parse_ConnectionDefinition"), e);
        }
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (persistMsg != null) {
                    ...
                    Logger.print(Logger.WARN, LOG_CATEGORY, mMessages.getString("ETLSE-W0504.setting_defaultValue"));
                }
            }
        } catch (Exception e) {
            Logger.print(Logger.ERROR, LOG_CATEGORY,mMessages.getString("ETLSE-E0431.Error_getting_the_value_from_runtimeInputs"), e);
        }
    }
