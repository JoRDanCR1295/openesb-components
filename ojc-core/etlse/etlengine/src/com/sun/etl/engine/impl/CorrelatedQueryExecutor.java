...
public class CorrelatedQueryExecutor extends SimpleTask {
    ...
    private static final Messages mMessages = Messages.getMessages(CorrelatedQueryExecutor.class);
    ...
    public void cleanUp() {
        try {
            ...
            Logger.printThrowable(Logger.WARN, LOG_CATEGORY, this.getClass().getName(),
                                     mMessages.getString("ETLSE-W0503.Exception_while_task_cleanup"), ex);
        } finally {
            super.cleanUp();
        }
    }
    ...
    public String process(ETLTaskNode node) throws ETLException {
        ...
        try {
            if (node != null) {
                ...
                throw new ETLException(mMessages.getString("ETLSE-E0419.TaskNode_is_null"));
            }
            ...
            if (!disableMonitor) {
                ...
                executionId = super.getExecutionEntryIdFromSummaryTable(node, startTime);
                //commented out till Monitoring system quality check-in
    ...
    private ResultSet selectData(ETLTaskNode node) throws BaseException {
        ...
        try {
            ...
            if (rs == null) {
                throw new ETLException(DN + mMessages.getString("ETLSE-E0423.Failed_to_get_ResultSet") + LOG_CATEGORY + mMessages.getString("ETLSE-E0424.SQL_execution_failed"));
            }
    ...
    private int updateData(ResultSet rs, String insertStmt, Connection dbCon, List types, List destsSource, ETLTaskNode node) throws Exception {
        ...
        try {
            ...
            if (rsMeta == null) {
                ...
                throw new BaseException(mMessages.getString("ETLSE-E0426.Unable_to_fetch_sourcetableMetadata"));
            }
            ...
            if (prepStmt == null) {
                ...
                throw new BaseException(mMessages.getString("ETLSE-E0444.Invalid_UPDATEstatement"));
            }
