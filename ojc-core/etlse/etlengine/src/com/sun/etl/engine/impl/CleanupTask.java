...
public class CleanupTask extends SimpleTask {
    ...
    private static final Messages mMessages = Messages.getMessages(CleanupTask.class);
        ...
        try {
            ...
            if (factory != null) {
                ...
                try {
                    ...
                    release(taskNode);
                    cleanUpAxionInstanceFolder(idbConnection);
                }
            }
    ...
    private void cleanUpAxionInstanceFolder(Connection conn) throws SQLException {
        if( conn == null ) return;
        String jdbcUrl = conn.getMetaData().getURL();
        String[] strs = jdbcUrl.split("instancedb:");
        
        if (strs != null && strs.length > 1) {
            String instancePath = strs[1];
            ...
            if (instancePath != null) {
                ...
                if (instanceFolder.exists()) {
                    ...
                    File temp = null;
                    while (true) {
                        temp = instanceFolder.getParentFile();
                        if (!temp.getName().equalsIgnoreCase("etl")) {
                            boolean deleteFlag = instanceFolder.delete();
                        } else {
                            break;
                        }
                        instanceFolder = temp;
     ...
     */
    public void handleException(com.sun.etl.exception.BaseException ex) {
    ...
    private void release(ETLTaskNode node) {
        ...
        try {
            ...
            Logger.print(Logger.ERROR, LOG_CATEGORY, DN + mMessages.getString("ETLSE-E0416.Failed_to_execute_appConn"), e);
        }
    }
