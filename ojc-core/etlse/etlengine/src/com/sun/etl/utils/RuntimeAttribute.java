...
public class RuntimeAttribute {
    ...
    private static final Messages mMessages = Messages.getMessages(RuntimeAttribute.class);
    ...
    public void parseXMLString(Element xmlElement) throws BaseException {
        ...
        try {
            ...
            throw new BaseException(mMessages.getString("ETLSE-E0467.Invalid_JDBCtype"));
        }
    }
