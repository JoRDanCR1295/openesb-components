...
public class XmlUtil {
    ...
    public static Element loadXMLFile(BufferedReader reader) {
        ...
        if (reader == null) {
            Logger.print(Logger.ERROR, LOG_CATEGORY,mMessages.getString("ETLSE-E0468.InvalidStream"));
        }
        ...
        try {
            ...
            String msg= mMessages.getString("ETLSE-E0469.Could_not_load_XML");
            Logger.printThrowable(Logger.ERROR, LOG_CATEGORY, null, msg+ reader, e);
        }
        return modelElement;
    }
    ...
    public static Element loadXMLFile(String fileName, ClassLoader classLoader) {
        ...
        if (StringUtil.isNullString(fileName)) {
            Logger.print(Logger.ERROR, LOG_CATEGORY, mMessages.getString("ETLSE-E0470.Invalid_fileName"));
        }
        ...
        try {
            ...
            if (istream == null) {
                ...
                if (istream == null) {
                    Logger.print(Logger.ERROR, LOG_CATEGORY, "configure", mMessages.getString("ETLSE-E0471.configureERROR")+ fileName);
                    return null;
                }
            }
            ...
            Logger.printThrowable(Logger.ERROR, LOG_CATEGORY, null, mMessages.getString("ETLSE-E0473.Couldnot_Load")+ fileName, e);
        } finally {
            if (istream != null) {
                try {
                    istream.close();
    ...
    public static Element transform(URL xslFileUrl, Element sourceElem) throws BaseException {
        try {
            ...
            throw new BaseException(mMessages.getString("ETLSE-E0472.cannot_transform_sourceDocument"), th);
        }
