...
public class Logger {
    ...
    private static final Messages mMessages = Messages.getMessages(Logger.class);
    /**
     * Log Debug messages
     */
     ...
     */
    private static final String DEFAULT_CONFIG_FILE = "com/sun/etl/utils/logger.xml";
        ...
        try {
            ...
            if (cfgClass != null) {
                ...
                if ("debug".equalsIgnoreCase(System.getProperty("run.mode"))) {
                    System.out.println(mMessages.getString("ETLSE-I0174.read_configurationFile"));
                }

                Method configureAndWatch = cfgClass.getMethod("configureAndWatch", new Class[] { String.class});
                if (url == null) {
                    System.out.println(mMessages.getString("ETLSE-I0172.configFile_not_found") + configFile + mMessages.getString("ETLSE-I0173.Using_search"));
            ...
            System.out.println(mMessages.getString("ETLSE-I0171.Error_configure_Log4Jlogger"));
