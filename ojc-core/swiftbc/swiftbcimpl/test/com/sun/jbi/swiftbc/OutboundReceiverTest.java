...
public class OutboundReceiverTest extends MockObjectTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        runtimeConfig = mock(RuntimeConfiguration.class, new Class[] { String.class },
                new Object[] { "test/com/sun/jbi/swiftbc/testDir" });
        ...
        instance = new OutboundReceiver((ComponentContext) componentContext.proxy(),
                (DeliveryChannel) deliveryChannel.proxy(), Collections.unmodifiableCollection(new HashMap().values()),
    ...
    /**
     * Test of setThreads method, of class com.sun.jbi.swiftbc.OutboundReceiver.
     */
    ...
    /**
     * Test of stopReceiving method, of class com.sun.jbi.swiftbc.OutboundReceiver.
     */
