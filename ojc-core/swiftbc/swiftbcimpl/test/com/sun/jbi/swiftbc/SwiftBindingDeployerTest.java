 ...
 * @author Raghunadh
 */
public class SwiftBindingDeployerTest extends org.jmock.cglib.MockObjectTestCase {
    SwiftBindingDeployer instance = null;

    Mock componentContext = mock(ComponentContext.class);

    Mock lifeCycle = mock(SwiftBindingComponent.class);

    public SwiftBindingDeployerTest(String testName) {
        super(testName);
    }

    protected void setUp() throws Exception {
        instance = new SwiftBindingDeployer((ComponentContext) componentContext.proxy(),
                (SwiftBindingComponent) lifeCycle.proxy());
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(SwiftBindingDeployerTest.class);

        return suite;
    }

    /**
     * Test of deploy method, of class com.sun.jbi.swiftbc.SwiftBindingDeployer.
     */
    public void testDeploy() throws Exception {
		System.out.println("Testing deploy");
        
        RuntimeConfiguration runtimeConfig = new RuntimeConfiguration("test/com/sun/jbi/swiftbc/testDir");
        ...
        String result = instance.deploy("testSUId", "test/com/sun/jbi/swiftbc/packaging/descriptors");
        assertNotNull(result);
    }

    /**
     * Test of init method, of class com.sun.jbi.swiftbc.SwiftBindingDeployer.
     */
    public void testInit() throws Exception {
        ...
        InboundReceiver inboundReceiver = new InboundReceiver((ComponentContext) componentContext.proxy(),
                (DeliveryChannel) mock(DeliveryChannel.class).proxy(), new RuntimeConfiguration(
                        "test/com/sun/jbi/swiftbc/testDir"));
        HashMap serviceUnits = new HashMap();
        lifeCycle.expects(once()).method("getStatusProviderHelper").will(returnValue(statusHelper));
        lifeCycle.expects(once()).method("getInboundReceiver").will(returnValue(inboundReceiver));
		lifeCycle.expects(once()).method("getRuntimeConfigurationMBean").will(returnValue(runtimeConfig));
        try {
            instance.init("testSUId", "test/com/sun/jbi/swiftbc/packaging/descriptors");
    ...
    /**
     * Test of start method, of class com.sun.jbi.swiftbc.SwiftBindingDeployer.
     */
    ...
    /**
     * Test of stop method, of class com.sun.jbi.swiftbc.SwiftBindingDeployer.
     */
    ...
    /**
     * Test of shutDown method, of class com.sun.jbi.swiftbc.SwiftBindingDeployer.
     */
    ...
    /**
     * Test of undeploy method, of class com.sun.jbi.swiftbc.SwiftBindingDeployer.
     */
