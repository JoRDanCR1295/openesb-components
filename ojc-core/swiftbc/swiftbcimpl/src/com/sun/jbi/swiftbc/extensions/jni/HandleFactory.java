...
/**
 * Wrapper class for the SAG C++ HandleFactory class
...
public class HandleFactory {
     ...
     * Caller needs to create the object from static method newFactory().
     */
     ...
     */
    public static native HandleFactory newFactory(String configFile)
        throws ExcStatus;
     ...
     * @throws ExcStatus on error
     */
    public native HandleClient newHClient(long timeout) throws ExcStatus;

    /**
     * Method newHServer.
     * @param messagePartner String
     * @return HandleServer
     * @throws ExcStatus on error
     */
    public native HandleServer newHServer(String messagePartner)
        throws ExcStatus;
     ...
     *
     * @param        env the environment variable in the form of
     * "envVariable=value"
     */
    public static native void setEnvVar(String env);
     ...
     */
    public static native String getEnvVar(String var);
