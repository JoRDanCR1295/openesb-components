...
/**
 * Wrapper class for C++ SAGJNINamedItemList class
 ...
 */
public class SAGJNINamedItemList implements SwiftNamedItemList{
    /** 
    ...
    /**
     * 
     * Creates a new instance of SAGJNINamedItemList
     */
    public SAGJNINamedItemList() {
        this.peer = alloc();
    }
     ...
     * @return int
     */
    public native int getNumberOfItem();
     ...
     * @return SAGNamedItem
     */
    public native SwiftNamedItem getNamedItem(int item);
     ...
     * @return SAGNamedItem
     */
    public native SwiftNamedItem getNamedItem(String itemName);

    /**
     * Method insert.
     * 
     * @param item SAGNamedItem
     */
    public native void insert(SwiftNamedItem item);

    /**
     * Method destroy.
     * @param item int
     */
    public native void destroy(int item);

    /**
     * Method destroy.
     * @param itemName String
     */
    public native void destroy(String itemName);
