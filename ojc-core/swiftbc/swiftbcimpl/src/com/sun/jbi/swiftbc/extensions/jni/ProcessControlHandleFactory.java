...
/**
 * Wrapper class for SAG C++ HandleFactory for SagProcessControl
 ...
 *
 */
public class ProcessControlHandleFactory {
     ...
     */
    private ProcessControlHandleFactory() {}
     ...
     * @return ProcessControlHandleFactory
     * @throws ExcStatus on error
     */
    public static native
        ProcessControlHandleFactory newFactory(String configFile)
        throws ExcStatus;
     ...
     * @exception    ExcStatus if any error occurs
     */
    public native Handle newHandle() throws ExcStatus;
