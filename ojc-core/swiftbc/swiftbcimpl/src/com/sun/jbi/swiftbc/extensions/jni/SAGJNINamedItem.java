...
/**
 * Wrapper class for SAG C++ SAGJNINamedItem class
 ...
 */
public class SAGJNINamedItem implements SwiftNamedItem {
    /** 
     ...
     * @param name String
     */
    public native void setItemName(String name);

    /**
     * Method setItemValue.
     * @param value String
     */
    public native void setItemValue(String value);

    /**
     * Method setNamedItemList.
     * 
     * @param itemList SAGNamedItemList
     */
    public native void setNamedItemList(SwiftNamedItemList itemList);
     ...
     * @return String
     */
    public native String getItemValue();
     ...
     * @return boolean
     */
    public native boolean isItemList();
