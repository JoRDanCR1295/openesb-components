...
/**
 * Wrapper class for SAG C++ Header class
...
public class Header {
    ...
    public native void setUserId(String sUserId);
    public native String getUserId();
    public native void setUserAuthentication(String sUserAuthentication);
    public native String getUserAuthentication();
    public native void setLogApplicationId(String sLogApplicationId);
    public native String getLogApplicationId();

    public native void setPrimitive(String sPrimitive);
    public native String getPrimitive();

    public native boolean getCompatMode();
