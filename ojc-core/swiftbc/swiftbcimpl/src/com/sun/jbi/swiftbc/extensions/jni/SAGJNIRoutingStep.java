...
/**
 * Wrapper class for SAG C++ SAGJNIRoutingStep class.
 * It is derived from sagappltypes.hpp.
 * 
 * 
 * 
 * @author Harry Liu (harry.liu@sun.com)
 * @version cvs revision: $Revision: 1.2 $   Last Modified: $Date: 2007/05/11 15:36:03 $
 * @deprecated 
 */
//newly-added for eway 51x for completeness although it's deprecated from native api
public class SAGJNIRoutingStep implements SwiftRoutingStep{
    /** 
    ...
    /**
     * 
     * Creates a new instance of SAGJNIRoutingStep
     */
    public SAGJNIRoutingStep() {
        this.peer = alloc();
    }

    public SAGJNIRoutingStep(SAGJNIRoutingStep orig) {
        this.peer = orig.peer;
    }
    ...
    public native void setVisit(int visit);
    public native int getVisit();
    public native void setPlugIn(String sPlugIn);
    public native String getPlugIn();
    public native void setPrimitive(String sPrimitive);
