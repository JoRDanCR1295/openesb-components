...
import com.sun.soabi.snmpmonitor2.Stats;
 ...
 * @author fkieviet
 */
public class Remote2Test extends TestCase {
    ...
    public Remote2Test(String testName) {
        super(testName);
    }
    ...
    public void testV1TrapWithMultipleQuerySyncPoint() throws Throwable {
        ...
        Stats before = ProcEng2.getStats();
        ...
        // Test with multiple sockets
        {
            ...
            for (;;) {
                Thread.sleep(1000);
                Stats current =  ProcEng2.getStats();
