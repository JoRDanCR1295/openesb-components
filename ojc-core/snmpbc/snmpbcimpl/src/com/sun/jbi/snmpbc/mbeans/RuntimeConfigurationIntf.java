...
/**
 * Runtime MBean interface
 *
 * @author echou
 */
public interface RuntimeConfigurationIntf {
    
    // configuration for InboundThreadPool, BC -> NMR
    public int getInboundThreadPoolMaxSize();
    public void setInboundThreadPoolMaxSize(int val) throws Exception;
    public int getInboundThreadPoolCoreSize();
    public void setInboundThreadPoolCoreSize(int val) throws Exception;
    public long getInboundThreadPoolKeepAliveInMillis();
    public void setInboundThreadPoolKeepAliveInMillis(long val) throws Exception;
    public long getInboundBatchSize();
    public void setInboundBatchSize(long val) throws Exception;
    

    // configuration for OutboundThreadPool, NMR -> BC
    public int getOutboundThreadPoolMaxSize();
    public void setOutboundThreadPoolMaxSize(int val) throws Exception;
    public int getOutboundThreadPoolCoreSize();
    public void setOutboundThreadPoolCoreSize(int val) throws Exception;
    public long getOutboundThreadPoolKeepAliveInMillis();
    public void setOutboundThreadPoolKeepAliveInMillis(long val) throws Exception;
    
    // test mbean
    public boolean getTestMode();
    public void setTestMode(boolean val) throws Exception;
