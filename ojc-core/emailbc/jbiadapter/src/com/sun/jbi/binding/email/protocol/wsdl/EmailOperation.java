 ...
 */
public abstract class EmailOperation implements ExtensibilityElement, Serializable {
    private static final long serialVersionUID = 1L;
    private Boolean isRequired = Boolean.TRUE;
    private EmailOperationInput input = null;
    ...
    public EmailOperationInput getInput() {
        return input;
    }

    public void setInput(EmailOperationInput input) {
        this.input = input;
    }
