...
public class Provides implements EndpointIdentifier {
    ...
    public Provides(QName ifName, QName serviceName, String endpointName) {
        this.interfaceName = ifName;
        this.serviceName = serviceName;
        this.endpointName = endpointName;
    }
    
    public Provides(QName ifName, QName serviceName, String endpointName, String appConfigName) {
        this.interfaceName = ifName;
        this.serviceName = serviceName;
        this.endpointName = endpointName;
