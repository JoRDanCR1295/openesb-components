...
public class WSDLEndpoint implements ServiceUnitConfig {
     ...
     */
    public Collection<InboundConfiguration> getInboundsConfigs(){
    	return inboundConfigs.values();
    }
    
    public InboundConfiguration findInboundConfig(String listenerName,  MediaType contentType, List<MediaType> acceptMediaTypes, String method, String path) {
