...
import com.sun.jbi.execbc.packaging.EndpointConfigurationSUDescriptor;
import com.sun.jbi.execbc.packaging.EndpointConfigurationSUDescriptorTest;
...
public class EndpointConfigurationSUDescriptorTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        instance = new EndpointConfigurationSUDescriptor("test/com/sun/jbi/execbc/packaging/descriptors");
    }
    ...
    /**
     * Test of addEndpoint method, of class com.sun.jbi.execbc.packaging.EndpointConfigurationSUDescriptor.
     */
    public void testAddEndpoint() {
        System.out.println("Testing addEndpoint");
        
        EndpointData p = new EndpointDataImpl("{http://localhost/execbctest/FileOut}portTypeFileOut", 
                                              "{http://localhost/execbctest/FileOut}serviceFileOut",
                                              "portFileOut",
                                               1);
        instance.addEndpoint(p);
        p = new EndpointDataImpl("{http://localhost/execbctest/FileIn}portTypeFileIn", 
                                 "{http://localhost/execbctest/FileIn}portTypeFileIn",
                                 "portFileIn",
                                  0);
        instance.addEndpoint(p);
    ...
    /**
     * Test of endpoints method, of class com.sun.jbi.execbc.packaging.EndpointConfigurationSUDescriptor.
     */
