 ...
 * @author sweng
 */
public class ExecOutputTest extends TestCase {
    ExecOutput instance = new ExecOutput();
    
    public ExecOutputTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(ExecOutputTest.class);
