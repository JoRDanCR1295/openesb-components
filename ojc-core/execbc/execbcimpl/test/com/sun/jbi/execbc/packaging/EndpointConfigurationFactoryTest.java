...
public class EndpointConfigurationFactoryTest extends TestCase {
    ...
    /**
     * Test of getEndpointConfiguration method, of class com.sun.jbi.execbc.packaging.EndpointConfigurationFactory.
     */
    public void testGetEndpointConfiguration() throws Exception {
        System.out.println("Testing getEndpointConfiguration");
        
        String suRootDir = new File("test/com/sun/jbi/execbc/packaging/descriptors").getAbsolutePath();
