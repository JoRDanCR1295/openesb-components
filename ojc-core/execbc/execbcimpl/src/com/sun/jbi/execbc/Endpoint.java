...
public interface Endpoint {
    ...
    public interface EndpointMessageType {
        public static final String IN_OUT = "inout";  // inout is not supported
                                                      // by Exec BC. Leave the
                                                      // constant here for
    ...
    void setExecAddress(ExecAddress address);
    
    ExecBinding getExecBinding();
    
    void setExecBinding(ExecBinding binding);
    
    Map getExecOperations();
    
    void setExecOperations(Map operations);
