 ...
 * @author Raghunadh
 */
public class HL7BindingTest extends TestCase {
    HL7Binding instance = null;

    public HL7BindingTest(String testName) {
        super(testName);
    }

    protected void setUp() throws Exception {
        instance = new HL7Binding();
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(HL7BindingTest.class);

        return suite;
    }

    /**
     * Test of setElementType and getElementType method, of class com.sun.jbi.hl7bc.extensions.HL7Binding.
     */
    public void testSetGetElementType() {
        ...
        QName expResult = new QName("http://schemas.sun.com/jbi/wsdl-extensions/hl7/", Constants.ELEM_BINDING);
        QName result = instance.getElementType();
        assertEquals(expResult, result);

        // 2. testing setElementType
        QName val = new QName("http://my-hl7-binding/test", Constants.ELEM_BINDING);
        expResult = new QName("http://my-hl7-binding/test", Constants.ELEM_BINDING);
    ...
    /**
     * Test of setRequired and getRequired method, of class com.sun.jbi.hl7bc.extensions.HL7Binding.
     */
