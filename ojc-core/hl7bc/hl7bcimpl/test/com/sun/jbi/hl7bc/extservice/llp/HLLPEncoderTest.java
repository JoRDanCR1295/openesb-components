 ...
 * @author traghuna
 */
public class HLLPEncoderTest extends org.jmock.cglib.MockObjectTestCase {
    HLLPEncoder instance =new HLLPEncoder();
    
  
    
    public HLLPEncoderTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(HLLPEncoderTest.class);
