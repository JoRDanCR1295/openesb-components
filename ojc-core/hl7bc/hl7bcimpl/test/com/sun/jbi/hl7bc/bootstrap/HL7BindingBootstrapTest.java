 ...
 * @author sweng
 */
public class HL7BindingBootstrapTest extends org.jmock.cglib.MockObjectTestCase {
    HL7BindingBootstrap instance = null;
    ...
    public HL7BindingBootstrapTest(String testName) {
        super(testName);
    }

    protected void setUp() throws Exception {
        instance = new HL7BindingBootstrap();
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(HL7BindingBootstrapTest.class);
        
        return suite;
    }

    /**
     * Test of init method, of class com.sun.jbi.hl7bc.bootstrap.HL7BindingBootstrap.
     */
    public void testInit() throws Exception {
        System.out.println("Testing init");

		String installRoot = "test/com/sun/jbi/hl7bc/bootstrap";

        // 1. testing the success scenario
        context.expects(atLeastOnce()).method("getContext").will(returnValue(componentContext.proxy()));
        componentContext.expects(atLeastOnce()).method("getLogger").with(eq(HL7BindingBootstrap.class.getName()),
                eq("com.sun.jbi.hl7bc.bootstrap.messages.Bundle")).will(
                returnValue(Logger.getLogger(HL7BindingBootstrap.class.getName(),
                        "com.sun.jbi.hl7bc.bootstrap.messages.Bundle")));
        componentContext.expects(atLeastOnce()).method("getLogger").with(
                eq("com.sun.jbi.hl7bc.bootstrap.InstallerExt"), eq("com.sun.jbi.hl7bc.bootstrap.messages.Bundle")).will(
                returnValue(Logger.getLogger("com.sun.jbi.hl7bc.bootstrap.InstallerExt",
                        "com.sun.jbi.hl7bc.bootstrap.messages.Bundle")));
    ...
    /**
     * Test of onInstall method, of class com.sun.jbi.hl7bc.bootstrap.HL7BindingBootstrap.
     */
...
//        componentContext.expects(atLeastOnce()).method("getMBeanServer").will(returnValue(mbServer.proxy()));
//        componentContext.expects(once()).method("getWorkspaceRoot").will(returnValue("test/com/sun/jbi/hl7bc/testDir"));
...
//    }
    ...
    /**
     * Test of cleanUp method, of class com.sun.jbi.hl7bc.bootstrap.HL7BindingBootstrap.
     */
