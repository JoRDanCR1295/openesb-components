...
public interface RuntimeConfigurationMBean {
    ...
    /**
     * MBean Getter for the attribute "DatabaseJNDIName"
     * 
     * @return JNDI Name
     */
    ...
    /**
     * MBean Setter for the attribute "DatabaseJNDIName"
     * 
    ...
    public void setDefaultMaxTimeToWaitForAResponse(Integer theValue) throws InvalidAttributeValueException, MBeanException;
