...
import com.sun.jbi.hl7bc.extservice.ack.hl7v21.*;
...
/**
 * This class builds and return HL7 v2.1 compliant ACK
 * 
 * @author S. Nageswara Rao, Raghunadh Teegavarapu
 */

public class HL7v21ACKBuilder implements ACKBuilder, HL7Constants {
   ...
   /* static {
    ...
    public Document buildACK() throws Exception {
        ...
        // objects composed of classes from the com.sun.jbi.hl7bc.extservice.ack.hl7v21 package.
    ...
    private ERRCONTENT buildERR() throws Exception {
        ...
        /* if(mErrCode != null && !mErrCode.equals("")) {
            sb.append(mErrCode).append("&");
        } */
        if(mErrMsg != null &&  !mErrMsg.equals("")) {
            sb.append(mErrMsg);
        }
        err1Content.setValue(sb.toString());
