 ...
 */
public class HL7BCPerformanceMeasurement implements PerformanceMeasurement {

    public static final String HL7_BC_SOURCE_FILTER = ".*hl7bc.*";
    ...
    public TabularData getPerformanceInstrumentationMeasurement(String endpoint) throws OpenDataException, MBeanException {
        ...
        gr.addPattern(HL7_BC_SOURCE_FILTER, endpoint, getPerfCatFilter());
        return gr.fetchData();
    }
    ...
    private String getPerfCatFilter() {
        ...
        for (int i=0; i < HL7BindingComponent.HL7BC_PERF_CATEGORIES.length; i++) {
            perfCatFilter.append(HL7BindingComponent.HL7BC_PERF_CATEGORIES[i]);
            if (i < HL7BindingComponent.HL7BC_PERF_CATEGORIES.length-1) {
