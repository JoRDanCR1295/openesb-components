...
public class AppConfigSBCharField extends ApplicationConfigurationField {
    private static final String INITIAL_VALUE = HL7ProtocolProperties.START_BLOCk_CHAR.toString();
    
    private Integer value = Integer.valueOf(INITIAL_VALUE);

    AppConfigSBCharField() {
        super("startBlockCharacter", "Start Block Char", SimpleType.INTEGER);
    }
    ...
    public Object clone() {
    	AppConfigSBCharField clone = new AppConfigSBCharField();
    ...
    public Object[] validate(Object value) {
        ...
        if (value != null) {
            ...
            if (val < 1 || val > 127) {
                ret = new String[]{
                        null,
                        "Invalid value " + val + ". Valid inclusive range is between 1 and 127. Should be specified in decimal. Default is " + HL7ProtocolProperties.START_BLOCk_CHAR
                };
            }
        }
