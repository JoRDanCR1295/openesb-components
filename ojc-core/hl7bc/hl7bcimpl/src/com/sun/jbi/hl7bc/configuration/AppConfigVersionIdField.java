...
public class AppConfigVersionIdField extends ApplicationConfigurationField {

    private String value = HL7ProtocolProperties.PROCESSING_ID;

    AppConfigVersionIdField() {
        super("versionID", "Version Id", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigVersionIdField clone = new AppConfigVersionIdField();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.VERSION_ID;
            corrected = true;
        } else {
