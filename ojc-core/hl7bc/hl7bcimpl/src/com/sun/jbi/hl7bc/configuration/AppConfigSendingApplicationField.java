...
public class AppConfigSendingApplicationField extends
		ApplicationConfigurationField {
    private String value = HL7ProtocolProperties.SENDING_APPLICATION;

    AppConfigSendingApplicationField() {
        super("sendingApplication", "Sending Application", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigSendingApplicationField clone = new AppConfigSendingApplicationField();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.SENDING_APPLICATION;
            corrected = true;
        } else {
