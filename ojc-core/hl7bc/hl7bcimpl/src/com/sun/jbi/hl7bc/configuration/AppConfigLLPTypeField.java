...
public class AppConfigLLPTypeField extends ApplicationConfigurationField {
    private String value = HL7ProtocolProperties.MLLPV1;

    AppConfigLLPTypeField() {
        super("llpType", "LLP Type", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigLLPTypeField clone = new AppConfigLLPTypeField();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.MLLPV1;
            corrected = true;
        } else {
            value =data.toString();
            corrected = true;
    ...
    public void setValue(Object value) throws ClassCastException {
        this.value = (value != null ? value.toString() : HL7ProtocolProperties.MLLPV1);
    }
