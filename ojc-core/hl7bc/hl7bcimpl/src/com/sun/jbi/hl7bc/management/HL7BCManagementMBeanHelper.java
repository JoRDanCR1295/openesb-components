...
/*
 * @(#)HL7BCManagementMBeanHelper.java
 *
...
/**
 * Helper class to handle HL7 BC management MBean
 
 * @author sweng
 */
public class HL7BCManagementMBeanHelper {
    ObjectName mObjName;
     ...
     */
    public HL7BCManagementMBeanHelper(ObjectName objName, MBeanServer mbeanServer) throws MalformedObjectNameException {
        mObjName = objName;
    ...
    /**
     * Register the management MBean for HL7 BC
    ...
    /**
     * Unregister the management MBean for HL7 BC
     * Note that to catch all JMX related exception one can use JMException
     */
