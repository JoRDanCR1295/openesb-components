...
public class AppConfigSoftProdInfoField extends ApplicationConfigurationField {
    private String value = HL7ProtocolProperties.SOFTWARE_PRODUCT_INFORMATION;

    AppConfigSoftProdInfoField() {
        super("softwareProductInformation", "Software Product Information", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigSoftProdInfoField clone = new AppConfigSoftProdInfoField();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.SOFTWARE_PRODUCT_INFORMATION;
            corrected = true;
        } else {
