...
@XmlType(name = "SFT.CONTENT", namespace = "urn:hl7-org:v2xml", propOrder = {
    "sft1",
    "sft2",
    "sft3",
    "sft4",
...
public class SFTCONTENT {
    ...
    @XmlElement(name = "SFT.1", namespace = "urn:hl7-org:v2xml", required = true)
    protected SFT1CONTENT sft1;
    @XmlElement(name = "SFT.2", namespace = "urn:hl7-org:v2xml", required = true)
    protected SFT2CONTENT sft2;
    @XmlElement(name = "SFT.3", namespace = "urn:hl7-org:v2xml", required = true)
    protected SFT3CONTENT sft3;
    @XmlElement(name = "SFT.4", namespace = "urn:hl7-org:v2xml", required = true)
    protected SFT4CONTENT sft4;
    @XmlElement(name = "SFT.5", namespace = "urn:hl7-org:v2xml")
    protected SFT5CONTENT sft5;
    @XmlElement(name = "SFT.6", namespace = "urn:hl7-org:v2xml")
