...
public class XmlUtil {
	 ...
	 */
	public static Document createDocument(boolean namespaceAware,
			InputSource source) throws SAXException, IOException, Exception {
		DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
	...
	public static Document createDocumentFromXML(boolean namespaceAware,
			String xml) throws SAXException, IOException, Exception {
		return createDocument(namespaceAware, new InputSource(new StringReader(
				xml)));
	}
	 ...
	 * @exception exception upon error
	 */
	public static byte[] transformToBytes(Node node, String encoding,
	 ...
	 * @exception exception upon error
	 */
	public static String transformToString(Node node, String encoding,
			boolean omitXMLDeclaration) throws Exception {
		String xmlData = null;
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
	 ...
	 */
	public static byte[] transformToBytes(Node node, String encoding,
			boolean omitXMLDeclaration, String method) throws Exception {
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
	 ...
	 */
	public static String transformToString(Node node, String encoding,
			boolean omitXMLDeclaration, String indent, String method)
			throws Exception {
		String xmlData = null;
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
	...
	public static DOMResult transformToDOMResult(Transformer trans,
