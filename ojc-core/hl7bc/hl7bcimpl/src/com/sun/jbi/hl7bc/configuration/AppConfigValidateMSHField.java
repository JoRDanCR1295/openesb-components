...
public class AppConfigValidateMSHField extends ApplicationConfigurationField{
    private Boolean value = false;

    AppConfigValidateMSHField() {
        super("validateMSH", "Validate MSH", SimpleType.BOOLEAN);
    }
    ...
    public Object clone() {
    	AppConfigValidateMSHField clone = new AppConfigValidateMSHField();
