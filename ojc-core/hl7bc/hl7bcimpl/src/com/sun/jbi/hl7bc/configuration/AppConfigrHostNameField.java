...
/**
 * Application Configuration field for Host Name.
 * 
 * @author Noel.Ang@sun.com
 */
final class AppConfigrHostNameField extends ApplicationConfigurationField {
    private String value = "";

    AppConfigrHostNameField() {
        super("hostName", "Host Name", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigrHostNameField clone = new AppConfigrHostNameField();
