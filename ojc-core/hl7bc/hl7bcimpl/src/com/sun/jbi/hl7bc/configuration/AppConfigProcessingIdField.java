...
public class AppConfigProcessingIdField extends ApplicationConfigurationField {
    private String value = HL7ProtocolProperties.PROCESSING_ID;

    AppConfigProcessingIdField() {
        super("processingID", "Processing Id", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigProcessingIdField clone = new AppConfigProcessingIdField();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.PROCESSING_ID;
            corrected = true;
        } else {
