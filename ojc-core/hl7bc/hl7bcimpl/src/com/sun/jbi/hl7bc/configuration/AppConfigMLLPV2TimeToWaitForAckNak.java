...
public class AppConfigMLLPV2TimeToWaitForAckNak extends
    ...
    AppConfigMLLPV2TimeToWaitForAckNak() {
        super("mllpv2TimeToWaitForAckNak", "MLLPV2 Time to Wait For Ack/Nak", SimpleType.INTEGER);
    }
    ...
    public Object clone() {
    	AppConfigMLLPV2TimeToWaitForAckNak clone = new AppConfigMLLPV2TimeToWaitForAckNak();
