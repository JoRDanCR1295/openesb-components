...
public class AppConfigSeqNumEnabledField extends ApplicationConfigurationField {
    private Boolean value = false;

    AppConfigSeqNumEnabledField() {
        super("seqNumEnabled", "Sequence Number", SimpleType.BOOLEAN);
    }
    ...
    public Object clone() {
    	AppConfigSeqNumEnabledField clone = new AppConfigSeqNumEnabledField();
