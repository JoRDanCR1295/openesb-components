...
public class AppConfigSendingFacilityField extends ApplicationConfigurationField{
    private String value = HL7ProtocolProperties.SENDING_FACILITY;

    AppConfigSendingFacilityField() {
        super("sendingFacility", "Sending Facility", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigSendingFacilityField clone = new AppConfigSendingFacilityField();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.SENDING_FACILITY;
            corrected = true;
        } else {
