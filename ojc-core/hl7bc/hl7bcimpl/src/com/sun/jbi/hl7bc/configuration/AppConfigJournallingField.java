...
public class AppConfigJournallingField extends ApplicationConfigurationField{
    private Boolean value = false;

    AppConfigJournallingField() {
        super("journallingEnabled", "Journalling Enabled", SimpleType.BOOLEAN);
    }
    ...
    public Object clone() {
    	AppConfigJournallingField clone = new AppConfigJournallingField();
