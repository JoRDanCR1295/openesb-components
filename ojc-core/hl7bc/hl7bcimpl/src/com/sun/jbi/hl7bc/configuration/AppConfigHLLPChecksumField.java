...
public class AppConfigHLLPChecksumField extends ApplicationConfigurationField {
    private Boolean value = false;

    AppConfigHLLPChecksumField() {
        super("hllpChecksumEnabled", "HLLP Checksum", SimpleType.BOOLEAN);
    }
    ...
    public Object clone() {
    	AppConfigHLLPChecksumField clone = new AppConfigHLLPChecksumField();
