...
public class AppConfigSoftVendorOrgField extends ApplicationConfigurationField {
    private String value = HL7ProtocolProperties.SOFTWARE_VENDOR_ORGANIZATION;

    AppConfigSoftVendorOrgField() {
        super("softwareVendorOrganization", "Software Vendor Organization", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigSoftVendorOrgField clone = new AppConfigSoftVendorOrgField();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.SOFTWARE_VENDOR_ORGANIZATION;
            corrected = true;
        } else {
