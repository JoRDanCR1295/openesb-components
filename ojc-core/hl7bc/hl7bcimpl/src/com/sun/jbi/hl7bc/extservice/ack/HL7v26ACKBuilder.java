...
import com.sun.jbi.hl7bc.extservice.ack.hl7v26.*;
...
/**
 * This class builds and return HL7 v2.6 compliant ACK
 * 
 * @author Raghunadh Teegavarapu
 */
public class HL7v26ACKBuilder implements ACKBuilder, HL7Constants {
	...
	private String mUserAuthenticationCredentialTypeCode;

	private String mUserAuthenticationCredential;
   ...
   /**
	...
	/**
     * Set the Validate UAC segment enabled
     */
    public void setUACEnabled(boolean val) {
        this.mEnabledUAC = val;
    }

    /**
     * Set the UserAuthenticationCredentialTypeCode
     */
    public void setUserAuthenticationCredentialTypeCode(String val) {
        this.mUserAuthenticationCredentialTypeCode = val;
    }

   /**
     * Set the UserAuthenticationCredential
     */
    public void setUserAuthenticationCredential(String val) {
        this.mUserAuthenticationCredential = val;
    }

    /**
     * This method builds MSH, (SFT/UAC), MSA and ERR segments and finally returns the ACK
     * 
    ...
    public Document buildACK() throws Exception {
        ...
        // unmarshal UAC instance document into a tree of Java content if UAC enabled
    ...
    private MSHCONTENT buildMSH() throws Exception {
        ...
        if (mReqMSHContent.getMSH7() != null) {
            ...
            msh7.setValue(mReqMSHContent.getMSH7().getValue());
    ...
    private ERRCONTENT buildERR() throws Exception {
        ...
        CWE1CONTENT cwe1 = new CWE1CONTENT();
        if(mErrCode != null && !mErrCode.equals("")) {
            cwe1.setValue(mErrCode);
            eld4.setCWE1(cwe1);
        }
        CWE2CONTENT cwe2 = new CWE2CONTENT();
        if(mErrMsg != null &&  !mErrMsg.equals("")) {
            cwe2.setValue(mErrMsg);
            eld4.setCWE2(cwe2);
        }
    ...
    private SFTCONTENT buildSFT() throws Exception {
        ...
        sft6.setValue(mSoftwareInstallDate);
    ...
    /**
     * This method builds and return UAC segment
     * 
     * @return UACCONTENT UAC segment of the Acknowledgment
     * @throws Exception In case any exception occurs
     */
    private UACCONTENT buildUAC() throws Exception {
        UACCONTENT ackUACContent = new UACCONTENT();
        // User Authentication Credential Type Code
        UAC1CONTENT uac1 = new UAC1CONTENT();
        CWE1CONTENT cwe1 = new CWE1CONTENT();
        cwe1.setValue(mUserAuthenticationCredentialTypeCode);
        uac1.setCWE1(cwe1);
        ackUACContent.setUAC1(uac1);

        //User Authentication Credential
        UAC2CONTENT uac2 = new UAC2CONTENT();
		ED1CONTENT ed1 = new ED1CONTENT();
		HD1CONTENT hd1 = new HD1CONTENT();
		hd1.setValue(mUserAuthenticationCredential);
		ed1.setHD1(hd1);
		uac2.setED1(ed1);
        ackUACContent.setUAC2(uac2);

        return ackUACContent;
    }
