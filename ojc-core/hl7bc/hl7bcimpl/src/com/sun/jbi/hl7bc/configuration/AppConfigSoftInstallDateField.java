...
public class AppConfigSoftInstallDateField extends
		ApplicationConfigurationField {
    private String value = HL7ProtocolProperties.SOFTWARE_INSTALLED_DATE;

    AppConfigSoftInstallDateField() {
        super("softwareInstallDate", "Software Install Date", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigSoftInstallDateField clone = new AppConfigSoftInstallDateField();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.SOFTWARE_INSTALLED_DATE;
            corrected = true;
        } else {
        ...
        if(value.length() != 0){
	        ...
	        try {
				...
				return new String[]{null,"Invalid Value :" + value + ". The date should be in format yyyyMMddHHmm"};
			}
        }
