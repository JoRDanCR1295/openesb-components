...
public class AppConfigSoftProductNameField extends
		ApplicationConfigurationField {
    private String value = HL7ProtocolProperties.SOFTWARE_PRODUCT_NAME;

    AppConfigSoftProductNameField() {
        super("softwareProductName", "Software Product Name", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigSoftProductNameField clone = new AppConfigSoftProductNameField();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.SOFTWARE_PRODUCT_NAME;
            corrected = true;
        } else {
