...
/**
 * Application Configuration field for Port (number).
 * @author Noel.Ang@sun.com
 */
final class AppConfigPortField extends ApplicationConfigurationField {
    private static final Integer INITIAL_VALUE = -1;
    
    private Integer value = INITIAL_VALUE;

    AppConfigPortField() {
        super("port", "Host Port", SimpleType.INTEGER);
    }
    ...
    public Object clone() {
        AppConfigPortField clone = new AppConfigPortField();
