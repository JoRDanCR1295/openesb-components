...
public class AppConfigSoftBinaryId extends ApplicationConfigurationField {
    private String value = HL7ProtocolProperties.SOFTWARE_BINARY_ID;

    AppConfigSoftBinaryId() {
        super("softwareBinaryID", "Software Binary Id", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigSoftBinaryId clone = new AppConfigSoftBinaryId();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.SOFTWARE_BINARY_ID;
            corrected = true;
        } else {
