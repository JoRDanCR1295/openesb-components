...
public class AppConfigEncodingCharactersField extends
		ApplicationConfigurationField {
    private String value = HL7ProtocolProperties.ENCODIND_CHARACTERS;

    AppConfigEncodingCharactersField() {
        super("encodingCharacters", "Encoding Characters", SimpleType.STRING);
    }
    ...
    public Object clone() {
    	AppConfigEncodingCharactersField clone = new AppConfigEncodingCharactersField();
    ...
    public Object[] validate(Object data) {
        ...
        // Check against null
        if (data == null) {
            value = HL7ProtocolProperties.ENCODIND_CHARACTERS;
            corrected = true;
        } else {
