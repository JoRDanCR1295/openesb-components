...
/**
 * Internationalization utility for Transforms Library's Saxon module.
...
public class I18n extends LocalizationSupport {
	...
	protected I18n() {
		super(Pattern.compile("(TRASAX-[4-7]\\d\\d\\d)(: )(.*)", Pattern.DOTALL), 
			  "", null);
	}
	
    /**
     * Creates a localized message for the TransformS Library.
