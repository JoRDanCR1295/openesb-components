...
public class JavaCompilerHelper {
    ...
    private static final Messages messages = Messages.getMessages(JavaCompilerHelper.class);
    private static final Logger log = Messages.getLogger(JavaCompilerHelper.class);
    ...
    public static boolean compile(String[] args, OutputStream out) {
        ...
        try {
            ...
            try {
                Method compileMethod = comSunToolsJavacMainClass.getMethod("compile",
                ...
                log.log(Level.SEVERE, "JavaCompilerHelper_NOSUCHMETHOD_ERROR",
                        new Object[]{"compile"});

                return false;
            }
        } catch (ClassNotFoundException e) {
            log.log(Level.SEVERE, "JavaCompilerHelper_CLASSPATH_ERROR",
