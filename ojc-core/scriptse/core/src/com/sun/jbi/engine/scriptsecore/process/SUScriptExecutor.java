...
import  com.sun.jbi.engine.scriptsecore.scrconfig.Parameter;
import  com.sun.jbi.engine.scriptsecore.scrconfig.Returntype;
    ...
    public void initJAXBContext() {
        ...
        try {
            ...
            lParser.parse(new File(mSU_InstallPath,
                    ScriptSEConstants.PACKAGE_INFO_XML), lHandler);
    ...
    public Bindings createBindings(Source aSrc) {
        ...
        try {
            ...
            if (lType != null) {
                ...
                if ((lTypeName.equals(
                        ScriptSEConstants.PARAMATER_TYPE_XSDTYPE)) &&
                        (lXSDName != null)) {
