...
public class ScriptseConfiguration extends AbstractConfigMBean implements ScriptseConfigurationMBean {

    public ScriptseConfiguration(ComponentContext ctx, ComponentConfig config) 
