...
public class ParseXsds {
	 ...
	 * @throws Exception
	 */
	public void parseForXsds(String serviceUnitRootPath ) throws Exception {
...
//			 compile the generated JAXB Classes
             ...
             List sourceFiles = listResourceFiles(new File(xjcHelper.getGeneratedSourceDir()), "java");
             String[] args = constructJavaCArgs(serviceUnitRootPath, sourceFiles);
             ByteArrayOutputStream baos = new ByteArrayOutputStream();
             JavaCompilerHelper.compile(args, baos);
             String jarFile = serviceUnitRootPath
                     + File.separator
	 ...
	 * @return args
	 */
	private String[] constructJavaCArgs(String serviceUnitRootPath, List sourceFiles) {
		String args[] = null;
	 ...
	 * @throws Exception
	 */
	public void createPackageXML(String serviceUnitRootPath) throws Exception{
	 ...
	 * @throws Exception
	 */	
	private void generatePakgInfo(String packageInfoFile, List pakList) throws Exception {
	     ...
	     try {
		         ...
		         for (int i = 0; i < pakList.size(); i++) {
		              sb.append("\n");
		              sb.append("   <file packageName=\"" + (String) pakList.get(i) + "\" xsdName=\"value\">");
		              sb.append("</file>");
		         }
		         sb.append("\n");
		         sb.append(" </packageInfo>\n");
