...
/**
 * Describes the Scheduler WSDL Binding extension.
 * 
 * @author sunsoabi_edwong
 */
public interface BindingEx extends ExtensibilityElement, SchedulerConstants {

    public static final QName ELEM_TYPE = new QName(SCHEDULER_SCHEMA_NAMESPACE,
            BINDINGEX_ELEM_NCNAME, SCHEDULER_PREFIX);
