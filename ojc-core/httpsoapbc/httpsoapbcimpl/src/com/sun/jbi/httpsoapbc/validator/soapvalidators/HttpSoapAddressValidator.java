...
public class HttpSoapAddressValidator extends AbstractValidator implements Validator {
    private static final Messages mMessages =
        Messages.getMessages(HttpSoapAddressValidator.class);
