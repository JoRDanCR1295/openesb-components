 ...
 */
public class HttpSoapComponentContext {
    
    private static HttpSoapComponentContext instance = new HttpSoapComponentContext();
    ...
    private HttpSoapComponentContext() {
    }
    
    public static HttpSoapComponentContext getInstance() {
        return instance;
    }
