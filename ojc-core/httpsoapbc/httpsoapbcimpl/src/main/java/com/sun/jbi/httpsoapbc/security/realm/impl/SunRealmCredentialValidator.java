...
/**
 *
 * Credentials validation based on Glassfish Application Server Realms
 */
public class SunRealmCredentialValidator implements CredentialValidator {
    ...
    private final ProgrammaticLogin progLogin;
    ...
    public Subject validateCredential(String username, char[] password)
        ...
        try {
            Boolean result = progLogin.login(username, password, realm, true);
            if (result) {
