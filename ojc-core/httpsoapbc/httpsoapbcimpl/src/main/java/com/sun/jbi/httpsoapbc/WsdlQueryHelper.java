...
public class WsdlQueryHelper {
 ...
 //   private Definition definition;
     ...
     *
     */
    public WsdlQueryHelper(Request request, int rPort, ByteBuffer def, boolean wsdl) {
        this.isWsdl = wsdl;
        ...
        try {
            ...
            localhostFQDN = InetAddress.getLocalHost().getCanonicalHostName();
    ...
    public WsdlQueryHelper(Request request, int rPort, ByteArrayOutputStream baos, boolean wsdl) {
