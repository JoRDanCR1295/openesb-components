 ...
 * Strings.
 */
public class StringCompareValidation extends ValidationBaseType
        implements ExtensibilityElement, Serializable {
    
    // Local element name
    public static final String ELEM_StringCompare = "WssTokenCompare";

    // QName representing this Extensibility Element
    private QName QNAME_StringCompare =
        new QName(NS_URI_HTTPBC_SEC_EXTENSION, ELEM_StringCompare);
    
    private Boolean mFieldRequired = false;

    private String mUsername = "";
    private char [] mPassword = "".toCharArray();
