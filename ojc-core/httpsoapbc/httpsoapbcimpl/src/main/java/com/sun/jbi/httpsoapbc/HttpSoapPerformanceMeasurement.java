 ...
 * 
 */
public class HttpSoapPerformanceMeasurement implements PerformanceMeasurement {

    public static final String HTTP_SOAP_BC_SOURCE_FILTER = ".*httpsoapbc.*";
    ...
    private String getPerfCatFilter() {
        ...
        for (int i=0; i < HttpSoapBindingLifeCycle.HTTPSOAPBC_PERF_CATEGORIES.length; i++) {
            perfCatFilter.append(HttpSoapBindingLifeCycle.HTTPSOAPBC_PERF_CATEGORIES[i]);
            if (i < HttpSoapBindingLifeCycle.HTTPSOAPBC_PERF_CATEGORIES.length-1) {
