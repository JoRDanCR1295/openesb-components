...
public class HttpSoapHeaderFaultValidator implements
            Validator,
            ValidatorObserver,
            Visitable,
            Visitor {
    ...
    private static final Messages mMessages =
        Messages.getMessages(HttpSoapHeaderFaultValidator.class);
    ...
    public void validate(ExtensibilityElement element)
        ...
        mPart = null;
        SOAPHeaderFault headerFault = (SOAPHeaderFault)element;
...
//         List encodingStyles = headerFault.getEncodingStyles();
//         if (encodingStyles != null) {
//             // This is optional.  Don't verify contents at this point.
//         }

//         String namespace = headerFault.getNamespaceURI();
//         if (namespace != null) {
