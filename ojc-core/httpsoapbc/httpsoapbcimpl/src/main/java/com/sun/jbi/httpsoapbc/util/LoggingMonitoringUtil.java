 ...
 * @author sweng
 */
public class LoggingMonitoringUtil extends MMUtil {
    public static final String COMPONENT_NAME = "sun-http-binding";
    ...
    public static void setCheckpoint(Endpoint endpoint, String msgId, String desc, Object payload) {
        String serviceInstanceId = getServiceInstanceID(endpoint);
        String solutionGroup = getSolutionGroup(serviceInstanceId);
        setCheckpoint(solutionGroup, msgId, COMPONENT_NAME, serviceInstanceId, desc, new Date(), payload);
    }
