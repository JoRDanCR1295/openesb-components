...
public interface CredentialValidator {
    public static final String CREDENTIAL_VALIDATOR = "CredentialValidator";
        
    /*
     * @todo Instead of passing username & password, pass a marker credential 
     *       interface to make it generic.    
     */
