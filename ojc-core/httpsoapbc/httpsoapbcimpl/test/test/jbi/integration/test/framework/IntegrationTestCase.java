...
import test.jbi.integration.testse.core.Connection;
import test.jbi.integration.testse.installer.TestSEInstaller;
...
abstract public class IntegrationTestCase extends TestCase implements Serializable{
	...
	protected void setUp() throws Exception {
		...
		String testBCDir = TestSEInstaller.generateInstaller(Configuration
				.getWorkingDir());
