package test.jbi.integration.testse.util;
...
public class Helper {
	...
	public static HTTPBCSUAssembler createTestSU(String name, String desc,
			String wsdlFileName, String inputDir, Class cls) throws IOException {
		HTTPBCSUAssembler su = new HTTPBCSUAssembler(name, desc);
	...
	public static HTTPBCSUAssembler createTestSU(String name, String desc,
		String wsdlFileName,String[] xmlFiles, String inputDir, Class cls) throws IOException {
	HTTPBCSUAssembler su = new HTTPBCSUAssembler(name, desc);
	...
	for(String xml : xmlFiles){
	    String s = Configuration.getPath(cls, xml);
	    su.addWsdl(s);
	}
	...
	public static String createTestSA(HTTPBCSUAssembler su, String saName,
