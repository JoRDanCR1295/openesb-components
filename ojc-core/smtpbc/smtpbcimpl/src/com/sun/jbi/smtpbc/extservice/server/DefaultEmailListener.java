...
public class DefaultEmailListener implements EmailListener {

    private AddressBook mAddressbook;

    public DefaultEmailListener(final AddressBook addressbook) {
