 ...
 * @author aegloff
 */
public class SMTPOperationOutput implements ExtensibilityElement, Serializable {
    
    // Qualified element names
    public static final QName QNAME_OPERATION_OUTPUT =
        new QName(SMTPConstants.NS_URI_SMTP, Constants.ELEM_OUTPUT);
    ...
    public QName getElementType() {
        return SMTPOperationOutput.QNAME_OPERATION_OUTPUT;
    }
	...
	public String toString() {
        ...
        strBuf.append("\nSMTP operation (" + SMTPOperationOutput.QNAME_OPERATION_OUTPUT + "):");
