 ...
 *
 */
public class RevokeTaskOperation extends AbstractStaticOperation {
    
    /** Creates a new instance of RevokeTaskOperation */
    public RevokeTaskOperation(Operation operation,
                              Element input, 
                              Subject subject,
    ...
    public void execute(){
        ...
        //extract input param to revokeTask operation of 
        ...
        try {
            ...
            //invoke revokeTask method
            StaticTaskManagementService.OperationStatus status = getTaskManagementService().revokeTask(taskid);
