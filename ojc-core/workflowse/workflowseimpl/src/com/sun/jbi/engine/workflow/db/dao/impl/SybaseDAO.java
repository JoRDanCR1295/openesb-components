 ...
 * @since eGate50
 */
public class SybaseDAO extends DAO {


    /** MAX_VARCHAR_LENGTH for SYBASE Data Type */
    protected static final int MAX_VARCHAR_LENGTH_SYBASE = 255;

    /** Sybase error code for unique constraint. */
    public static final int ERROR_CODE_UNIQUE_CONSTRAINT = 2601;

    /** DB TYPE */
    protected static final String SYBASE = "_SYBASE";
     ...
     */
    public SybaseDAO() throws DAOException, Exception {
         super();
    }
    ...
    public void setAutoCommit(boolean autoCommit) throws SQLException {
        // bug 57864
        // by default the Sybase auto commit is set to false in constructor.
    }
    ...
    protected void fillInParms(PreparedStatement ps, List columns,
        ...
        for (index = 0; index < columns.size(); index++) {
            ...
            if ( (obj == null) && (columnTypes.size() > index)) {
                ...
                String data = "";  // default data for Sybase image/text.

                if (colType == java.sql.Types.CLOB) {
                    // CLOB type is text for Sybase.
                    ps.setString(index + 1, data);
                } else if (colType == java.sql.Types.BLOB) {
                    // BLOB type is image for Sybase.
                    ...
                    // LONGVARCHAR type is text for Sybase.
                     ps.setString(index + 1, data);
     ...
     * if the errorcode is a unique constraint error code for Sybase.
     *
   ...
   /**
    ...
    public int getMaxVarcharLength() {
        return MAX_VARCHAR_LENGTH_SYBASE;
    }
