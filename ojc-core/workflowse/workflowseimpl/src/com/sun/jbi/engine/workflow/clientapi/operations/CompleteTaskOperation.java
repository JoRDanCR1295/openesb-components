 ...
 * 
 */
public class CompleteTaskOperation extends AbstractStaticOperation {
    
    /** Creates a new instance of CompleteTaskOperation */
    public CompleteTaskOperation(Operation operation,
                              Element input, 
                              Subject subject,
    ...
    public void execute() {
        ...
        //extract input param to completeTask operation of 
        ...
        try {
            ...
            StaticTaskManagementService.OperationStatus status = getTaskManagementService().completeTask(taskid, getTaskSubject());
