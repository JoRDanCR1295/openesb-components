...
public class WorkflowEngineDynamicWsdlTest extends TestCase {
    ...
    public void testWorkflowCreateToCompleteTask() throws Exception {
        ...
        String fileName = "/com/sun/jbi/engine/workflow/clientapi/testMessages/dynamic/GetApprovePurchaseInputData.xml";
        Element getTaskInputOptInput = Util.loadInputMessageElement(fileName);
        ClientWorkflowRequest getTaskInputOptReq = new ClientWorkflowRequest ("GetApprovePurchaseInput", getTaskInputOptInput, getTaskInputOpt, subject);
        ...
        ClientWorkflowRequest setOutputReq = new ClientWorkflowRequest ("SetApprovePurchaseOutput", setOutputInput, setOutputOpt, subject);
        ...
        ClientWorkflowRequest getTaskOutputOptReq = new ClientWorkflowRequest ("GetApprovePurchaseOutput", getTaskOutputOptInput, getTaskOutputOpt, subject);
...
//        
//        //Complete task
        Operation completeTaskOpt =  mPortTypeTaskStatic.getOperation("CompleteTask", null, null);
