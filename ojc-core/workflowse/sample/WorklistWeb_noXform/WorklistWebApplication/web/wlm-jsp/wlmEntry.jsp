...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function showTaskDetails(taskId, claimedBy, isClicked) {
                var taskDetailsURL_new ="taskDetailsIn.jsp";
                var taskDetailsURL_out ="taskDetailsOut.jsp";
                if(taskId != null) {
                    taskDetailsURL_new = taskDetailsURL_new + "?taskId="+taskId;
                    taskDetailsURL_out = taskDetailsURL_out + "?taskId="+taskId;
                }


                if(claimedBy != null  && claimedBy != "") {
                    taskDetailsURL_new = taskDetailsURL_new + "&claimedBy="+ claimedBy;
                    taskDetailsURL_out = taskDetailsURL_out + "&claimedBy="+ claimedBy;
                }

                if (isClicked ||taskDetailsURL_new != taskDetailsURL) {
                    taskDetailsURL = taskDetailsURL_new;
             	    loadIframe('taskDetailsIframeIn', taskDetailsURL);
                    if(claimedBy != null && claimedBy != "") {
                    	loadIframe('taskDetailsIframeOut', taskDetailsURL_out);
                    	document.getElementById('taskDetailsOut').style.display = 'block';
                    } else {
                    	document.getElementById('taskDetailsOut').style.display = 'none';
                    }
        ...
        <style type="text/css">
            ...
            .columnL {width: 5%; border: none;}
            .columnR {width: 20%; border: none; padding-left: 10}
    ...
    <body class="yui-skin-sam">
        <table class="layout" cellspacing="0">
        	...
        	<div id="taskDetails">
            		<div id="taskDetailsIn" class="yui-skin-sam">
                		<iframe name="taskDetailsIframeIn" id="ifrmIn" width="400" height="300"
                		scrolling="auto" title="Task Input Details" frameborder="0"></iframe>
            		</div>
            		<div id="taskDetailsOut" class="yui-skin-sam">
                		<iframe name="taskDetailsIframeOut" id="ifrmOut" width="400" height="300"
                		scrolling="auto" title="Task Output Details" frameborder="0"></iframe>
            		</div>
        	</div>
                </td>
                <td class="columnR">
        ...
        <script type="text/javascript">
            ...
            function showIframe() {
                var detailFrame = document.getElementById('taskDetails');
