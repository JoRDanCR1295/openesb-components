 ...
 * @author gpatil
 */
public interface POJOExecutor {
    public enum POJOExecutorMethods {operation, onReply, onDone, onError, onFault};
    ...
    //public void executeOnProvisioningError(MessageExchange me);
}
