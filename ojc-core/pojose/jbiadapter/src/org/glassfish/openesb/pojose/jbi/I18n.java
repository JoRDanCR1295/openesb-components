...
public class I18n extends LocalizationSupport {  
    ...
    private static final String COMP_TYPE = "ServiceEngine"; //NOI18N
    ...
    // For logging fine/finest. No need to localize.
    ...
    public static void alertInfo(String[] msgParts) {
        alerter.info(msgParts[1], Constants.POJO_SE_NAME, DEPLOY_NAME,
    ...
    public static void alertWarning(String[] msgParts) {
        alerter.warning(msgParts[1], Constants.POJO_SE_NAME, DEPLOY_NAME,
                SERVER_TYPE, COMP_TYPE,
                NotificationEvent.OPERATIONAL_STATE_RUNNING,
                NotificationEvent.EVENT_TYPE_ALERT, msgParts[0]);
    ...
    public static void alertMinor(String[] msgParts) {
        alerter.minor(msgParts[1], Constants.POJO_SE_NAME, DEPLOY_NAME,
                SERVER_TYPE, COMP_TYPE,
                NotificationEvent.OPERATIONAL_STATE_RUNNING,
                NotificationEvent.EVENT_TYPE_ALERT, msgParts[0]);
    ...
    public static void alertMajor(String[] msgParts) {
        alerter.major(msgParts[1], Constants.POJO_SE_NAME, DEPLOY_NAME,
                SERVER_TYPE, COMP_TYPE,
                NotificationEvent.OPERATIONAL_STATE_RUNNING,
                NotificationEvent.EVENT_TYPE_ALERT, msgParts[0]);
    ...
    public static void alertCritical(String[] msgParts) {
        alerter.critical(msgParts[1], Constants.POJO_SE_NAME, DEPLOY_NAME,
                SERVER_TYPE, COMP_TYPE,
                NotificationEvent.OPERATIONAL_STATE_RUNNING,
                NotificationEvent.EVENT_TYPE_ALERT, msgParts[0]);
    ...
    public static void alertFatal(String[] msgParts) {
        alerter.fatal(msgParts[1], Constants.POJO_SE_NAME, DEPLOY_NAME,
                SERVER_TYPE, COMP_TYPE,
                NotificationEvent.OPERATIONAL_STATE_RUNNING,
                NotificationEvent.EVENT_TYPE_ALERT, msgParts[0]);
