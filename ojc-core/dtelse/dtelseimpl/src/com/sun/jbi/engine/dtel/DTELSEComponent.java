...
public class DTELSEComponent implements Component {
    private ComponentLifeCycle mComponentLifeCycle;
    private ServiceUnitManager mServiceUnitManager;
    
    public DTELSEComponent() {
        mComponentLifeCycle = new DTELSELifeCycle(this);
        mServiceUnitManager = new DTELSEServiceUnitManager(this);
    }
    /**
