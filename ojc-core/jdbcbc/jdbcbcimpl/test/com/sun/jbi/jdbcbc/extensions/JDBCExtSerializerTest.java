...
public class JDBCExtSerializerTest extends TestCase {
	...
	public void setUp() throws Exception {
        ...
        addressElementType = new QName("http://schemas.sun.com/jbi/wsdl-extensions/jdbc/",
                "address");
        outputFolder = "test/com/sun/jbi/jdbcbc/extensions/output/";
        expectedFolder = "test/com/sun/jbi/jdbcbc/extensions/expected/";

        final BufferedReader br = new BufferedReader(new InputStreamReader(
                    new FileInputStream(
                        new File(
                            "test/com/sun/jbi/jdbcbc/packaging/wsdls/TestJdbc.wsdl")),
                    "UTF-8"));
        //wsdlFactory = WSDLFactory.newInstance();
        //reader = ((WSDLFactoryImpl) wsdlFactory).newWSDLReader(new CatalogResolver(
         //           new CatalogManager()));
        //def = reader.readWSDL(new File(
        //            "test/com/sun/jbi/jdbcbc/packaging/wsdls/TestJdbc.wsdl").getAbsolutePath());
    ...
    /**
     * Test of marshall method, of class com.sun.jbi.jdbcbc.extensions.JdbcExtSerializer.
     */
    ...
    /**
     * Test of unmarshall method, of class com.sun.jbi.jdbcbc.extensions.JdbcExtSerializer.
     */
