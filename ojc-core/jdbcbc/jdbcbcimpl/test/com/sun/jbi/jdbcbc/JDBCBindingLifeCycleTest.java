...
public class JDBCBindingLifeCycleTest extends org.jmock.cglib.MockObjectTestCase {
    ...
    /**
     * Test of getLifeCycle method, of class com.sun.jbi.jdbcbc.JDBCBindingLifeCycle.
     */
    ...
    public void testInit() throws Exception {
        ...
        /*jbiContext.expects(atLeastOnce()).method("getLogger")
            ...
            eq("com.sun.jbi.jdbcbc.messages.Bundle"))
                  .will(returnValue(Logger.getLogger(
                    JDBCBindingLifeCycle.class.getName(),
                    "com.sun.jbi.jdbcbc.messages.Bundle")));
        jbiContext.expects(atLeastOnce()).method("getLogger")
                  .with(eq("com.sun.jbi.jdbcbc.JDBCBindingDeployer"),
            eq("com.sun.jbi.jdbcbc.messages.Bundle"))
                  .will(returnValue(Logger.getLogger(
                    "com.sun.jbi.jdbcbc.JDBCBindingDeployer",
                    "com.sun.jbi.jdbcbc.messages.Bundle")));*/
        //jbiContext.expects(atLeastOnce()).method("getLogger").with(eq("com.sun.jbi.jdbcbc.InboundMessageProcessor"), eq("com.sun.jbi.jdbcbc.messages.Bundle")).will(returnValue(Logger.getLogger("com.sun.jbi.jdbcbc.InboundMessageProcessor", "com.sun.jbi.jdbcbc.messages.Bundle")));
        //jbiContext.expects(atLeastOnce()).method("getLogger").with(eq("com.sun.jbi.jdbcbc.OutboundMessageProcessor"), eq("com.sun.jbi.jdbcbc.messages.Bundle")).will(returnValue(Logger.getLogger("com.sun.jbi.jdbcbc.OutboundMessageProcessor", "com.sun.jbi.jdbcbc.messages.Bundle")));
        /*jbiContext.expects(atLeastOnce()).method("getLogger")
                  .with(eq("com.sun.jbi.jdbcbc.OutboundReceiver"),
            eq("com.sun.jbi.jdbcbc.messages.Bundle"))
                  .will(returnValue(Logger.getLogger(
        ...
        jbiContext.expects(atLeastOnce()).method("getWorkspaceRoot")
                  .will(returnValue("test/com/sun/jbi/jdbcbc/testDir"));
    ...
    /**
     * Test of shutDown method, of class com.sun.jbi.jdbcbc.JDBCBindingLifeCycle.
     */
    ...
    /**
     * Test of activate endpoints method, of class com.sun.jbi.jdbcbc.JDBCBindingLifeCycle.
     */
    ...
    /**
     * Test of getServiceDescription method, of class com.sun.jbi.jdbcbc.JDBCBindingLifeCycle.
     */
