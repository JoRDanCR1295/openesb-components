...
/**
 * Application Configuration field for Principal.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigPrincipalField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigPrincipalField() {
        super("principal", "Principal", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigPrincipalField clone = new AppConfigPrincipalField();
