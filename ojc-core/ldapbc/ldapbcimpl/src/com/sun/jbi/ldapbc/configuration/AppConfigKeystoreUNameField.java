...
/**
 * Application Configuration field for KeyStoreUsername.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigKeystoreUNameField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigKeystoreUNameField() {
        super("keystoreusername", "KeyStore Username", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigKeystoreUNameField clone = new AppConfigKeystoreUNameField();
