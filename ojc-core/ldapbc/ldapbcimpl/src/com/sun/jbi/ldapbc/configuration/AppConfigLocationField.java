...
/**
 * Application Configuration field for Location.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigLocationField extends ApplicationConfigurationField {
    private String value = "";
	 // Message bundle
  //  private static final Messages mMessages = Messages.getMessages(AppConfigLocationField.class);
	// Logger
   // private static Logger mLogger = Messages.getLogger(AppConfigLocationField.class);


    public AppConfigLocationField() {
        super("location", "LDAP SERVER URL", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigLocationField clone = new AppConfigLocationField();
    ...
    public Object[] validate(Object data) { 
		...
		/*if (value.length() > 0) {
			...
			if(!(stArr.length == 4 && stArr[0].equals("ldap") && stArr[1].indexOf("//") 
					== 0 && Integer.parseInt(stArr[2])<= 65535)) {
					ret = new String[]{
							null,
						   mMessages.getString("LDAPBC-E01135.Invalid_Server_Url", value)};
					return ret;
			}
