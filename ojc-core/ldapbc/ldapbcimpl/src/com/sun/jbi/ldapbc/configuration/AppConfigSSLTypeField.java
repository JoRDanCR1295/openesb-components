...
/**
 * Application Configuration field for ssltype.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigSSLTypeField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigSSLTypeField() {
        super("ssltype", "SSL TYPE", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigSSLTypeField clone = new AppConfigSSLTypeField();
