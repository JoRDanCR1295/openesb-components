...
/**
 * Application Configuration field for TrustStore.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigTrustStoreField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigTrustStoreField() {
        super("truststore", "TrustStore Location", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigTrustStoreField clone = new AppConfigTrustStoreField();
