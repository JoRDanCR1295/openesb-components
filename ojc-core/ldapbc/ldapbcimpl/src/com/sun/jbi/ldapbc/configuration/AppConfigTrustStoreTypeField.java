 ...
 */
public final class AppConfigTrustStoreTypeField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigTrustStoreTypeField() {
        super("truststoretype", "TrustStore Type", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigTrustStoreTypeField clone = new AppConfigTrustStoreTypeField();
