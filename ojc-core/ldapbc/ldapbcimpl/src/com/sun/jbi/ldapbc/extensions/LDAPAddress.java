 ...
 */
public class LDAPAddress extends LdapConnection implements ExtensibilityElement, Serializable {

    private static final long serialVersionUID = 1L;
    private QName mFieldElementType = LDAPConstants.QNAME_ADDRESS;
