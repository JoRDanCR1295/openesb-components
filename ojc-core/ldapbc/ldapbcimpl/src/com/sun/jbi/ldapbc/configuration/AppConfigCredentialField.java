...
/**
 * Application Configuration field for Credential.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigCredentialField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigCredentialField() {
        super("credential", "Credential", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigCredentialField clone = new AppConfigCredentialField();
