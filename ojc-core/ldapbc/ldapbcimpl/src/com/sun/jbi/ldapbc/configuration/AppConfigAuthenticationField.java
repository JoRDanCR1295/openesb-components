...
/**
 * Application Configuration field for Authentication.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigAuthenticationField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigAuthenticationField() {
        super("authentication", "Authentication Type", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigAuthenticationField clone = new AppConfigAuthenticationField();
