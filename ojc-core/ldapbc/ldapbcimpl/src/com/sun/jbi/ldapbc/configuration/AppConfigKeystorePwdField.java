...
/**
 * Application Configuration field for Keystore Password.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigKeystorePwdField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigKeystorePwdField() {
        super("keystorepassword", "KeyStore Password", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigKeystorePwdField clone = new AppConfigKeystorePwdField();
