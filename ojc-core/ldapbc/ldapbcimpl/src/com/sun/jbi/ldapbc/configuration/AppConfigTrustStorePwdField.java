...
/**
 * Application Configuration field for TrustStore Password.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigTrustStorePwdField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigTrustStorePwdField() {
        super("truststorepassword", "TrustStore Password", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigTrustStorePwdField clone = new AppConfigTrustStorePwdField();
