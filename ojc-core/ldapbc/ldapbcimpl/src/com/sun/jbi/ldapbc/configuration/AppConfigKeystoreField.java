 ...
 */
public final class AppConfigKeystoreField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigKeystoreField() {
        super("keystore", "KeyStore Location", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigKeystoreField clone = new AppConfigKeystoreField();
