...
/**
 * Application Configuration field for TLS Security.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigTLSSecurityField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigTLSSecurityField() {
        super("tlssecurity", "TLS Security", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigTLSSecurityField clone = new AppConfigTLSSecurityField();
