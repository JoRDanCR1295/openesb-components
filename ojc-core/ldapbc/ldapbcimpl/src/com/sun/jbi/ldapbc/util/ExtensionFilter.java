...
public class ExtensionFilter implements FileFilter {
     ...
     */
    public ExtensionFilter(final String[] extensions, final boolean include) {
    ...
    public static Object[] duplicate(final Object[] a) {
        if (a == null) {
            return a;
        }
    ...
    public static String[] duplicate(final String[] a) {
        if (a == null) {
            return a;
        }
