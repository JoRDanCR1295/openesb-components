...
/**
 * Application Configuration field for KeyStoreType.
 * 
 * @author Noel.Ang@sun.com
 */
public final class AppConfigKeystoreTypeField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigKeystoreTypeField() {
        super("keystoretype", "KeyStore Type", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigKeystoreTypeField clone = new AppConfigKeystoreTypeField();
