...
/**
 * Application Configuration field for DB Server URL.
 * 
 * @author Venkata.Jetti@sun.com
 */
public final class AppConfigDBJNDINameField extends ApplicationConfigurationField {
    ...
    private static final Messages mMessages =
            Messages.getMessages(AppConfigDBJNDINameField.class);
    
    // Logger
    private static Logger mLogger = Messages.getLogger(AppConfigDBJNDINameField.class);

    public AppConfigDBJNDINameField() {
        super("DatabaseJNDIName", "Database JNDI Name", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigDBJNDINameField clone = new AppConfigDBJNDINameField();
    ...
    public Object[] validate(Object data) { 
        ...
        //TODO:: need to write code for validating the DB url
        //TODO:: for the time being treat as if things are fine
