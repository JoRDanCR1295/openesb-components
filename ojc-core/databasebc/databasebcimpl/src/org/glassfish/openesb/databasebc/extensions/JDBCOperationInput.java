...
/*
	...
	*/
    public static final String ATTR_GENERATED_KEY = "generatedKey";
    ...
    private HashMap mColNamesTypes = new HashMap();
/*
	* Modified by Logicoy for [ task #20 ] DB BC - Insert statement should return primary key auto-increment value inserted
	*/    
    private String mGeneratedKey = null;
    ...
    */
    ...
    public void setColNamesTypes(HashMap colNamesTypes){
    	mColNamesTypes = colNamesTypes;
    }
    
    public HashMap getColNamesTypes(){
    	return this.mColNamesTypes;
    }
/*
	* Modified by Logicoy for [ task #20 ] DB BC - Insert statement should return primary key auto-increment value inserted
	*/
