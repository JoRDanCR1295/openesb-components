...
/**
 * The Application Configuration Field that names an
 * Application Configuration object.  The "key" to a set of fields to be
 * used together.
 * 
 * @author Venkata.Jetti@sun.com
 */
public final class AppConfigNameField extends ApplicationConfigurationField {
    private String value = "";

    public AppConfigNameField() {
        super("configurationName", "Application Configuration Name", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigNameField clone = new AppConfigNameField();
     ...
     *         action. Otherwise, an array of one or more strings describing the
