...
public class JDBCComponentContext {
    ...
    public static final String NM_PROP_DATABASEBC_CONNECTION_JNDI_NAME = "org.glassfish.openesb.databasebc.connection.jndiname";
    ...
    public JDBCBindingDeployer getDeployer() {
        return mDeployer;
    }
    
    public void setDeployer(JDBCBindingDeployer deployer) {
        mDeployer = deployer;
    }
}
