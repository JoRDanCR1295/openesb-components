...
public class JDBCConstants {
    ...
    public static final String ELEM_SP_INPUT = "spinput";
    public static final String ELEM_SP_OUTPUT = "spoutput";
    ...
    public static final QName QNAME_SP_OPERATION_INPUT = new QName(JDBCConstants.NS_URI_JDBC,
            JDBCConstants.ELEM_SP_INPUT);
    public static final QName QNAME_SP_OPERATION_OUTPUT = new QName(JDBCConstants.NS_URI_JDBC,
            JDBCConstants.ELEM_SP_OUTPUT);
