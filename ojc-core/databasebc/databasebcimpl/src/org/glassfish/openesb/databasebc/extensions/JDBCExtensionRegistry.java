...
public class JDBCExtensionRegistry extends ExtensionRegistry {
    ...
    public JDBCExtensionRegistry(JDBCExtSerializer serializer) {
        super();
        serializer.registerSerializer(this);
    }

    /** Creates a new instance of JDBCExtensionRegistry */
    public JDBCExtensionRegistry(Map<String, String[]> envVarConfigMap) {
        super();
        JDBCExtSerializer jdbcExtSerializer = new JDBCExtSerializer(envVarConfigMap);
