...
public class JDBCBindingBootstrapTest extends org.jmock.cglib.MockObjectTestCase {
    ...
    /**
     * Test of init method, of class org.glassfish.openesb.databasebc.bootstrap.JdbcBindingBootstrap.
     */
    public void testInit() throws Exception {
        ...
        componentContext.expects(atLeastOnce()).method("getLogger")
            ...
            eq("org.glassfish.openesb.databasebc.bootstrap.messages.Bundle"))
                        .will(returnValue(Logger.getLogger(
                    JDBCBindingBootstrap.class.getName(),
                    "org.glassfish.openesb.databasebc.bootstrap.messages.Bundle")));
        componentContext.expects(atLeastOnce()).method("getLogger")
                        .with(eq("org.glassfish.openesb.databasebc.bootstrap.InstallerExt"),
            eq("org.glassfish.openesb.databasebc.bootstrap.messages.Bundle"))
                        .will(returnValue(Logger.getLogger(
                    "org.glassfish.openesb.databasebc.bootstrap.InstallerExt",
                    "org.glassfish.openesb.databasebc.bootstrap.messages.Bundle")));
    ...
    /**
     * Test of cleanUp method, of class org.glassfish.openesb.databasebc.bootstrap.JdbcBindingBootstrap.
     */
