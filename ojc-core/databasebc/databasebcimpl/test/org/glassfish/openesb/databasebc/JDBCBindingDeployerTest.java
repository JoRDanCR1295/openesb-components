...
public class JDBCBindingDeployerTest extends org.jmock.cglib.MockObjectTestCase {
    ...
    Mock runtimeConfiguration = mock(RuntimeConfigurationMBean.class);
	...
	public void setUp() throws Exception {
        instance = new JDBCBindingDeployer((ComponentContext) componentContext.proxy(),
                                           ...
                                           (RuntimeConfigurationMBean)runtimeConfiguration.proxy());
    }
    ...
    /**
     * Test of deploy method, of class org.glassfish.openesb.databasebc.JDBCBindingDeployer.
     */
...
//         runtimeConfiguration.expects(once()).method("retrieveApplicationVariablesMap").will(returnValue(new HashMap<String, String[]>()));
//         final String result = instance.deploy("testSUId", "testSUDir");
//         Assert.assertNotNull(result);
    }

    /**
     * Test of init method, of class org.glassfish.openesb.databasebc.JDBCBindingDeployer.
     */
...
//             new RuntimeConfiguration("test/org/glassfish/openesb/databasebc/testDir",
//                                      (KeyStoreUtilClient)mock(KeyStoreUtilClient.class).proxy());
        ...
        try {
            //componentContext.expects(once()).method("getComponentName").will(returnValue("someComponentName"));
            //instance.init("testSUId", "test/corg/glassfish/openesb/databasebc/packaging/descriptors");
            System.out.println(
    ...
    /**
     * Test of start method, of class org.glassfish.openesb.databasebc.JDBCBindingDeployer.
     */
    ...
    /**
     * Test of stop method, of class org.glassfish.openesb.databasebc.JDBCBindingDeployer.
     */
    ...
    /**
     * Test of shutDown method, of class org.glassfish.openesb.databasebc.JDBCBindingDeployer.
     */
    ...
    /**
     * Test of undeploy method, of class org.glassfish.openesb.databasebc.JDBCBindingDeployer.
     */
    public void testUndeploy() throws Exception {
        ...
        try {
            ...
            instance.undeploy("testSUId",
                "test/org/glassfish/openesb/databasebc/packaging/descriptors");
        } catch (final Exception e) {
            Assert.fail(
