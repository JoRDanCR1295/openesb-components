...
/**
 * Utility interface to configure a BPEL context factory.
 * @author Kevan Simpson
 */
public interface BPELXPathContextFactory {
	public void setTransformEngine(TransformEngine engine);
