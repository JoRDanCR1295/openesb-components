...
public class TimeLessThan implements Function {
	...
	public Object invoke(ExpressionContext arg0, Object[] args) {
		...
		GregorianCalendar cal1 = getGregorianCalendarFromTime(first);
		GregorianCalendar cal2 = getGregorianCalendarFromTime(second);
    ...
    public static GregorianCalendar getGregorianCalendarFromTime(String xsdTime) throws StandardException {
        GregorianCalendar calendar = new GregorianCalendar(DateParserImpl.UTC);
        calendar.clear();
        //hh:mm:ss.sTZD
        StringTokenizer st = new StringTokenizer(xsdTime, DateParserImpl.DELIMITER, true);
        try {
			DateParserImpl.getCalendarTime(st, calendar, xsdTime);
