...
public class DateTimeImpl implements DateTime {
    ...
    /**
     * Creates a new DateTimeImpl object.
     */
    public DateTimeImpl() {
     ...
     */
    public DateTimeImpl(GregorianCalendar cal) {
     ...
     */
    public DateTimeImpl(int year, int month, int day) {
    ...
    public boolean before(DateTime other) {
        return cal.before(other.getCal());
    }
    ...
    public String toString() {
        return DateParserImpl.getIsoDate(cal.getTime());
    }
    ...
    public static DateTime parse(String value) {
        return new DateTimeImpl(DateParserImpl.getCalendar(value));
    }
}
