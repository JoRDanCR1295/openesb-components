...
public class DebuggerServerRunner {
	...
	public static void main(String[] args) {
		...
		//Schedule the message to be sent every 5 seconds, 2 seconds from now
		TimerTask msgSender = new MessageSender ();
		new Timer ().schedule(msgSender, 2000, 5000);
