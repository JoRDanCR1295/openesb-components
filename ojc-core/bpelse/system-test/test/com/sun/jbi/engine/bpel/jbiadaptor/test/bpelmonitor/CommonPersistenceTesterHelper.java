...
public class CommonPersistenceTesterHelper {
    ...
    public static void commonCode(String folder, String propertiesFilename) throws Exception {
        URL url = com.sun.jbi.engine.bpel.jbiadaptor.test.bpeldebugger.CommonPersistenceTesterHelper.class.getResource(folder);
    ...
    private static int execCommand(URI propFilePath, String deployedFolderPath)
        ...
        return EngineDriver.main(new String[] {funcParam1, funcParam2, "8888", "bpelsemonitor.properties"});
    }
}
