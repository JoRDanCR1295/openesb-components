 ...
 */
public class CommonTraceTesterHelper {

    public static void commonCode(String folder, String propertiesFilename) throws Exception {
        URL url = CommonTraceTesterHelper.class.getResource(folder);
        ...
        TestCase.assertTrue(status == TraceEngineDriver.SUCCESSFUL_EXECUTION);
    ...
    private static int execCommand(URI propFilePath, String deployedFolderPath)
        ...
        return TraceEngineDriver.main(new String[] {funcParam1, funcParam2, "8888", "bpelse.properties"});
    }
}
