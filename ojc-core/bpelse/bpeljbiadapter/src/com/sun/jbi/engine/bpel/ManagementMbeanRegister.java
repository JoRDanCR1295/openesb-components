...
/*
 * @(#)$Id: ManagementMbeanRegister.java,v 1.1 2008/02/04 20:18:57 pbhagat Exp $
 *
 ...
 */
public class ManagementMbeanRegister {
     ...
     */
    public ManagementMbeanRegister(String componentType, String componentName, MBeanServer mbeanServer) throws MalformedObjectNameException {
     ...
     * Create an instance, providing an MBeanServer to use
     */
    public ManagementMbeanRegister(ObjectName objName, MBeanServer mbeanServer) throws MalformedObjectNameException {
