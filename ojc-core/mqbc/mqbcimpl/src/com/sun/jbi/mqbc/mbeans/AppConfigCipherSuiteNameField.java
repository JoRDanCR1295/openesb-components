...
/**
 * Application Configuration field for CipherSuite Name.
 * 
 * @author Noel.Ang@sun.com
 */
final class AppConfigCipherSuiteNameField extends ApplicationConfigurationField {
    private String value = "";

    AppConfigCipherSuiteNameField() {
        super("cipherSuite", "Cipher Suite", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigCipherSuiteNameField clone = new AppConfigCipherSuiteNameField();
