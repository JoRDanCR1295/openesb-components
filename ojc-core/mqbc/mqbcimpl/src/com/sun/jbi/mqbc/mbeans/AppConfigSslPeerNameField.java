...
/**
 * Application Configuration field for SSL Peer Name.
 * 
 * @author Noel.Ang@sun.com
 */
final class AppConfigSslPeerNameField extends ApplicationConfigurationField {
    private String value = "";

    AppConfigSslPeerNameField() {
        super("sslPeerName", "SSL Peer Name", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigSslPeerNameField clone = new AppConfigSslPeerNameField();
