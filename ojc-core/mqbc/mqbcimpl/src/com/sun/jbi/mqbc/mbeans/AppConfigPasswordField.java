...
/**
 * Application Configuration field for User Name.
 * 
 * @author Noel.Ang@sun.com
 */
final class AppConfigPasswordField extends ApplicationConfigurationField {
    private String value = "";

    AppConfigPasswordField() {
        super("password", "Password", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigPasswordField clone = new AppConfigPasswordField();
