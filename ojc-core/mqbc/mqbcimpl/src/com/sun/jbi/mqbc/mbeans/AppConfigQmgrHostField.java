...
/**
 * Application Configuration field for Queue Manager Host Name.
 * 
 * @author Noel.Ang@sun.com
 */
final class AppConfigQmgrHostField extends ApplicationConfigurationField {
    private String value = "";

    AppConfigQmgrHostField() {
        super("queuemanagerHost", "Queue Manager Host Name", SimpleType.STRING);
    }
    ...
    public Object clone() {
        AppConfigQmgrHostField clone = new AppConfigQmgrHostField();
