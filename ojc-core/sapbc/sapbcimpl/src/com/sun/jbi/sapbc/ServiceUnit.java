...
interface ServiceUnit {
     ...
     * @throws JBIException if unable to initialize this ServiceUnit
     */
    void init() throws JBIException;

    /**
     * Starts this ServiceUnit.  This involves activating all Endpoints that are
     * part of this ServiceUnit.
     *
     * @throws JBIException if any Endpoint fails to activate
     */
    void start() throws JBIException;

    /**
     * Stops this ServiceUnit.  This involves deactivating all Endpoints that
     * are part of this ServiceUnit;
     *
     * @throws JBIException if any Endpoint fails to deactivate
     */
     ...
     *
     * @throws JBIException upon error.
     */
    ...
    /**
     * Indicates whether the Service Unit has been initialized.
     */
    boolean isInitialized();

    /**
     * Indicates whether the Service Unit has been shut down.
     */
    boolean isShutdown();
}
