 ...
 * @author sweng
 */
public class SAPBindingBootstrapTest extends org.jmock.cglib.MockObjectTestCase {
    SAPBindingBootstrap instance = null;
    ...
    public SAPBindingBootstrapTest(String testName) {
        super(testName);
    }

    protected void setUp() throws Exception {
        instance = new SAPBindingBootstrap();
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(SAPBindingBootstrapTest.class);
        
        return suite;
    }

    /**
     * Test of init method, of class com.sun.jbi.sapbc.bootstrap.SAPBindingBootstrap.
     */
    public void testInit() throws Exception {
        ...
        componentContext.expects(atLeastOnce()).method("getLogger").with(eq(SAPBindingBootstrap.class.getName()), eq("com.sun.jbi.sapbc.bootstrap.messages.Bundle")).will(returnValue(Logger.getLogger(SAPBindingBootstrap.class.getName(), "com.sun.jbi.sapbc.bootstrap.messages.Bundle")));
        componentContext.expects(atLeastOnce()).method("getLogger").with(eq("com.sun.jbi.sapbc.bootstrap.InstallerExt"), eq("com.sun.jbi.sapbc.bootstrap.messages.Bundle")).will(returnValue(Logger.getLogger("com.sun.jbi.sapbc.bootstrap.InstallerExt", "com.sun.jbi.sapbc.bootstrap.messages.Bundle")));
    ...
    /**
     * Test of onInstall method, of class com.sun.jbi.sapbc.bootstrap.SAPBindingBootstrap.
     */
...
//        componentContext.expects(atLeastOnce()).method("getMBeanServer").will(returnValue(mbServer.proxy()));
//        componentContext.expects(once()).method("getWorkspaceRoot").will(returnValue("test/com/sun/jbi/sapbc/testDir"));
...
//    }
    ...
    /**
     * Test of cleanUp method, of class com.sun.jbi.sapbc.bootstrap.SAPBindingBootstrap.
     */
