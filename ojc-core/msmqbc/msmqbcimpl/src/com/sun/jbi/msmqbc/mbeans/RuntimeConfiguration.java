...
public class RuntimeConfiguration implements RuntimeConfigurationMBean, NotificationEmitter {
    ...
    public void setThreads(Integer val) throws InvalidAttributeValueException, MBeanException {
        ...
        try {
            ...
            mLogger.log(Level.SEVERE, "RuntimeConfiguration_INVALID_ARGUMENT", new Object[] { attrName, ex });

            String errMsg = mMessages.getString("RuntimeConfiguration_INVALID_ARGUMENT", new Object[] { attrName, ex });
            throw new InvalidAttributeValueException(errMsg);
        }
        if (newVal.intValue() < MIN_THREADS || newVal.intValue() > MAX_THREADS) {
            mLogger.log(Level.SEVERE, "RuntimeConfiguration_INVALID_VALUE", new Object[] { newVal, attrName,
                    new Long(MIN_THREADS), new Long(MAX_THREADS) });

            String errMsg = mMessages.getString("RuntimeConfiguration_INVALID_VALUE", new Object[] { newVal, attrName,
                    new Long(MIN_THREADS), new Long(MAX_THREADS) });
            throw new InvalidAttributeValueException(errMsg);
        }
    ...
    private void persistConfiguration() throws MBeanException {
        ...
        try {
            ...
            mLogger.log(Level.SEVERE, "RuntimeConfiguration_PERSIST_FAILED", new Object[] { mWorkspaceRoot, ex });

            String errMsg = mMessages.getString("RuntimeConfiguration_PERSIST_FAILED", new Object[] { mWorkspaceRoot,
                    ex });
