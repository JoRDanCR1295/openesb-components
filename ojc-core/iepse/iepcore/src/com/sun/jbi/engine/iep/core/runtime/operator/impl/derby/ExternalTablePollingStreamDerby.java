...
/*
 * @(#)ExternalTablePollingStreamDerby.java 
 *
 ...
 * @author Ritesh Adval
 */
public class ExternalTablePollingStreamDerby implements ExternalTablePollingStreamDb {

    private static final Messages mMessages = Messages.getMessages(ExternalTablePollingStreamDerby.class);
    private DerbySpecial mDerbySpecial;

    public ExternalTablePollingStreamDerby(DerbySpecial derbySpecial) {
    ...
    public PreparedStatement[] createOperateStatements(Connection source, Connection target, ExternalTablePollingStream op) throws Exception {
        ...
        //targetSql.append("CURRENT_TIMESTAMP_NS()");
