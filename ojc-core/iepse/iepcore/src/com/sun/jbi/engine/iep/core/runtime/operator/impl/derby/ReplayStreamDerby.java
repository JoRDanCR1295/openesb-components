 ...
 * @author Ritesh Adval
 */
public class ReplayStreamDerby implements ReplayStreamDb {

    private static final Messages mMessages = Messages.getMessages(ReplayStreamDerby.class);
    private DerbySpecial mDerbySpecial;

    public ReplayStreamDerby(DerbySpecial derbySpecial) {
