 ...
 * @author Bing Lu
 */
public class TimeBasedAggregatorOracle implements TimeBasedAggregatorDb {
    private static final Messages mMessages = Messages.getMessages(TimeBasedAggregatorOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public TimeBasedAggregatorOracle(OracleSpecial oracleSpecial) {
