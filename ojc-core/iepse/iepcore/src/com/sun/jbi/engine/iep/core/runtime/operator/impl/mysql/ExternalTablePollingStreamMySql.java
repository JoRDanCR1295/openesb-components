 ...
 * @author Bing Lu
 */
public class ExternalTablePollingStreamMySql implements ExternalTablePollingStreamDb {
    private static final Messages mMessages = Messages.getMessages(ExternalTablePollingStreamMySql.class);
    
    private MySqlSpecial mMySqlSpecial;
    
    public ExternalTablePollingStreamMySql(MySqlSpecial mySqlSpecial) {
