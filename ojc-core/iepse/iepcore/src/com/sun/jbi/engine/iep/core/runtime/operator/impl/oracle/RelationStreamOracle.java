 ...
 * @author Bing Lu
 */
public class RelationStreamOracle implements RelationStreamDb {
    private static final Messages mMessages = Messages.getMessages(RelationStreamOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public RelationStreamOracle(OracleSpecial oracleSpecial) {
