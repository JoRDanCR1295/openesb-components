 ...
 * @author Bing Lu
 * 
 * Fortent : Based on InsertStreamOracle.java
 */
public class InsertStreamDB2 implements InsertStreamDb {
    private static final Messages mMessages = Messages.getMessages(InsertStreamDB2.class);
    
    private DB2Special mDB2Special;
    
    public InsertStreamDB2(DB2Special dB2Special) {
