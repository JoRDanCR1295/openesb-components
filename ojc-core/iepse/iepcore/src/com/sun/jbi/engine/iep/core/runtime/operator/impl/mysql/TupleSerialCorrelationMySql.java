...
/*
 * @(#)TupleSerialCorrelationMySql.java
 *
 ...
 * @author Bing Lu
 */
public class TupleSerialCorrelationMySql implements TupleSerialCorrelationDb {
    private static final Messages mMessages = Messages.getMessages(TupleSerialCorrelationMySql.class);
    
    private MySqlSpecial mMySqlSpecial;
    
    public TupleSerialCorrelationMySql(MySqlSpecial mySqlSpecial) {
