 ...
 * @author Bing Lu
 * 
 * Fortent : Based on UnionOracle.java
 */
public class UnionDB2 implements UnionDb {
    private static final Messages mMessages = Messages.getMessages(UnionDB2.class);
    
	private DB2Special mDB2Special;

	public UnionDB2(DB2Special dB2Special) {
...
//		Fortent : sequence change
        sb.append("NEXT VALUE FOR " + seqName + "," + COL_TIMESTAMP + "," + " FROM (SELECT DISTINCT ");
