 ...
 * @author Bing Lu
 */
public class StreamProjectionAndFilterOracle implements StreamProjectionAndFilterDb {
    private static final Messages mMessages = Messages.getMessages(StreamProjectionAndFilterOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public StreamProjectionAndFilterOracle(OracleSpecial oracleSpecial) {
