 ...
 * @author Bing Lu
 */
public class PartitionedWindowDerby implements PartitionedWindowDb {
    private static final Messages mMessages = Messages.getMessages(PartitionedWindowDerby.class);
    
    private DerbySpecial mDerbySpecial;
    
    public PartitionedWindowDerby(DerbySpecial derbySpecial) {
