 ...
 * @author Bing Lu
 */
public class RelationAggregatorOracle implements RelationAggregatorDb {
    private static final Messages mMessages = Messages.getMessages(RelationAggregatorOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public RelationAggregatorOracle(OracleSpecial oracleSpecial) {
