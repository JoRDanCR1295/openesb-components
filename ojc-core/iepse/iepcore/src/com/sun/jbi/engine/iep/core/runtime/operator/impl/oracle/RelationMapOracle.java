 ...
 * @author Bing Lu
 */
public class RelationMapOracle implements RelationMapDb {
    private static final Messages mMessages = Messages.getMessages(RelationMapOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public RelationMapOracle(OracleSpecial oracleSpecial) {
    ...
    public PreparedStatement[] createOperateStatements(Connection con, RelationMap op) throws Exception {
        ...
        sb.append(sequenceName + ".NextVal,");
