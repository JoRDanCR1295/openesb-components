 ...
 * @author Bing Lu
 */
public class DistinctOracle implements DistinctDb {
    private static final Messages mMessages = Messages.getMessages(DistinctOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public DistinctOracle(OracleSpecial oracleSpecial) {
