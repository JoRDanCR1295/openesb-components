 ...
 * @author Bing Lu
 */
public class UnionAllOracle implements UnionAllDb {
    private static final Messages mMessages = Messages.getMessages(UnionAllOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public UnionAllOracle(OracleSpecial oracleSpecial) {
