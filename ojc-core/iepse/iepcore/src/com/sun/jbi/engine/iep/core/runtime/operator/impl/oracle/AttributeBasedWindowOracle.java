 ...
 * @author Bing Lu
 */
public class AttributeBasedWindowOracle implements AttributeBasedWindowDb {
    private static final Messages mMessages = Messages.getMessages(AttributeBasedWindowOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public AttributeBasedWindowOracle(OracleSpecial oracleSpecial) {
