 ...
 * @author Bing Lu
 */
public class InsertStream extends AbstractOperator {
    public InsertStream(Map prop) {
        initialize(prop);
    }
    ...
    protected void createOperateStmt(Connection con) throws Exception {
        ...
        mOperateStmt = mDbSpecial.getInsertStreamDb().createOperateStatements(con, this);
    }
