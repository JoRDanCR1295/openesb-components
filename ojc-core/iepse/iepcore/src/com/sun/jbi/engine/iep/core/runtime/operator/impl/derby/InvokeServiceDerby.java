 ...
 * @author Bing Lu
 */
public class InvokeServiceDerby implements InvokeServiceDb {
    private static final Messages mMessages = Messages.getMessages(InvokeServiceDerby.class);
    
    private DerbySpecial mDerbySpecial;
    
    public InvokeServiceDerby(DerbySpecial derbySpecial) {
