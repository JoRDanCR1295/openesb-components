...
public class NameUtil {
    private static final Messages mMessages = Messages.getMessages(NameUtil.class);

    /** Holds a list of reserved identifiers.  */
    private static final HashSet<String> JAVA_KEYWORD = new HashSet<String>();
    static {
...
//
    ...
    public static String makeInstanceId(String str) {
        StringBuffer sb = new StringBuffer(str.length());
        
        int dotIndex = str.lastIndexOf(".");
        if(dotIndex != -1) {
            str = str.substring(0, dotIndex) + "_" + str.substring(dotIndex +1, str.length());
        }
    ...
    public static String getUid() {
        ...
        try {
            ...
            mMessages.log(Level.WARNING, "NameUtil.Fail_to_create_uid_using_ip_address", e);
            mIP = "localhost";
        }
        return mIP + "/" + uid;
    }
    ...
    public static void main(String[] args) {
        ...
        mMessages.logOriginal(Level.INFO, makeAlphaNumId(sb.toString()));
    }
}
