 ...
 * @author Bing Lu
 */
public class IntersectOracle implements IntersectDb {
    private static final Messages mMessages = Messages.getMessages(IntersectOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public IntersectOracle(OracleSpecial oracleSpecial) {
