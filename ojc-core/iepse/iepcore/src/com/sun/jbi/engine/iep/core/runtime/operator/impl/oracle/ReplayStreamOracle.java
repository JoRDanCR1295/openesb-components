 ...
 * @author Ritesh Adval
 */
public class ReplayStreamOracle implements ReplayStreamDb {
    private static final Messages mMessages = Messages.getMessages(ReplayStreamOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public ReplayStreamOracle(OracleSpecial oracleSpecial) {
