 ...
 * @author Bing Lu
 * 
 * Fortent : Based on InvokeStreamOracle.java
 */
public class InvokeStreamDB2 implements InvokeStreamDb {
    private static final Messages mMessages = Messages.getMessages(InvokeStreamDB2.class);
    
    private DB2Special mDB2Special;
    
    public InvokeStreamDB2(DB2Special dB2Special) {
