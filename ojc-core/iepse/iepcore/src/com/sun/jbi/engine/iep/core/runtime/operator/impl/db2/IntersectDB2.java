 ...
 * @author Bing Lu
 * 
 * Fortent : Based on IntersectOracle.java
 */
public class IntersectDB2 implements IntersectDb {
    private static final Messages mMessages = Messages.getMessages(IntersectDB2.class);
    
    private DB2Special mDB2Special;
    
    public IntersectDB2(DB2Special dB2Special) {
