 ...
 * @author Bing Lu
 */
public class DeleteStream extends AbstractOperator {
    public DeleteStream(Map prop) {
        initialize(prop);
    }
    ...
    protected void createOperateStmt(Connection con) throws Exception {
        ...
        mOperateStmt = mDbSpecial.getDeleteStreamDb().createOperateStatements(con, this);
    }
