 ...
 * @author Bing Lu
 */
public class GapWindowOracle implements GapWindowDb {
    private static final Messages mMessages = Messages.getMessages(GapWindowOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public GapWindowOracle(OracleSpecial oracleSpecial) {
