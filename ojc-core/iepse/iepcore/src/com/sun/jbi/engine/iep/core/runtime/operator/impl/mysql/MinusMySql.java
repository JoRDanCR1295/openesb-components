 ...
 * @author Bing Lu
 */
public class MinusMySql implements MinusDb {
    private static final Messages mMessages = Messages.getMessages(MinusMySql.class);
    
    private MySqlSpecial mMySqlSpecial;
    
    public MinusMySql(MySqlSpecial mySqlSpecial) {
