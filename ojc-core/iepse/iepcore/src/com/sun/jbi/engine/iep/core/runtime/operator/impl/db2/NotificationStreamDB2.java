 ...
 * @author Bing Lu
 * 
 * Fortent : Based on NotificationStreamOracle.java
 */
public class NotificationStreamDB2 implements NotificationStreamDb {
    private static final Messages mMessages = Messages.getMessages(NotificationStreamDB2.class);
    
    private DB2Special mDB2Special;
    
    public NotificationStreamDB2(DB2Special dB2Special) {
...
//		Fortent : jtaylor : DB2 time duration replacement for "days"
        double microseconds = size * 1000;
        String duration = microseconds + " microseconds ";
...
//		Fortent : sequence change
        ...
        sb.append("t." + COL_SEQID + " AS " + COL_SEQID + ", ");
//		Fortent : duration replacement for "days"
        sb.append("t." + COL_TIMESTAMP + " + " + duration  + " AS " + COL_TIMESTAMP + " FROM ");
        sb.append(tableName);
        sb.append(" t WHERE ? < t." + COL_TIMESTAMP + " AND t." + COL_TIMESTAMP + " <= ? ");
        sb.append(" AND NOT EXISTS (SELECT 'x' FROM " + inputTableName + " u WHERE ");
        sb.append("u." + COL_TIMESTAMP + " <= t." + COL_TIMESTAMP);
...
//		Fortent : duration replacement for "days"
        sb.append("u." + COL_TIMESTAMP + " + " + duration + " AS " + COL_TIMESTAMP + " FROM ");
