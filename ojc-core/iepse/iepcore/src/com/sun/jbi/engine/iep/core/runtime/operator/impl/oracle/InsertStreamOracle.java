 ...
 * @author Bing Lu
 */
public class InsertStreamOracle implements InsertStreamDb {
    private static final Messages mMessages = Messages.getMessages(InsertStreamOracle.class);
    ...
    public InsertStreamOracle(OracleSpecial oracleSpecial) {
