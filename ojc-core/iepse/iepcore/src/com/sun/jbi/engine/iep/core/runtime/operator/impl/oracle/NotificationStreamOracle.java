 ...
 * @author Bing Lu
 */
public class NotificationStreamOracle implements NotificationStreamDb {
    private static final Messages mMessages = Messages.getMessages(NotificationStreamOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public NotificationStreamOracle(OracleSpecial oracleSpecial) {
    ...
    public PreparedStatement[] createOperateStatements(Connection con, NotificationStream op) throws Exception {
        ...
        sb.append("t." + COL_SEQID + " AS " + COL_SEQID + ", ");
        sb.append("t." + COL_TIMESTAMP + " + " + days  + " AS " + COL_TIMESTAMP + " FROM ");
        sb.append(tableName);
        sb.append(" t WHERE ? < t." + COL_TIMESTAMP + " AND t." + COL_TIMESTAMP + " <= ? ");
        sb.append(" AND NOT EXISTS (SELECT 'x' FROM " + inputTableName + " u WHERE ");
        sb.append("u." + COL_TIMESTAMP + " <= t." + COL_TIMESTAMP);
        ...
        sb.append("u." + COL_TIMESTAMP + " + " + days + " AS " + COL_TIMESTAMP + " FROM ");
