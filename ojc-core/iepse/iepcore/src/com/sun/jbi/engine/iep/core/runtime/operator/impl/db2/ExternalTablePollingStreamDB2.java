...
/*
 * @(#)ExternalTablePollingStreamOracle.java 
 *
 ...
 * @author Ritesh Adval
 * 
 * Fortent : Based on ExternalTablePollingStreamOracle.java
 */
public class ExternalTablePollingStreamDB2 implements ExternalTablePollingStreamDb {
    private static final Messages mMessages = Messages.getMessages(ExternalTablePollingStreamDB2.class);

    private DB2Special mDB2Special;
    
    public ExternalTablePollingStreamDB2(DB2Special dB2Special) {
    ...
    public PreparedStatement[] createOperateStatements(Connection source, Connection target, ExternalTablePollingStream op) throws Exception {
...
//          add order by in  sourceSql2
        ...
        return new PreparedStatement[]{sourceStmt, targetStmt};
    }
