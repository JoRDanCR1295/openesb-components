...
/*
 * @(#)StreamProjectionAndFilterMySql.java
 *
 ...
 * @author Bing Lu
 */
public class StreamProjectionAndFilterMySql implements StreamProjectionAndFilterDb {
    private static final Messages mMessages = Messages.getMessages(StreamProjectionAndFilterMySql.class);
    
    private MySqlSpecial mMySqlSpecial;
    
    public StreamProjectionAndFilterMySql(MySqlSpecial oracleSpecial) {
        mMySqlSpecial = oracleSpecial;
    }
