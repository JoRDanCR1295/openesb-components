 ...
 * @author Bing Lu
 */
public class InvokeServiceOracle implements InvokeServiceDb {
    private static final Messages mMessages = Messages.getMessages(InvokeServiceOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public InvokeServiceOracle(OracleSpecial oracleSpecial) {
