 ...
 * @author Ritesh Adval
 */
public class ExternalTablePollingStreamOracle implements ExternalTablePollingStreamDb {
    private static final Messages mMessages = Messages.getMessages(ExternalTablePollingStreamOracle.class);
    
    private OracleSpecial mOracleSpecial;
    
    public ExternalTablePollingStreamOracle(OracleSpecial oracleSpecial) {
