 ...
 * @author Bing Lu
 * 
 * Fortent : Based on MinusOracle.java
 */
public class MinusDB2 implements MinusDb {
    private static final Messages mMessages = Messages.getMessages(MinusDB2.class);
    
    private DB2Special mDB2Special;
    
    public MinusDB2(DB2Special dB2Special) {
