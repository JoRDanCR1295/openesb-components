 ...
 * @author Bing Lu
 */
public class InvokeServiceDB2 implements InvokeServiceDb {
    private static final Messages mMessages = Messages.getMessages(InvokeServiceDB2.class);
    
    private DB2Special mDB2Special;
    
    public InvokeServiceDB2(DB2Special oracleSpecial) {
        mDB2Special = oracleSpecial;
    }
    ...
    public PreparedStatement[] createOperateStatements(Connection con, InvokeService op) throws Exception {
        ...
        // INSERT INTO S2 (Name, Value, Amount, SeqId, Timestamp) VALUES (?, ?, ?, S2_seqid.nextVal, ?)
