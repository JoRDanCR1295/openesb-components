 ...
 * @author Bing Lu
 */
public class GapWindowDerby implements GapWindowDb {
    private static final Messages mMessages = Messages.getMessages(GapWindowDerby.class);
    
    private DerbySpecial mDerbySpecial;
    
    public GapWindowDerby(DerbySpecial derbySpecial) {
