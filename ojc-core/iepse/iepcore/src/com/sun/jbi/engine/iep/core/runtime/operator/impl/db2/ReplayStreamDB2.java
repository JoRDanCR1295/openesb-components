 ...
 * @author Ritesh Adval
 * 
 * Fortent : Based on ReplayStreamOracle.java
 */
public class ReplayStreamDB2 implements ReplayStreamDb {
    private static final Messages mMessages = Messages.getMessages(ReplayStreamDB2.class);
    
    private DB2Special mDB2Special;
    
    public ReplayStreamDB2(DB2Special dB2Special) {
