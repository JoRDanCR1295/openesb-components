 ...
 * @author Bing Lu
 * 
 * Fortent : Based on UnionAllOracle.java
 */
public class UnionAllDB2 implements UnionAllDb {
    private static final Messages mMessages = Messages.getMessages(UnionAllDB2.class);
    
	private DB2Special mDB2Special;

	public UnionAllDB2(DB2Special dB2Special) {
...
//      sb.append(COL_INPUT_ID + "," + COL_INPUT_SEQID + "," + seqName + ".NextVal," + COL_TIMESTAMP + ",'+' FROM ( ");
//		Fortent : sequence change
        sb.append(COL_INPUT_ID + "," + COL_INPUT_SEQID + "," + "NEXT VALUE FOR " + seqName + COL_TIMESTAMP + ",'+' FROM ( ");
