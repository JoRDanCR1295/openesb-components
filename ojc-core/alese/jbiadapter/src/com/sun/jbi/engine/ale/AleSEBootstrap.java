...
/**
 * Bootstrap implementation for ALE Service Engine.
 * 
 * @author Kevan Simpson
 */
public class AleSEBootstrap extends AbstractBootstrap {
    public AleSEBootstrap() {
    }
    ...
    protected Object initInstallMBean(ComponentContext ctx)
        ...
        try {
            ...
            return new AleSEConfiguration(ctx, getConfig());
        }
        catch (Exception e) {
            throw error(e, "ALESE-6001: AleSEBootstrap installation MBean failed to initialize: {0}",
                        e.getMessage());
        }
    }
}
