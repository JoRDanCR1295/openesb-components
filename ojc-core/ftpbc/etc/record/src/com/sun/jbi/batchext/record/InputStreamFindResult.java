...
/**
 * This class provides the user the results of the InputStreamFindAdapter's
 * find method.
 */
public class InputStreamFindResult 
{
    int recordSize = -1;
    boolean bLastRecord = false;
    
    /** Creates new InputStreamFindResult */
    public InputStreamFindResult(int ndx, boolean bLastRecord) 
    {
        this.recordSize = ndx;
        this.bLastRecord = bLastRecord;
    }
