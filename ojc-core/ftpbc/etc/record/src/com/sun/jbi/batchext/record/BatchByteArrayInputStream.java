...
/*
 * @(#)BatchByteArrayInputStream.java 
 *
 ...
 * @see     InputStreamFindAdapter
 */

public class BatchByteArrayInputStream extends ByteArrayInputStream {
     ...
     * Pass-through constructor.
     */
    public  BatchByteArrayInputStream(byte[] buff, int off, int len) {
        super(buff, off, len);
    }
     ...
     * @return If 'n' is greater than or equal to zero, return whatever
