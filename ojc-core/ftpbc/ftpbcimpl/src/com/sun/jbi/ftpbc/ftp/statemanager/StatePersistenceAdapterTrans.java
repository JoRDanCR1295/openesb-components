...
/*
 * @(#)StatePersistenceAdapterTrans.java 
 *
...
/**
 * Interface to allow storage of state information to persistent store
 * in transactional mode.
 */
public interface StatePersistenceAdapterTrans {

    /**
     * Called to save state information.  The information saved
     * is in a pre-prepared state.  To commit the saved information
     * prepare and commit must be called.
     *
     * @see         #prepare
     * @see         #commit
     * @see         #rollback
     *
     * @throws      StatePersistenceException if state information was
    ...
    /**
     * Called to rollback any work done in prepareSave. Upon successfully
     * returning from rollbackSave, the state of this object will be as
     * if prepareSave did not get called.
     *
     * @param       state   A java.io.Serializable object to save.
     *
     * @see         #prepareSave
     *
     * @throws      StatePersistenceException if prepareSave was not called
     *              or the rollback failed.
     */
     ...
     *
     * @throws      StatePersistenceException when restore fails.
     */
    public java.io.Serializable restore() throws StatePersistenceException;
