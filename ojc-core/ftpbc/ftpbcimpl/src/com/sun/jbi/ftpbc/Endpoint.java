...
public interface Endpoint {
    ...
    public static final String ENDPOINT_TYPE_INBOUND = StatusProviderHelper.CONSUMING_ID;
    public static final String ENDPOINT_TYPE_OUTBOUND = StatusProviderHelper.PROVISIONING_ID;
    ...
    ////////
    //
    //  FTP Binding specific Endpoint.  
    //
    ////////
    FTPAddress getAddress();

    void setAddress(FTPAddress address);

    FTPBinding getBinding();

    void setBinding(FTPBinding binding);

    Map getOperations();

    void setOperations(Map operations);

    String getOperationUUID(QName opName);
