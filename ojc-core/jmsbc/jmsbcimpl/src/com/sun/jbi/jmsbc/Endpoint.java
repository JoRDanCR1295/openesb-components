...
public interface Endpoint {
    ...
    JMSAddress getJMSAddress();
    
    void setJMSAddress(JMSAddress address);

    JMSBinding getJMSBinding();

    void setJMSBinding(JMSBinding binding);

    Map getJMSOperations();

    void setJMSOperations(Map operations);

    JMSInput getJMSOperationInput(JMSOperation operation);

    void setJMSOperationInput(JMSOperation operation,
                              JMSInput operationInput);

    JMSOutput getJMSOperationOutput(JMSOperation operation);

    void setJMSOperationOutput(JMSOperation operation,
    ...
    QName createOperationAddress(String opName);
    
    void setServiceUnitID (String serviceUnitID);
    ...
    void setApplicationConfigurationName(String config);
    
    ServiceQuality[] getServiceQualities();

    void setServiceQualities(ServiceQuality[] qos);
