...
public class TestAttachmentsForTextMessage extends IntegrationTestCase {
	...
	private static final String MSG_REPLY = "test_Integration_TestAttachmentsForTextMessage_Reply";
	private static final String MSG_FAILED = "test_Integration_TestAttachmentsForTextMessage_Failed";
	private static final String DESTINATION_QUEUE = "TestAttachmentsQueue";
	private static final String MSG = "test_Integration_TestAttachmentsForTextMessage";
	
	public void test_Integration_TestBinaryAttachment_SendText_As_Attachment() throws Throwable {
	...
	public void test_Integration_TestBinaryAttachment_SendText_As_Attachment_Reply_Inline() throws Throwable {
		//Activate end point and message processor
		final ComponentContext context = JbiHelper.getComponentContext();
		drainMessages(DESTINATION_QUEUE, JMSConstants.QUEUE, context);
...
//	}
	...
	private static class MessageConsumerImpl implements MessageConsumer{
		...
		public void onMessage(MessageExchange ex) throws Exception {
			...
			if(sendInline){
				xml = JbiHelper.wrapIntoJBIMessage(MESSAGE_REPLY, new String[] {reply});
			}else{
		    	...
		    	nm.addAttachment(cid, new DataHandler(new JMSBCDataSource(
						new ByteArrayInputStream(reply.getBytes()), "part1")));
			}
	...
	private String createTestSU1() throws IOException {
		...
		su.addWsdl(Configuration.getPath(getClass(), "JMS-Text-1.wsdl"));
