...
package com.sun.jbi.cam.services.administration.providers.glassfish;
...
import com.sun.jbi.cam.services.administration.providers.ServerEventBroadcaster;
import com.sun.jbi.cam.services.administration.providers.ServerEventListener;
import com.sun.jbi.cam.services.administration.providers.glassfish.connector.RemoteServerConnector;
...
public class ServerInformationImpl implements ServerInformation,
    ...
    private void initialize() throws InstanceNotFoundException,
        ...
        mLog = java.util.logging.Logger
                .getLogger("com.sun.jbi.cam.services.administration.providers.glassfish");
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationgetClusterNames()
     */
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationgetClusteredServerNames()
     */
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationgetInstallRootKey()
     */
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SeServerInformationetInstanceName()
     */
     ...
     * 
     * @return the instance root property
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationgetInstanceRootKey()
     */
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationgetMBeanServerConnection(java.lang.String,
     *      boolean)
     */
    public MBeanServerConnection getMBeanServerConnection(String instanceName,
			boolean forceNew) throws IOException, InstanceException {
	 ...
	 * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationgetServersInCluster(java.lang.String)
	 */
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationgetStandaloneServerNames()
     */
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SeServerInformationetTargetName()
     */
     ...
     * 
     * @return the target name.
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SeServerInformationetTargetName(java.lang.String)
     */
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationisCluster(java.lang.String)
     */
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationisClusteredServer(java.lang.String)
     */
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationisDAS()
     */
     ...
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationisInstanceUp(java.lang.String)
     */
     ...
     * 
     * @return true if the target is a standalone server
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationisStandaloneServer(java.lang.String)
     */
     ...
     *         cluster name
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.SServerInformationisValidTarget(java.lang.String)
     */
     ...
     * 
     * 
     * @see com.sun.jbi.cam.services.administration.providers.glassfish.ServerInformation#supportsMultipleServers()
     */
     ...
     * 
     * @see com.sun.jbi.cam.services.administration.providers.ServerEventBroadcaster#addListener(com.sun.jbi.cam.services.administration.providers.ServerEventListener)
     */
     ...
     *            name of the standalone instance.
     * 
     * @see com.sun.jbi.cam.services.administration.providers.ServerEventBroadcaster#removeListener(com.sun.jbi.cam.services.administration.providers.ServerEventListener)
     */
    ...
    public static void main(String[] args) {
        ...
        portNumber = 5651; // CAS
        MBeanServerConnection connection = null;
        connection = RemoteServerConnector.getConnection(hostName, portNumber,
                userName, password);
        if (connection != null) {
            System.out.println(connection.toString());
            ServerInformationImpl info = null;
            try {
                info = new ServerInformationImpl(connection);
                if (info != null) {
                    System.out.println("Install Root Key: "
                            + info.getInstallRootKey());
                    System.out.println("Instance Name: "
                            + info.getInstanceName());
                    System.out.println("Instance Root Key: "
                            + info.getInstanceRootKey());
                    try {
                    ...
                    try {
                        System.out
                                .println("== List of Clustered Server Names ==");
                        Set<String> set = info.getClusteredServerNames();
                        for (String clusterName : set) {
                            System.out.println("ClusterServerName: "
                                    + clusterName);
                        }
                    } catch (ConfigException e) {
                        e.printStackTrace();
                    ...
                    try {
                        System.out
                                .println("== List of Standalone Server Names ==");
                        Set<String> set = info.getStandaloneServerNames();
                        for (String serverName : set) {
                            System.out.println("StandaloneServerName: "
                                    + serverName);
                        }
                    } catch (ConfigException e) {
                        e.printStackTrace();
                    ...
                    try {
                        System.out.println("== List of Clustered Names ==");
                        Set<String> set = info.getClusterNames();
                        for (String clusterName : set) {
                            System.out.println("ClusterName: " + clusterName);
                            Set<String> serverSet = info
                                    .getServersInCluster(clusterName);
            ...
            System.out
                    .println("Connection to MBeanServer could not be retrieved.");
        }
