...
public class DBManager extends BaseBean{
    ...
    private static final String DB_JNDI_KEY = "DatabaseJNDIName";
    private static final String SELECT_STATE_QUERY = 
            "select * from STATE";
    private static final String SELECT_STATE_QUERY_WITH_FILTER = 
        "select * from STATE WHERE BPELID IN (%BPELS_IDS%)";
    ...
    public List<SimpleVariable> getAllSimpleVars(String bpid){
        ...
        try {
            conn = ds.getConnection();
            Statement stmt = conn.createStatement();
            String query = "select * from VARIABLESIMPLE " +
    		"where bpid=" + "'" + bpid + "'";
 //           System.out.println(">>>>>>>>>>>>> getSimpleVarsByBPID: query" + query);
    ...
    public List<String> getInstancesIDDoneList() {
        ...
        String query = "select stateid from STATE where status='DONE'";
    ...
    private void initDataSource(){
        ...
        String dsJndiName = (String)props.get(DB_JNDI_KEY);
        try{
