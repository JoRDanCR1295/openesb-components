    ...
    <f:view>
        <webuijsf:page frame="true">
            <webuijsf:html>
                ...
                -->
                <f:loadBundle basename="com.sun.jbi.cam.plugins.bpelse.table.resources.Bundle" var="bptablemsgs" />
                 ...
                 <webuijsf:form id="form1">
                    <webuijsf:contentPageTitle id="pagetitle" 
                            ...
                            helpText="#{bptablemsgs.bpelse_instances_table_inlinehelp}" />
                    <br />
                    <div class="ConMgn"> 
                        
              <webuijsf:button text="#{bptablemsgs.bpelse_instances_delete_all}"
                               id="deleteAllInstances" 
                               actionExpression="#{state.deleteAll}" 
                               toolTip="#{bptablemsgs.bpelse_instances_delete_all_tip}"/>
              <br/>
              <br/>
              <!-- Instances Table -->
