    ...
    <f:view>
        <webuijsf:page frame="true">
            ...
            <webuijsf:form id="form1"> 
                ...
                <webuijsf:tabSet id="tabs" selected="tabBlank" binding="#{BPTabsBean.tabSet}">
                    <!---
                    ...
                    <webuijsf:tab id="tabBPInstances" text="#{msgs.bpelse_instances_tab_title}" url="/faces/plugins/bpelse/instancesTable.jsp" target="tabBottomFrame" />                    
                    -->    
                </webuijsf:tabSet >                
