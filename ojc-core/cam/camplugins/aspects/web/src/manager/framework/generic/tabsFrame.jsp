...
<jsp:root version="1.2" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html" xmlns:jsp="http://java.sun.com/JSP/Page" xmlns:webuijsf="http://www.sun.com/webui/webuijsf">
    ...
    <f:view>
        <webuijsf:page frame="true">
            <webuijsf:html>
                <webuijsf:head title="Composite Application Manager - Apects Plugin" />
                <webuijsf:frameSet id="tabFrameSet"  rows="50px,*"  >
                     <webuijsf:frame name="tabTopFrame" toolTip="topFrame" url="/faces/manager/framework/generic/tabs.jsp" frameBorder="false" noResize="false" scrolling="false" />
