 ...
 * @author graj
 */
public class AspectsServiceProvider extends StandardMBean implements AspectsServiceProviderMBean, MBeanRegistration {
    
    private MBeanServer mbeanServer;
    
    private Logger logger = Logger.getLogger(AspectsServiceProvider.class.getName());
    ...
    static final public String BASENAME = "com.sun.jbi.cam.plugins.aspects.resources.providerMappings";
     ...
     */
    public AspectsServiceProvider() throws NotCompliantMBeanException {
        super(AspectsServiceProviderMBean.class);
    }
