...
public class ServiceEntry implements Serializable {
     ...
     * @param parameters
     */
    public ServiceEntry(ServiceType serviceType, Parameter inputParameters,
            List<Parameter> outputParameterList) {
        super();
        this.serviceType = serviceType;
        this.input = inputParameters;
        this.outputList = outputParameterList;
    }
     ...
     */
    public void setOutputList(List<Parameter> outputList) {
     ...
     * @return
     */
    public boolean addOutputParameter(Parameter parameter) {
        return this.outputList.add(parameter);
    }
     ...
     * @return
     */
    public boolean removeOutputParameter(Parameter parameter) {
        return this.outputList.remove(parameter);
    }
    ...
    public boolean equals(Object aThat) {
        ...
        if (!(aThat instanceof ServiceEntry)) {
            return false;
        }
        ...
        ServiceEntry that = (ServiceEntry) aThat;

        // now a proper field-by-field evaluation can be made
        return EqualsUtil.areEqual(this.input, that.input)
                && EqualsUtil.areEqual(this.outputList, that.outputList)
                && EqualsUtil.areEqual(this.serviceType, that.serviceType);
    }
    ...
    public int hashCode() {
        ...
        if (fHashCode == 0) {
            ...
            result = HashCodeUtil.hash(result, this.input);
            result = HashCodeUtil.hash(result, this.outputList);
            result = HashCodeUtil.hash(result, this.serviceType);
            fHashCode = result;
        }
        return fHashCode;
    }
    ...
    public void dump() {
        ...
        Iterator<Parameter> iterator = this.outputList.iterator();
