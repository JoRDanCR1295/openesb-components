...
package com.sun.jbi.cam.plugins.aspects;
...
public class ApplicationListener implements ServletContextListener {
    ...
    private static String ASPECTS_CONTEXT_STRING = "/aspects";
    private static String MBEAN_NAME = "com.sun.cam:type=plugins,name=aspects";
    private static String MBEAN_CLASS_NAME = "com.sun.jbi.cam.plugins.aspects.AspectsServiceProvider";
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        if(contextPath.endsWith(ASPECTS_CONTEXT_STRING) == false) {
            System.out.println("Context "+contextPath+" does not match "+ASPECTS_CONTEXT_STRING);
            return;
        }
        ///////////////////////////////////////////
    ...
    protected void registerApplication(ServletContextEvent event) {
        ...
        AspectsServiceProvider mbean = null;
        ...
        try {
            ...
            mbean = new AspectsServiceProvider();
        } catch (NotCompliantMBeanException ex) {
            ex.printStackTrace();
        }
        try {
            annotatedMbean = new AnnotatedStandardMBean(mbean,
                    AspectsServiceProviderMBean.class);
        } catch(NotCompliantMBeanException ex) {
            ex.printStackTrace();
        }
