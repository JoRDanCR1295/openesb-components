        ...
        <webuijsf:page frame="true">
            <webuijsf:html>
                ...
                <webuijsf:frameSet id="bpInstancesSvgFrameSet"  rows="50%,*"  >
                     <webuijsf:frame name="svgFrame" frameBorder="false" url="/faces/plugins/bpelse/svg.jsp"  noResize="false"/>
                     <webuijsf:frame name="instancesFrame" toolTip="topFrame" url="/faces/plugins/bpelse/instancesTable.jsp" frameBorder="false" noResize="true" scrolling="false" />
                </webuijsf:frameSet>
