            ...
            <webuijsf:html>
                ...
                <webuijsf:frameSet id="ServiceAssemblyFrameSet" rows="10%,90%" >
                     <webuijsf:frame id="saViewerControl" name="saViewerControl" 
                               ...
                               frameBorder="true"/>
                   <webuijsf:frameSet id="SVGServiceUnitFrameSet" rows="70%,*" >
                     <webuijsf:frame id="saViewerFrame" name="saViewerFrame" 
                               url="#{SVGRendererBean.serviceAssemblyURL}" 
                               frameBorder="true" 
                               noResize="false"
                               scrolling="true"/>
                    <webuijsf:frame id="serviceUnitFrame" name="serviceUnitFrame"  
                               url="#{SVGRendererBean.serviceUnitURL}" 
                               frameBorder="true" 
                               noResize="false"
                               scrolling="true"/>
                   </webuijsf:frameSet>
