...
public class Actions {
    ...
    protected static final Option[] moreActionsOptions = {
        new OptionTitle("table_ActionsMenuTitle"),
        new Option("ACTION1", "table_Action1"),
        new Option("ACTION2", "table_Action2"),
        new Option("ACTION3", "table_Action3"),
        new Option("ACTION4", "table_Action4"),
    };
    ...
    public void action() {
        ...
        if (param != null) {
            message = "table_embeddedActionMsg" + " " + param;
        } else {
            message = "table_tableActionMsg";
        }
    ...
    public void moreActions() {
        //group.getMessages().setMessage("table_moreActionsMsg");
    }
