...
public class Filter {
    ...
    protected static final Option[] filterOptions = {
        new Option("FILTER0", "table_filterAllItems"),
        new Option("FILTER1", "table_filter1"),
        new Option("FILTER2", "table_filter2"),
    };
    ...
    public void applyBasicFilter() {
        if (basicFilter.equals("FILTER1")) {
            filterText = "table_filter1";
        } else if (basicFilter.equals("FILTER2")) {
            filterText = "table_filter2";
        } else {
            filterText = null;
        }
