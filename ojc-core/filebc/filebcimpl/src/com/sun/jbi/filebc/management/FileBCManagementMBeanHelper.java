...
/*
 * @(#)$Id: FileBCManagementMBeanHelper.java,v 1.2 2010/02/04 02:58:53 fkieviet Exp $
 *
 ...
 * @author sweng
 */
public class FileBCManagementMBeanHelper {
     ...
     */
    public FileBCManagementMBeanHelper(ObjectName objName, MBeanServer mbeanServer) throws MalformedObjectNameException {
        mObjName = objName;
