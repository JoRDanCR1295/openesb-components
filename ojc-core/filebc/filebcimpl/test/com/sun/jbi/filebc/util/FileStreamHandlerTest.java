...
public class FileStreamHandlerTest extends TestCase {
    ...
    public void testGetAllContentsAsBytesCase1() throws Exception {
        ...
        assertTrue("This is a test of Single_Record_Per_File scenario\r\n".equals(new String(result)) ||
    ...
    public void testReadNextRecordCase3() throws Exception {
        ...
        assertTrue("This is record number1\r\n\r\n".equals(new String(result)) ||
        ...
        assertTrue("\r\nThis is record number 2".equals(new String(result)) ||
                "\nThis is record number 2".equals(new String(result)));
        ...
        assertTrue("This is record number3\r\n\r\n".equals(new String(result)) ||
                "This is record number3\n\n".equals(new String(result)));
    ...
    public void testReadNextRecordCase4() throws Exception {
        ...
        // read the last record
        //expResult = "\r\nThis is record numbe";
        result = instance.readNextRecord();
        if (result == null) {
            fail("Unexpected IO error has occurred");
        }
        assertTrue("\r\nThis is record numbe".equals(new String(result)) ||
                "\nThis is record number".equals(new String(result)));
        ...
        // read the last record
        //expResult = "This is record number3\r\n\r\n";
        result = instance.readNextRecord();
        if (result == null) {
            fail("Unexpected IO error has occurred");
        }
    ...
    public void testReadNextRecordCase5() throws Exception {
        ...
        assertTrue("\r\nThis is re||cord num".equals(new String(result)) ||
                "\nThis is re||cord numb".equals(new String(result)));
