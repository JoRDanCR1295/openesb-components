...
package com.sun.encoder.hl7.i18n;
 ...
 * internationalized Bundle.properties files.  A normal Logger object will be created through the
 * Logger.getLogger() method provided by the Java APIs.
 */
public class Messages {
    
    private static final String MY_BUNDLE_NAME =
        "com.sun.encoder.hl7.i18n.messages.Bundle";
    private static final String DEFAULT_BUNDLE_NAME = "messages.Bundle";
    private static final Logger logger =
        Logger.getLogger(Messages.class.getName(), MY_BUNDLE_NAME);
   ...
   /**
     * Retrieves a Logger object.  A Logger is retrieved from
