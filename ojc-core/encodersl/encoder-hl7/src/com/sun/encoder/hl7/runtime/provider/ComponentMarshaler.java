 ...
 * @author sun
*/
final class ComponentMarshaler extends BaseMarshaler {
    ...
    public Marshaler startElement(String uri, String localName,
        ...
        if (!mIsFirst) {
            switch (mModel.getParticleType()) {
                ...
                case SchemaParticle.CHOICE:
                    errMsg = mMessages.getString("HL7ENC-E0010.Failed_handling_repetitive_subcomponent",
        ...
        if (mMatchResult.mResult == MatchResult.MATCH_ELEMENT) {
            if (!MarshalHandler.isSimpleContent(mMatchResult.mElementType)) {
                errMsg = mMessages.getString("HL7ENC-E0011.Element_must_be_simple_content_type",
                    new Object[]{uri, localName});
                throw new SAXException(errMsg);
            }
        }
