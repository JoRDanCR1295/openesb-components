...
public class MainGenerator {
    ...
    public static void main(String[] args) {
        ...
        version = "2.3";
        String encodersl = System.getProperty("JV_SRCROOT");
        if (encodersl == null) {
            encodersl = "C:/OpenSourceProjects/open-jbi-components/";
        }
        dbLocation = encodersl + "ojc-core/encodersl/encoder-hl7/metadata/hl7_56.mdb";
        outputLocation = encodersl + "ojc-core/encodersl/encoder-hl7/dist/xsd/" + version;
