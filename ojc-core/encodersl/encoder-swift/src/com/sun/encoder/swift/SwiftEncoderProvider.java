...
/**
 * Implementation of encoder provider for Swift.
 *  
 * @author Jun Xu
 * @since 6.0
 * @version 
 */
public class SwiftEncoderProvider implements EncoderProvider {

    private EncoderType mEncoderType;
    
    public String getIdentification() {
        return "swiftencoder-1.0";
    }
    
    /**
     * Instantiates an Swift encoder.
     * 
    ...
    /**
     * Instantiates a collection of Swift encoders.
     * 
    ...
    /**
     * Instantiates a Swift encoder.  Supports passing in additional properties.
     * 
     * @see com.sun.encoder.EncoderProvider#newEncoder(com.sun.encoder.MetaRef,
    ...
    public Encoder newEncoder(MetaRef metaRef, URIResolver uriResolver,
        ...
        SwiftEncoder encoder = new SwiftEncoder(mEncoderType, properties);
        encoder.setMeta(metaRef);
        return encoder;
    }

    /**
     * Instantiates a collection of Swift encoders.  Supports passing in
