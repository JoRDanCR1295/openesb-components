...
public class MashupSEComponent implements Component {
    ...
    public MashupSEComponent() {
        mComponentLifeCycle = new MashupSELifeCycle(this);
        mServiceUnitManager = new MashupSEServiceUnitManager(this);
    }
    ...
    public void setMashupMapEntryTable(MashupMapEntryTable mapEntryTable) {
        this.mMapEntryTable = mapEntryTable;
    }
    ...
    public org.w3c.dom.Document getServiceDescription(ServiceEndpoint endpoint) {
        ...
        MashupMapEntry mashupMapEntry = mMapEntryTable.findMashupEntry(operation,
                service);
        Definition def = mashupMapEntry.getWsdl();
        WSDLWriter writer = new WSDLWriterImpl();
        try {
            wsdlDocument = writer.getDocument(def);
        } catch (WSDLException ex) {
            Logger.getLogger(MashupSEComponent.class.getName()).log(Level.SEVERE, null, ex);
        }
        return wsdlDocument;
    }
