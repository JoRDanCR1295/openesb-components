...
public class MashupMapEntry {
	 ...
	 */
	private MashupMapEntry(String serviceUnitName, 
						String type, 
						QName partnerLink,
						QName portType, 
						QName operation, 
	...
	public static MashupMapEntry newRequestReplyService(
			...
			String file,
			Definition wsdl) {
		return new MashupMapEntry(serviceUnitName, REQUEST_REPLY_SERVICE,
				partnerLink, portType, operation, file, null, null, null, null,
				wsdl);
	}

	public static MashupMapEntry newFilterOneWay(String serviceUnitName,
			QName partnerLink, QName portType, QName operation, String file,
			QName outPartnerLink, QName outPortType, QName outOperation,
			Definition wsdl) {
		return new MashupMapEntry(serviceUnitName, FILTER_ONE_WAY, partnerLink,
				portType, operation, file, outPartnerLink, outPortType,
				outOperation, null, wsdl);
	}

	public static MashupMapEntry newFilterRequestReply(String serviceUnitName,
			QName partnerLink, QName portType, QName operation, String file,
			QName outPartnerLink, QName outPortType, QName outOperation,
			String replyFile, Definition wsdl) {
		return new MashupMapEntry(serviceUnitName, FILTER_REQUEST_REPLY,
