...
public class DBConnectionParameters implements Cloneable, Comparable {    
    ...
    private static final Messages mMessages = Messages.getMessages(DBConnectionParameters.class);
    ...
    public void parseXML(Element xmlElement) throws BaseException {
        try {
            ...
            throw new BaseException(LOG_CATEGORY + mMessages.getString("EDMSE-E0121.Parsing_Error"), ex);
        }
    }
