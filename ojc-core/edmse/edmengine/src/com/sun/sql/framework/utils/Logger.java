        ...
        try {
            ...
            if (cfgClass != null) {
                ...
                if ("debug".equalsIgnoreCase(System.getProperty("run.mode"))) {
                    Logger.fine(mMessages.getString("EDMSE-F0223.reading_configurationFile"));
                }

                Method configureAndWatch = cfgClass.getMethod("configureAndWatch", new Class[] { String.class});
                if (url == null) {
                    Logger.fine(mMessages.getString("EDMSE-F0224.Can't_find_configFile") + configFile + mMessages.getString("EDMSE-F0225.using_file_search"));
            ...
            Logger.fine(mMessages.getString("EDMSE-F0226.error_configuring_Log4jLogger"));
