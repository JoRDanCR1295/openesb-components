...
public class Attribute implements Cloneable {
    ...
    public Attribute(Attribute src) throws BaseException {
        if (src == null) {
            throw new IllegalArgumentException(mMessages.getString("EDMSE-E0131.can_not_create_new_instance") + src);
        }
    ...
    public Attribute(String name, Object value) {
        if (StringUtil.isNullString(name)) {
            throw new IllegalArgumentException(mMessages.getString("EDMSE-E0132.empty_name_value"));
        }

        if (value == null) {
            throw new IllegalArgumentException(mMessages.getString("EDMSE-E0133.null_objectRef"));
        }

        attributeType = value.getClass().getName();
        if (!Attribute.isValidType(attributeType)) {
            throw new IllegalArgumentException(mMessages.getString("EDMSE-E0134.invalid_AttributeType") + attributeType);
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        try {
            ...
            throw new CloneNotSupportedException(mMessages.getString("EDMSE-E0135.can_not_create_clone") + this.toString());
        }
        return attr;
    }
    ...
    private void createValueFor(String value, String typeName) throws BaseException {
        if (StringUtil.isNullString(typeName)) {
            throw new IllegalArgumentException(mMessages.getString("EDMSE-E0136.empty_typeName"));
        }

        if (!isValidType(typeName)) {
            throw new IllegalArgumentException(mMessages.getString("EDMSE-E0134.invalid_AttributeType")+ typeName);
        }
        ...
        if (typeName.equals(List.class.getName()) || typeName.equals(ArrayList.class.getName())) {
            ...
            try {
                ...
                throw new BaseException(mMessages.getString("EDMSE-E0137.constructor_does_not_exists")+ typeName, e);
            } catch (Exception e) {
                throw new BaseException(mMessages.getString("EDMSE-E0138.classLoad_error")+"'" + attributeType + "'.", e);
            }
        }
    }
}
