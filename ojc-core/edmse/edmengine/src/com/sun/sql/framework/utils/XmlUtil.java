...
public class XmlUtil {
    ...
    public static String escapeXML(String string) {
        String escapedStr = (string == null) ? "":StringUtil.replaceInString(string, XML_ILLEGALS, XML_ALLOWABLES);
        return escapedStr;
    }
    ...
    public static Element loadXMLFile(BufferedReader reader) {
        ...
        if (reader == null) {
            Logger.print(Logger.ERROR, LOG_CATEGORY, mMessages.getString("EDMSE-E0140.Invalid_stream"));
        }
        ...
        try {
            ...
            Logger.printThrowable(Logger.ERROR, LOG_CATEGORY, null, mMessages.getString("EDMSE-E0141.Could_not_load_XML") + reader, e);
        }
        return modelElement;
    }
    ...
    public static Element loadXMLFile(String fileName, ClassLoader classLoader) {
        ...
        if (StringUtil.isNullString(fileName)) {
            Logger.print(Logger.ERROR, LOG_CATEGORY, mMessages.getString("EDMSE-E0142.Invalid_Filename"));
        }
        ...
        try {
            ...
            if (istream == null) {
                ...
                if (istream == null) {
                    Logger.print(Logger.ERROR, LOG_CATEGORY, "configure", mMessages.getString("EDMSE-E0143.configure_ERROR")+ fileName);
                    return null;
                }
            }
            ...
            if (element == null) {
                throw new BaseException(LOG_CATEGORY, fileName + mMessages.getString("EDMSE-E0144.is_empty"));
            }
        } catch (Exception e) {
            Logger.printThrowable(Logger.ERROR, LOG_CATEGORY, null, mMessages.getString("EDMSE-E0145.Could_not_load") + fileName, e);
        } finally {
            if (istream != null) {
                try {
                    istream.close();
    ...
    public static Element transform(URL xslFileUrl, Element sourceElem) throws BaseException {
        try {
            ...
            throw new BaseException(mMessages.getString("EDMSE-E0146.can_not_transform_source_document"), th);
        }
