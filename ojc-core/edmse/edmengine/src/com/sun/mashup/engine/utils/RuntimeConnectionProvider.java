        ...
        if(jndiResourceName != null && !"".equalsIgnoreCase(jndiResourceName)) {
            ...
            try {
                ...
                try {
                    ...
                    Logger.getLogger(RuntimeConnectionProvider.class.getName()).log(Level.SEVERE, null, ex);
                    throw new AxionException(mMessages.getString("EDMSE-E0117.unable_to_Load_DriverClass"), ex);
                }
                conn = DriverManager.getConnection(url, userName, password);
            } catch (SQLException ex) {
                Logger.getLogger(RuntimeConnectionProvider.class.getName()).log(Level.SEVERE, null, ex);
                throw new AxionException(mMessages.getString("EDMSE-E0118.creatingConnection_Failed"), ex);
            }
