 ...
 */
public class Jbi4CorbaRuntimeException extends RuntimeException {

    /**
     * Serial Version UID.
     */
    private static final long serialVersionUID = 8309654013669032549L;
     ...
     */
    public Jbi4CorbaRuntimeException(final String message) {
     ...
     * @param    cause    The cause of the exception.
     */
    public Jbi4CorbaRuntimeException(final Throwable cause) {
