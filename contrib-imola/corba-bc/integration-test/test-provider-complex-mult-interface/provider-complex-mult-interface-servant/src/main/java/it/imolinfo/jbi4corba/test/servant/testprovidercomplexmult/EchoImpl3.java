...
import it.imolinfo.jbi4corba.test.testprovidercomplexmult.EchoComplex3POA;
 ...
 */
public class EchoImpl3 extends EchoComplex3POA {

  /**
   * logger.
   */
  private static Logger log = Logger.getLogger(EchoImpl3.class.getName());
  ...
  // ==========================================
    ...
    public StructOfStruct echoStructOfStruct(StructOfStruct v) {
        log.info("StructOfStruct echoStructOfStruct(StructOfStruct) " + "- message received: " + v);
         v.internalStruct.fieldString="Interface3";
        return v;
    }
