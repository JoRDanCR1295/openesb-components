...
/**
* it/imolinfo/jbi4corba/test/testprovidercomplexmult/VTPrimiHelper.java .
...
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/testprovidercomplexmult/VTPrimi:1.0";


  public static void insert (org.omg.CORBA.Any a, it.imolinfo.jbi4corba.test.testprovidercomplexmult.VTPrimi that)
  {
  ...
  public static it.imolinfo.jbi4corba.test.testprovidercomplexmult.VTPrimi extract (org.omg.CORBA.Any a)
  {
  ...
  public static it.imolinfo.jbi4corba.test.testprovidercomplexmult.VTPrimi read (org.omg.CORBA.portable.InputStream istream)
  {
    return (it.imolinfo.jbi4corba.test.testprovidercomplexmult.VTPrimi)((org.omg.CORBA_2_3.portable.InputStream) istream).read_value (id ());
  }

  public static void write (org.omg.CORBA.portable.OutputStream ostream, it.imolinfo.jbi4corba.test.testprovidercomplexmult.VTPrimi value)
  {
