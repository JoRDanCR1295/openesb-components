...
/**
* rttitypes/TempUnion1Helper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from RttiPragmaPrefix.idl
* Wednesday, July 22, 2009 4:13:00 PM CEST
*/

abstract public class TempUnion1Helper
{
  private static String  _id = "IDL:3hh4.123/rttitypes/TempUnion1:1.0";

  public static void insert (org.omg.CORBA.Any a, rttitypes.TempUnion1 that)
  {
  ...
  public static rttitypes.TempUnion1 extract (org.omg.CORBA.Any a)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      _members0[2] = new org.omg.CORBA.UnionMember (
        ...
        _tcOf_members0,
        null);
      __typeCode = org.omg.CORBA.ORB.init ().create_union_tc (rttitypes.TempUnion1Helper.id (), "TempUnion1", _disTypeCode0, _members0);
    }
    return __typeCode;
  }
  ...
  public static rttitypes.TempUnion1 read (org.omg.CORBA.portable.InputStream istream)
  {
    rttitypes.TempUnion1 value = new rttitypes.TempUnion1 ();
    short _dis0 = (short)0;
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, rttitypes.TempUnion1 value)
  {
