...
/**
* rttitypes/TempUnionHelper.java .
...
{
  private static String  _id = "IDL:3hh4.123/rttitypes/TempUnion:1.0";

  public static void insert (org.omg.CORBA.Any a, rttitypes.TempUnion that)
  {
  ...
  public static rttitypes.TempUnion extract (org.omg.CORBA.Any a)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      _members0[2] = new org.omg.CORBA.UnionMember (
        ...
        _tcOf_members0,
        null);
      __typeCode = org.omg.CORBA.ORB.init ().create_union_tc (rttitypes.TempUnionHelper.id (), "TempUnion", _disTypeCode0, _members0);
    }
    return __typeCode;
  }
  ...
  public static rttitypes.TempUnion read (org.omg.CORBA.portable.InputStream istream)
  {
    rttitypes.TempUnion value = new rttitypes.TempUnion ();
    short _dis0 = (short)0;
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, rttitypes.TempUnion value)
  {
