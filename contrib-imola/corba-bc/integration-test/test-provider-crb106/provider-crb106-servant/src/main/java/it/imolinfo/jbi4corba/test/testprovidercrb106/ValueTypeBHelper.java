...
/**
* it/imolinfo/jbi4corba/test/testprovidercrb106/ValueTypeBHelper.java .
...
// value type
abstract public class ValueTypeBHelper
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/testprovidercrb106/ValueTypeB:1.0";


  public static void insert (org.omg.CORBA.Any a, it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeB that)
  {
  ...
  public static it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeB extract (org.omg.CORBA.Any a)
  {
    ...
    if (__typeCode == null)
    {
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          __active = true;
          org.omg.CORBA.ValueMember[] _members0 = new org.omg.CORBA.ValueMember[15];
          ...
          _members0[13] = new org.omg.CORBA.ValueMember ("fieldDouble", 
              ...
              null, 
              org.omg.CORBA.PUBLIC_MEMBER.value);
          // ValueMember instance for typeA
          _tcOf_members0 = it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeAHelper.type ();
          _members0[14] = new org.omg.CORBA.ValueMember ("typeA", 
              it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeAHelper.id (), 
              _id, 
              "", 
              _tcOf_members0, 
              null, 
              org.omg.CORBA.PUBLIC_MEMBER.value);
          __typeCode = org.omg.CORBA.ORB.init ().create_value_tc (_id, "ValueTypeB", org.omg.CORBA.VM_NONE.value, null, _members0);
          __active = false;
        }
      }
    }
  ...
  public static it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeB read (org.omg.CORBA.portable.InputStream istream)
  {
    return (it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeB)((org.omg.CORBA_2_3.portable.InputStream) istream).read_value (id ());
  }

  public static void write (org.omg.CORBA.portable.OutputStream ostream, it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeB value)
  {
