...
/**
* it/imolinfo/jbi4corba/test/testprovidercrb106/ValueTypeAHelper.java .
...
// value type
abstract public class ValueTypeAHelper
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/testprovidercrb106/ValueTypeA:1.0";


  public static void insert (org.omg.CORBA.Any a, it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeA that)
  {
  ...
  public static it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeA extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[14] = new org.omg.CORBA.ValueMember ("typeB", 
              ...
              null, 
              org.omg.CORBA.PUBLIC_MEMBER.value);
          __typeCode = org.omg.CORBA.ORB.init ().create_value_tc (_id, "ValueTypeA", org.omg.CORBA.VM_NONE.value, null, _members0);
          __active = false;
        }
      }
    }
  ...
  public static it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeA read (org.omg.CORBA.portable.InputStream istream)
  {
    return (it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeA)((org.omg.CORBA_2_3.portable.InputStream) istream).read_value (id ());
  }

  public static void write (org.omg.CORBA.portable.OutputStream ostream, it.imolinfo.jbi4corba.test.testprovidercrb106.ValueTypeA value)
  {
