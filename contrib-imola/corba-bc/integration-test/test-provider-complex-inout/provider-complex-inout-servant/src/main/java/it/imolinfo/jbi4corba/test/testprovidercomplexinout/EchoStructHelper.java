...
/**
* it/imolinfo/jbi4corba/test/testprovidercomplexinout/EchoStructHelper.java .
...
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/testprovidercomplexinout/EchoStruct/EchoStruct:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[13] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (it.imolinfo.jbi4corba.test.testprovidercomplexinout.EchoStructHelper.id (), "EchoStruct", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    it.imolinfo.jbi4corba.test.testprovidercomplexinout.EchoStruct value = new it.imolinfo.jbi4corba.test.testprovidercomplexinout.EchoStruct ();
