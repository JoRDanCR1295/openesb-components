...
/**
* it/imolinfo/jbi4corba/test/testprovideranytypes/TempUnionHelper.java .
...
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/testprovideranytypes/TempUnion/TempUnion:1.0";

  public static void insert (org.omg.CORBA.Any a, it.imolinfo.jbi4corba.test.testprovideranytypes.TempUnion that)
  {
  ...
  public static it.imolinfo.jbi4corba.test.testprovideranytypes.TempUnion extract (org.omg.CORBA.Any a)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      _members0[2] = new org.omg.CORBA.UnionMember (
        ...
        _tcOf_members0,
        null);
      __typeCode = org.omg.CORBA.ORB.init ().create_union_tc (it.imolinfo.jbi4corba.test.testprovideranytypes.TempUnionHelper.id (), "TempUnion", _disTypeCode0, _members0);
    }
    return __typeCode;
  }
  ...
  public static it.imolinfo.jbi4corba.test.testprovideranytypes.TempUnion read (org.omg.CORBA.portable.InputStream istream)
  {
    it.imolinfo.jbi4corba.test.testprovideranytypes.TempUnion value = new it.imolinfo.jbi4corba.test.testprovideranytypes.TempUnion ();
    short _dis0 = (short)0;
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, it.imolinfo.jbi4corba.test.testprovideranytypes.TempUnion value)
  {
