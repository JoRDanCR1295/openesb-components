...
/**
* it/imolinfo/jbi4corba/test/testprovideroneway/EchoStructHelper.java .
...
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/testprovideroneway/EchoStruct/EchoStruct:1.0";

  public static void insert (org.omg.CORBA.Any a, it.imolinfo.jbi4corba.test.testprovideroneway.EchoStruct that)
  {
  ...
  public static it.imolinfo.jbi4corba.test.testprovideroneway.EchoStruct extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[13] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (it.imolinfo.jbi4corba.test.testprovideroneway.EchoStructHelper.id (), "EchoStruct", _members0);
          __active = false;
        }
      }
    }
  ...
  public static it.imolinfo.jbi4corba.test.testprovideroneway.EchoStruct read (org.omg.CORBA.portable.InputStream istream)
  {
    it.imolinfo.jbi4corba.test.testprovideroneway.EchoStruct value = new it.imolinfo.jbi4corba.test.testprovideroneway.EchoStruct ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, it.imolinfo.jbi4corba.test.testprovideroneway.EchoStruct value)
  {
