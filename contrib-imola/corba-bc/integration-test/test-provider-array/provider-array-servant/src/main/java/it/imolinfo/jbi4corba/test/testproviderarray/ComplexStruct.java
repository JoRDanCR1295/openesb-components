...
/**
* it/imolinfo/jbi4corba/test/testproviderarray/ComplexStruct.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from EchoArray.idl
* venerdì 20 febbraio 2009 12.20.53 CET
*/

public final class ComplexStruct implements org.omg.CORBA.portable.IDLEntity
{
  ...
  public ComplexStruct (boolean _fieldBoolean, char _fieldChar, char _fieldWChar, byte _fieldOctet, String _fieldString, String _fieldWString, short _fieldShort, short _fieldUnsignedShort, int _fieldLong, int _fieldUnsignedLong, long _fieldLongLong, long _fieldUnsignedLongLong, float _fieldFloat, double _fieldDouble)
  {
