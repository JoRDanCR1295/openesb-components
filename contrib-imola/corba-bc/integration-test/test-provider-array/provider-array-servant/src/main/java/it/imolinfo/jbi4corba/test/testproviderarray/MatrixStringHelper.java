...
/**
* it/imolinfo/jbi4corba/test/testproviderarray/MatrixStringHelper.java .
...
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/testproviderarray/MatrixString:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_array_tc (2, __typeCode );
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (it.imolinfo.jbi4corba.test.testproviderarray.MatrixStringHelper.id (), "MatrixString", __typeCode);
    }
    return __typeCode;
  }
