...
/**
* it/imolinfo/jbi4corba/test/testproviderarray/ComplexStructHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from EchoArray.idl
* venerdì 20 febbraio 2009 12.20.53 CET
*/

abstract public class ComplexStructHelper
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/testproviderarray/ComplexStruct:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[13] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (it.imolinfo.jbi4corba.test.testproviderarray.ComplexStructHelper.id (), "ComplexStruct", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    it.imolinfo.jbi4corba.test.testproviderarray.ComplexStruct value = new it.imolinfo.jbi4corba.test.testproviderarray.ComplexStruct ();
