...
/**
* it/imolinfo/jbi4corba/test/testproviderarray/ArrayBooleanHelper.java .
...
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/testproviderarray/ArrayBoolean:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (it.imolinfo.jbi4corba.test.testproviderarray.ArrayBooleanHelper.id (), "ArrayBoolean", __typeCode);
    }
    return __typeCode;
  }
