...
/**
* it/imolinfo/jbi4corba/test/testproviderarray/ArrayUnsignedLongLongHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from EchoArray.idl
* venerdì 20 febbraio 2009 12.20.53 CET
*/

abstract public class ArrayUnsignedLongLongHelper
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/testproviderarray/ArrayUnsignedLongLong:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (it.imolinfo.jbi4corba.test.testproviderarray.ArrayUnsignedLongLongHelper.id (), "ArrayUnsignedLongLong", __typeCode);
    }
    return __typeCode;
  }
