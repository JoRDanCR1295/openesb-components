...
/**
* it/imolinfo/jbi4corba/test/testprovidercomplex/MySequenceHelper.java .
...
{
  private static String  _id = "IDL:3hh4.123/it/imolinfo/jbi4corba/test/testprovidercomplex/MySequence:1.0";
  ...
  {
    return (it.imolinfo.jbi4corba.test.testprovidercomplex.MySequence)((org.omg.CORBA_2_3.portable.InputStream) istream).read_value (id ());
  }
