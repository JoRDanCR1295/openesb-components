...
import it.imolinfo.jbi4corba.test.testprovidercomplex.EchoComplex;
import it.imolinfo.jbi4corba.test.testprovidercomplex.EchoComplexException;
import it.imolinfo.jbi4corba.test.testprovidercomplex.EchoComplexHelper;
import it.imolinfo.jbi4corba.test.testprovidercomplex.EchoComplexPOA;
 ...
 */
public class EchoComplexImpl extends EchoComplexPOA {

    /**
     * logger.
     */
    private static Logger log = Logger.getLogger(EchoComplexImpl.class.getName());
        ...
        Thread servantThread = new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    EchoComplexImpl helloImpl = new EchoComplexImpl();
                    log.info("EchoComplexImpl ..." + helloImpl);
