...
/**
* it/imolinfo/jbi4corba/test/webservice/generator/echocomplex/typedefany/mycharArrHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from EchoTypeDefAny.idl
* mercoledì 10 febbraio 2010 15.46.40 CET
*/

abstract public class mycharArrHelper
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/webservice/generator/echocomplex/typedefany/mycharArr:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (it.imolinfo.jbi4corba.test.webservice.generator.echocomplex.typedefany.mycharArrHelper.id (), "mycharArr", __typeCode);
    }
    return __typeCode;
  }
