...
/**
* it/imolinfo/jbi4corba/test/webservice/generator/echocomplex/typedefany/EchoStructHelper.java .
...
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/webservice/generator/echocomplex/typedefany/EchoStruct:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[14] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (it.imolinfo.jbi4corba.test.webservice.generator.echocomplex.typedefany.EchoStructHelper.id (), "EchoStruct", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    it.imolinfo.jbi4corba.test.webservice.generator.echocomplex.typedefany.EchoStruct value = new it.imolinfo.jbi4corba.test.webservice.generator.echocomplex.typedefany.EchoStruct ();
    ...
    value.fieldAny = istream.read_any ();
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, it.imolinfo.jbi4corba.test.webservice.generator.echocomplex.typedefany.EchoStruct value)
  {
    ...
    ostream.write_any (value.fieldAny);
  }
