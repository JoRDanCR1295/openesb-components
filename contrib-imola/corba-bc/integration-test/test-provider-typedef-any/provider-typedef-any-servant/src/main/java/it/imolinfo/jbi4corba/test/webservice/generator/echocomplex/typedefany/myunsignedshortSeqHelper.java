...
/**
* it/imolinfo/jbi4corba/test/webservice/generator/echocomplex/typedefany/myunsignedshortSeqHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from EchoTypeDefAny.idl
* mercoledì 10 febbraio 2010 15.46.40 CET
*/

abstract public class myunsignedshortSeqHelper
{
  private static String  _id = "IDL:it/imolinfo/jbi4corba/test/webservice/generator/echocomplex/typedefany/myunsignedshortSeq:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (it.imolinfo.jbi4corba.test.webservice.generator.echocomplex.typedefany.myunsignedshortSeqHelper.id (), "myunsignedshortSeq", __typeCode);
    }
    return __typeCode;
  }
