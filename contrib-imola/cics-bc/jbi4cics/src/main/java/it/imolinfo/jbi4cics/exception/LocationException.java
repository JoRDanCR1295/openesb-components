 ...
 */
public class LocationException extends Jbi4cicsException {
    
    /**
     * Serial Version UID.
     */
    private static final long serialVersionUID = 5288346360855488633L;
     ...
     */
    public LocationException(String message, Object[] args) {
        super(message, args);
    }
     ...
     */
    public LocationException(String message, Object[] args, Throwable cause) {
