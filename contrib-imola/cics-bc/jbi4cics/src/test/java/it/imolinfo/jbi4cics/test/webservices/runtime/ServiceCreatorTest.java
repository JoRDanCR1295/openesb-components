...
public class ServiceCreatorTest extends BaseCommareaTest {
  private static Log log = LogFactory.getLog(ServiceCreatorTest.class);



  public ServiceCreatorTest(String arg) {
    super(arg);
  }
  ...
  public void testServiceCreator() {
    try {
      ...
      final ServiceDescriptor serviceDescriptor = new ServiceDescriptor();
