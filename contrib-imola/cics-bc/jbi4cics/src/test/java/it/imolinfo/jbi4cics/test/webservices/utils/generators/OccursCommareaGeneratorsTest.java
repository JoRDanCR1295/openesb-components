...
public class OccursCommareaGeneratorsTest extends BaseCommareaTest {
  
  public static Log log = LogFactory.getLog(OccursCommareaGeneratorsTest.class);

  
  public OccursCommareaGeneratorsTest(String arg) {
    super(arg);
  }
