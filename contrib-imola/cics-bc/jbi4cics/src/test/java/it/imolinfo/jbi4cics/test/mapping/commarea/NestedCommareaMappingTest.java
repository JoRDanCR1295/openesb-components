...
public class NestedCommareaMappingTest extends TestCase {
  private static Log log = LogFactory.getLog(NestedCommareaMappingTest.class);

  public static final String DeafultHostCodePage = "CP1144";

  public NestedCommareaMappingTest(String arg) {
    super(arg);
  }
  ...
  public final void testOneNest() {
    try {
      ...
      cobolTypeDescriptorInternal.setType(CobolType.NESTED_COMMAREA);
      ...
      internalBean.setPluto("pluto");
      ExternalBean externalBean=new ExternalBean();
      externalBean.setNested(internalBean);
