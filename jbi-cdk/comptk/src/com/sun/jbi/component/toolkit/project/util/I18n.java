...
/**
 * Internationalization utility for Component Development Kit.
...
public class I18n extends LocalizationSupport {
	...
	protected I18n() {
		super(Pattern.compile("(CDK-[4-7]\\d\\d\\d)(: )(.*)", Pattern.DOTALL),
			  "", null);
	}

    /**
     * Creates a localized message for the CDK library.
	...
	public static String loc(String message, Object... params) {
	    return mI18n.format(message, params);
