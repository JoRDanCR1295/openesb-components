...
/**
 * Ant task that copies multiple files specified by one property (separated by path separator ';').
 * It merely delegates to copy task for every file in the files attribute.
 * The files attribute is parsed as a Path structure.
 *
 * (original code copied from web project's copyfiles ant task)
 * 
 * @author chikkala 
 * 
 */
