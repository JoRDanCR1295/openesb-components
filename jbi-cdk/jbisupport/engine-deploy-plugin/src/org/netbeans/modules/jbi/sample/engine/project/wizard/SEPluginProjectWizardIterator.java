 ...
 */
package org.netbeans.modules.jbi.sample.engine.project.wizard;
...
import org.netbeans.modules.jbi.sample.engine.project.SEPluginProjectGenerator;
import org.netbeans.modules.jbi.sample.engine.project.SEPluginProjectProperties;
...
public class SEPluginProjectWizardIterator implements WizardDescriptor.InstantiatingIterator {
    ...
    protected Set<Object> createProjectSpecificArtifacts(FileObject projectDirFO ) throws IOException {
        ...
        try {
            ...
            String[] suArtifacts = {"SampleWSDL.wsdl"};
