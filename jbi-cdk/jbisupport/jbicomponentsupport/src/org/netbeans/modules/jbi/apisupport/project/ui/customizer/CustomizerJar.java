...
public class CustomizerJar extends JPanel implements HelpCtx.Provider {
    ...
    public CustomizerJar( CustomizerUIModel uiProperties ) {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(excludeMessage, java.util.ResourceBundle.getBundle("org/netbeans/modules/jbi/apisupport/project/ui/customizer/Bundle").getString("LBL_CustomizerJar_ExcludeMessage"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
