...
class PlatformNode extends AbstractNode implements ChangeListener {
    ...
    private static final String PLATFORM_ICON = "org/netbeans/modules/jbi/apisupport/project/ui/resources/platform";    //NOI18N
    ...
    private static class PlatformProvider implements PropertyChangeListener {
        ...
        public JavaPlatform getPlatform () {
            if (platformCache == null) {
                ...
                platformCache = JbiCompProjectUtil.getActivePlatform (platformSystemName);
