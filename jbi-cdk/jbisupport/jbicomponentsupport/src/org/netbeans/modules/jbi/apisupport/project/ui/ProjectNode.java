...
class ProjectNode extends AbstractNode {
    ...
    private static final String PROJECT_ICON = "org/netbeans/modules/jbi/apisupport/project/ui/resources/projectDependencies.gif";    //NOI18N
               ...
               public void run() {
                   ...
                   if (cp != null) {
                       ...
                       for (int i=0; i<entries.length; i++) {
                           if (!entryId.equals(JbiCompProjectProperties.getAntPropertyName(entries[i]))) {
