...
/**
 * This is a sample service implementation that takes the input as xml document and the xslt file
 * to apply the xslt transformation on the input xml and return the transformed output xml.
 * This implementation of the service is invoked when a InOut message exchange is processed to
 * invoke a service provided by the engine.
 *
 * @author chikkala
 */
public interface XSLTService {
     ...
     * by applying the xslt in the file specified in xsltPath
