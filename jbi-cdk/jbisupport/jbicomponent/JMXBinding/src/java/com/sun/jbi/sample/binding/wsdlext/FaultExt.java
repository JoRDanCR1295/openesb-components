...
/**
 * This interface and its implementation represents the java model for binding operation fault 
 * extension element.
 * The inner classes FaultExtImpl implements the interface and the FaultExtSerializer provides
 * the serializer and deserializer implementation. The implemenation and serializer classes will
 * be registered with the ExtensionRegistry to process the binding operation fault extension element 
...
public interface FaultExt  extends  ExtConstants, ExtensibilityElement, java.io.Serializable {
    ...
    /**
     * This class provides the serializer and deserializer implementation for binding operation fault
