...
/**
 * This class is a helper class for processing the wsdl extensions. It has methods that help
 * locate the extension elements and return the java models corresponds to the extension elements.
 * @author chikkala
 */
public final class WSDLExtHelper {
     ...
     * @param endpointName name of the port under which to lookup for the port extension.
    ...
    /**
     * @return OperationExt java object corresponding to the operation extension element under binding
     */
    ...
    /**
     * @return InputExt java object corresponding to input extension element of the
     * the binding operation under binding
     */
    ...
    /**
     * @return OutputExt java object corresponding to output extension element of the
     * the binding operation under binding
     */
    ...
    /**
     * @return FaultExt java object corresponding to fault extension element of the
     * the binding operation under binding
     */
