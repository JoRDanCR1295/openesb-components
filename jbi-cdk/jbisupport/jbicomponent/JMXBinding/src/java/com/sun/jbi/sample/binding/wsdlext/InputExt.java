...
/**
 * This interface and its implementation represents the java model for binding operation input 
 * extension element.
 * The inner classes InputExtImpl implements the interface and the InputExtSerializer provides
 * the serislizer and deserializer implementation. The implementation and serializer classes will
 * be registered with the ExtensionRegistry to process the binding operation input extension element 
