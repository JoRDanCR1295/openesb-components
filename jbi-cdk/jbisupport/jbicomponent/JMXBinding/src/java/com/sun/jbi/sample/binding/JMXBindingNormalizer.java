...
/**
 * This class is a concrete implementation of the AbstractNormalizer to implement normalize jmx
 * binding specific concrete messages to jbi wrapper messages and denormalize the jbi wrapper messages
 * to jmx binding specific messages. The jmx binding concrete message has "message" as the root element
 * that contains the part elements as its children. for example
 *   <jmxbc:message xmlns:jmxbc="http://java.sun.com/jbi/sample/jmx-bc/envelope/"
 ...
 *       <msgns:part2-elememnt/>
 *       <wsdlns:part3-type-name> <!-- part has type attribute. so element of the type are wrapped with part name -->
 *          <msgns:part3-type-elements>
 *       <wsdlns:part3-type-name>
 *   </jmxbc:message>
 *
 * This is the sample code that demonstrate how to normalize and denormalize messages to/from jbi
 * wrapper from/to concrete messages specific to a binding protocol
 *
 * @author chikkala
 */
public class JMXBindingNormalizer extends AbstractNormalizer {
    ...
    /**
     * normalizes the jmx binding protocol specific concrete message to jbi normalized message
     */
    ...
    /**
     * denormalizes the jbi message to the jmx binding protocol specific concrete message.
     */
