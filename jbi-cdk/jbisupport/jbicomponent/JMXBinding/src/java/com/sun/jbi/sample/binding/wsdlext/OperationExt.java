 ...
 * extension element.
 * The inner classes OperationImpl implements the interface and the OperationExtSerializer provides
 * the serilizer and deserializer implementation. The implementation and serializer classes will
 * be registered with the ExtensionRegistry to process the binding operation extension element
