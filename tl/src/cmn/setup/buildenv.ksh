...
export CVS_SRCROOT_PREFIX CVS_CO_ROOT CVSIGNORE
CVS_SRCROOT_PREFIX="open-jbi-components"
CVS_CO_ROOT="${SRCROOT}/.."
...
if [ "$IIS_MAVEN_REPO_LOCAL" != "" ]; then
    ...
    MAVEN_REPO_LOCAL="$MAVEN_REPOSITORY"
fi
...
M2_HOME=$TOOLROOT/java/maven209
...
#######
export JV_SRCROOT JV_TOOLROOT JV_MAVEN_REPO_LOCAL JV_MAVEN_DISTROOT JV_GFBASE JV_NETBEANS_HOME
