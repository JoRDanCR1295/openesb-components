...
import org.glassfish.openesb.engine.screenscrapingse.datatypes.*;
...
public class ScriptExecutorImpl implements ScriptExecutor {
     ...
     private static Logger msLogger = Logger.getLogger(ScriptExecutorImpl.class.getName());
    ...
    public ScriptExecutorImpl(String aSURootPath) {
        ...
        try {
            ...
            mJaxbCtx = JAXBContext.newInstance("org.glassfish.openesb.engine.screenscrapingse.datatypes",
                    mUrlCl);
    ...
    public Source processScript(Source aInputSource) {
        ...
        //Instantiating the script Engine
        mEngine = ScreenScrapingSERepository.GetInstance().getScriptEngine(lEngineName);

        if (mEngine == null) {
            msLogger.severe(I18n.loc("SSSECRORE-1005: The SCRIPT ENGINE IS NOT LOADED PLESE CHECK"));
        ...
        try {
            ...
            msLogger.fine(I18n.loc("SSSECORE-1106: THE INPUT SOURCE FROM SCRIPTUTIL CLASS IS ...{0}",lBuff.toString()));
    ...
    public Script getScript(Source aInputSource) {
        msLogger.info(I18n.loc("SSSECORE-1009: Inside the getScript object method"));
    ...
    private Object executeScriptFrmFile(Script.ScriptSource.File aFile,
            Script aScript) {
        Object lResult = null;
        String lFilePath = aFile.getFilePath();

        if (lFilePath == null) {
            msLogger.severe(I18n.loc("SSSECORE-1005: The String pathname is null erroneous"));
        ...
        if (aFile.isPreloaded() == true) {
            ...
            msLogger.severe(I18n.loc("SSSECORE-1011: The ScriptFile path in the SU is ::{0}", lFilePath));
        }
        ...
        try {
            ...
            msLogger.severe(I18n.loc("SSSECORE-1012: Binding exception {0}", ex.toString()));
            ex.printStackTrace();
        } finally {
            if (lFileRdr != null) {
                try {
    ...
    private Object executeScriptFrmUrl(Script.ScriptSource.Url aUrl,
            Script aScript) {
        Object lResult = null;
        FileReader lFileRdr = null;
        ...
        try {
            ...
            msLogger.severe(I18n.loc("SSSECORE-1015: Failure to execute from URL :: {0}", ex.getMessage()));
            ...
            if (lFileRdr != null) {
                try {
                    ...
                    msLogger.severe(I18n.loc("SSSECORE-1016: Unable to close the FileReader",ex.getMessage()));
     ...
     * @return DOCUMENT ME!
     */
    private Object executeScriptFrmInlinedTxt(
            Script.ScriptSource.Inlined aInLined, Script aScript) {
        Object lResult = null;
        ...
        try {
            ...
            msLogger.severe(I18n.loc("SSSECORE-1017: Failed to execute the Inlined Script..{0}",ex.getMessage()));
    ...
    public Bindings getScriptBindings(Script aScript) {
        msLogger.info("Inside the ScriptContext method");
        ...
        if (lInput == null) {
            msLogger.warning(I18n.loc("Input Parameters are null :: Ensure if its Ok"));
        } else {
    ...
    public Source createOutputSource(Script aInputScript, Object aResult) {
        ...
        try {
            ...
            JAXBElement lElement = new JAXBElement(mQname, aResult.getClass(),
                    aResult);
            ...
            msLogger.info(I18n.loc("SSSECORE-1019: PRINTING THE OUTMSG....{0}",(ScriptXMLHelper.readFromDOMSource((DOMSource) lResult)).toString()));
          
        } catch (Exception ex) {
            msLogger.severe(I18n.loc("SSSECORE-1020: exception ...{0}", ex.getMessage()));
        }
    ...
    public void setNsLocal(String lUri, String lLocal) {
        msLogger.info(I18n.loc("SSSECORE-1021: NAMESPACE URI IS {0}", lUri));
        msLogger.info(I18n.loc("SSSECORE-1022: LOCAL PART NAME IS {0} ", lLocal));
        mQname = new QName("http://www.zaz-consulting.com/screenscraping/screenscrapingse",
                "Localresult");
    }
        ...
        class PrashLoader extends ClassLoader {
            ...
            public void printClasses() {
                ...
                for (Package elem : lPackages) {
                    System.out.println("The loader Packages are " +
                            elem.getName());
                }
            }
        }
