    ...
    public static boolean compile(String[] args, OutputStream out) {
        ...
        try {
            ...
            try {
                ...
                log.severe(I18n.loc("SSSECORE-1006: JavaCompilerHelper_NOSUCHMETHOD_ERROR {compile}"));

                return false;
            }
        } catch (ClassNotFoundException e) {
            log.severe(I18n.loc("SSSECORE-1007: JavaCompilerHelper_CLASSPATH_ERROR com.sun.tools.javac.Main {0}",
                    e.getMessage()));

            return false;
        } catch (SecurityException e) {
             log.severe(I18n.loc("SSSECORE-1008: JavaCompilerHelper Security exception {0}",
                    e.getMessage()));
            return false;
        }
    }
