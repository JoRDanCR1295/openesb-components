...
public class SetBufferAddressOrder {
    ...
    public static final byte ORDER_ID = 0x11;

    public static int processOrder(Session3270 session, byte[] buf, int bufPos) {
        byte[] screenAddress = new byte[]{buf[bufPos + 1], buf[bufPos + 2]};
        int offset = AddressConvertUtil.getOffsetFromScreenAddress(screenAddress);
