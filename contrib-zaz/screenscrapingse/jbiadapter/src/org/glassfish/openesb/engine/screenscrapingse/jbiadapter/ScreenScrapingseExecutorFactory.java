...
import org.glassfish.openesb.engine.screenscrapingse.process.ScriptInfoVO.WorkingMode;
import org.glassfish.openesb.engine.screenscrapingse.process.ScriptExecutorImpl;
import org.glassfish.openesb.engine.screenscrapingse.process.SUScriptExecutor;
 ...
 * @author rchen
 */
public class ScreenScrapingseExecutorFactory {
private static Logger mLogger = Logger.getLogger(ScreenScrapingseExecutorFactory.class.getName());
    ...
    private ScreenScrapingseExecutorFactory()
    {
    };
    /**
     * DOCUMENT ME!
