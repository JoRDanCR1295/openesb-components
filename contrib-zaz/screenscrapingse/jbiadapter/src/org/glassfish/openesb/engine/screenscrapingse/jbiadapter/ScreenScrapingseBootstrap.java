...
public class ScreenScrapingseBootstrap extends AbstractBootstrap { //implements Bootstrap {
    ...
    protected Object initInstallMBean(ComponentContext ctx)
        ...
        try {
            ...
            return new ScreenScrapingseConfiguration(ctx, getConfig());
        }
        catch (Exception e) {
            throw error(e, "SSSE-6001: ScreenScrapingseBootstrap installation MBean failed to initialize: {0}",
                        e.getMessage());
        }
    }
