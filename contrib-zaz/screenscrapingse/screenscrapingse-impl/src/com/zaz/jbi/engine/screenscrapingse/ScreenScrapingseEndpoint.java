 ...
 */
public class ScreenScrapingseEndpoint extends AbstractEndpoint {

    private static Logger msLogger = Logger.getLogger(ScreenScrapingseEndpoint.class.getName());
