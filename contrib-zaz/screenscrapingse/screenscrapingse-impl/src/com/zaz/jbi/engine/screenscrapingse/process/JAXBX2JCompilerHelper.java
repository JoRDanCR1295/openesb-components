...
public class JAXBX2JCompilerHelper {
    ...
    class MyErrorListener implements ErrorListener {
        ...
        public void error(SAXParseException exception) {
            mLogger.log(Level.SEVERE, "JAXBX2JCompilerHelper_cannot_parse_xsd",
                    exception.getMessage());
        }

        public void fatalError(SAXParseException exception) {
            mLogger.log(Level.SEVERE,
                    "JAXBX2JCompilerHelper_fatal_error_message",
                    exception.getMessage());
        }

        public void warning(SAXParseException exception) {
            mLogger.log(Level.SEVERE, "JAXBX2JCompilerHelper_warning_message",
                    exception.getMessage());
        }

        public void info(SAXParseException exception) {
            mLogger.log(Level.SEVERE, "JAXBX2JCompilerHelper_Info_message",
                    exception.getMessage());
        }
    }
}
