...
refer the test case files at ${drivertest_dir}/bpelse\correlation\MatchingInstanceTwoCorrJBI\test\rec_pick_correlate_any

Covers the following tests.

Initiating Activities   - Receive (correlation1 [initiate=yes]) and Pick (correlation2 [initiate=yes])
