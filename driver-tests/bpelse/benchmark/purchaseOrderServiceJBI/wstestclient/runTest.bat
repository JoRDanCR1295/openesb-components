...
:Run
java -cp bin;%APPSERVER_HOME%\lib\appserv-ws.jar;%APPSERVER_HOME%\lib\javaee.jar test.Test http://localhost:18181/purchaseOrderService/purchaseOrderPort %THREAD% %COUNT% %VERIFY%
GOTO SUCCESS
