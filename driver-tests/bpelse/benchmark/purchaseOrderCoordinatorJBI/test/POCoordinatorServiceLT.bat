...
:RUN_TEST
set SOAP_UI_HOME=\tools\soapui-1.7.5
call ..\..\openEsbSoapUILT.bat -lwarmupPOCoordinatorServiceLT purchaseOrderCoordinator-soapui-project.xml
call ..\..\openEsbSoapUILT.bat -lPOCoordinatorServiceLT -r purchaseOrderCoordinator-soapui-project.xml