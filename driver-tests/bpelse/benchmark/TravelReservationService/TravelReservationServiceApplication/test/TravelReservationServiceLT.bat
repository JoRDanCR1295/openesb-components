...
:RUN_TEST
set SOAP_UI_HOME=\tools\soapui-1.7.5
call ..\..\..\openEsbSoapUILT.bat -lwarmupTRTestCaseLoadTest TravelReservationService-soapui-project.xml
call ..\..\..\openEsbSoapUILT.bat -lTRTestCaseLoadTest -r TravelReservationService-soapui-project.xml