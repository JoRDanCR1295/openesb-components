...
:Run
java -cp bin;%APPSERVER_HOME%\lib\appserv-ws.jar;%APPSERVER_HOME%\lib\javaee.jar test.Test http://localhost:8080/purchaseOrderService/purchaseOrderService %THREAD% %COUNT% %VERIFY%
GOTO SUCCESS
