...
:RUN_TEST
set SOAP_UI_HOME=\tools\soapui-1.7.5
call ..\..\openEsbSoapUILT.bat -lwarmupFunctionalBMLoadTest functionalBenchMark-soapui-project.xml
call ..\..\openEsbSoapUILT.bat -lfunctionalBMLoadTest -r functionalBenchMark-soapui-project.xml