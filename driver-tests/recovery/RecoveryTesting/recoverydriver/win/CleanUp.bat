...
%JAVA_HOME%/bin/java -Xdebug -Xrunjdwp:transport=dt_socket,address=3999,server=y,suspend=n -cp ../dist/recoverydriver.jar;%AS_HOME%/javadb/lib/derbyclient.jar;%ORACLE_DRIVER_PATH% com.sun.jbi.recoverytest.CleanUp test.properties
