 ...
 *
 */
public class FileBasedJMSMessageSender extends Thread {
    ...
    public FileBasedJMSMessageSender(Properties properties, Properties testCaseProperties) {
        ...
        String inputTemplateFile = testCaseProperties.getProperty("InputTemplateFile");
        try {
            this.testMessageTemplate = Utility.readTextFromFile(inputTemplateFile, "UTF-8"); 
        } catch (IOException e) {
        ...
        try {
            do {
                try {
                    ...
                    String testMessage = Utility.replaceAll(testMessageTemplate, "${counter}", counter + "");
