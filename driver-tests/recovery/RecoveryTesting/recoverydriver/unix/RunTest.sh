...
$JAVA_HOME/bin/java -cp ../dist/recoverydriver.jar:$AS_HOME/lib/activation.jar:$AS_HOME/lib/appserv-admin.jar:$AS_HOME/lib/install/applications/jmsra/imqjmsra.jar:$AS_HOME/lib/appserv-rt.jar:$AS_HOME/lib/j2ee.jar:$AS_HOME/lib/javaee.jar:$AS_HOME/jbi/lib/jbi_rt.jar:$AS_HOME/lib/mail.jar:$AS_HOME/javadb/lib/derbyclient.jar:$ORACLE_DRIVER_PATH:$JAVA_HOME/lib/tools.jar com.sun.jbi.recoverytest.JMSBasedRecoveryTest test.properties
