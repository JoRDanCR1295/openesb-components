...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns2="http://sun.com/UploadTest/EmplInput">
    <xsl:template match="/">
        <xsl:element name="EmployeeOutput" namespace="http://sun.com/UploadTest/EmplOutput">
