...
public class LocalFileService implements org.netbeans.j2ee.wsdl.file.FILEPortType {
    ...
    @WebServiceRef(wsdlLocation = "META-INF/wsdl/client/FTP_JOE/FTP_JOE.wsdl")
    ...
    public org.netbeans.xml.schema.responsemessageschema.ResponseType fileOperation(org.netbeans.xml.schema.requestmessageschema.RequestType part1) {
        ...
        try { // Call Web Service Operation
            ...
            client.ResponseType result = port.ftpOperation(part1c);
            response.setResponseElement(result.getResponseElement());
            System.out.println("Result = "+result);
        } catch (Exception ex) {
            // TODO handle custom exceptions here
            response.setResponseElement("Exception=" + ex.getLocalizedMessage());
        } 
        return response;
    }
