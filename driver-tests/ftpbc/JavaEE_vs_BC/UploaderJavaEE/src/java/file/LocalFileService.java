...
public class LocalFileService implements org.netbeans.j2ee.wsdl.file.FILEPortType {
    ...
    public org.netbeans.xml.schema.simpleschema.ResponseType fileOperation(org.netbeans.xml.schema.simpleschema.RequestType part1) {
        org.netbeans.xml.schema.simpleschema.ResponseType response = new org.netbeans.xml.schema.simpleschema.ResponseType();
        try { // Call Web Service Operation
            ...
            response.setResponseElement("send one way message to ftp remote returned without error.");
        } catch (Exception ex) {
            // TODO handle custom exceptions here
            response.setResponseElement("Exception when messaging over ftp : e=" + ex.getLocalizedMessage());
        }
        return response;
    }
