...
public class InitiatorSEServiceUnitManager implements ServiceUnitManager {
    private static final Logger mLogger = Logger.getLogger(InitiatorSEServiceUnitManager.class.getName());
    ...
    public InitiatorSEServiceUnitManager(Component component) {
    }
