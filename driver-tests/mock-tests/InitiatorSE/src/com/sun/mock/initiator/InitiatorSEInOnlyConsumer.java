...
public class InitiatorSEInOnlyConsumer extends AbstractInOnlyConsumer  {

	private static final Logger LOGGER = Logger.getLogger(InitiatorSEInOnlyConsumer.class.getName());
	private InitiatorEngine mEngine;
	
	private AcceptManager mAcceptManager;


	public InitiatorSEInOnlyConsumer(InitiatorEngine engine, AcceptManager acceptManager) {
		this.mEngine = engine;
