...
public class InitiatorSELifeCycle extends AbstractComponentManager {
    
	private static final Logger mLogger = Logger.getLogger(InitiatorSELifeCycle.class.getName());
    private ComponentContext mContext;
    private DeliveryChannel mChannel;
    private InitiatorEngine mEngine;
    private Definition mDefinition;
    
    private  InitiatorSEInOutConsumer inOutConsumer;
    
    
    public InitiatorSELifeCycle() {
    }
    ...
    public void init(ComponentContext context) throws javax.jbi.JBIException {
        ...
        mEngine = new InitiatorEngine ();
        
        InitiatorSEInOutProvider inOutProvider = new InitiatorSEInOutProvider(this.mDefinition, mEngine);  
        ...
        InitiatorSEInOnlyConsumer inOnlyConsumer = new InitiatorSEInOnlyConsumer(mEngine, getAcceptManager());
        router.register(PatternRoleKey.IN_ONLY_CONSUMER, 
                new SimpleProcessorFactory(inOnlyConsumer));        
        
       
        inOutConsumer = new InitiatorSEInOutConsumer(this.mDefinition, mEngine, getAcceptManager());
...
//        }
        ...
        inOutConsumer.executeInTransaction();
        //mEngine.start();
    ...
    protected ServiceUnitManager initServiceUnitManager() {
        return new InitiatorSEServiceUnitManager(this);
    }
    ...
    private void initDefinition() {
    	try {
    		URL wsdl = InitiatorSELifeCycle.class.getResource("/com/sun/mock/initiator/resources/transferAmount.wsdl");
    		InputStream wsdlIn = InitiatorSELifeCycle.class.getResourceAsStream("/com/sun/mock/initiator/resources/transferAmount.wsdl");
