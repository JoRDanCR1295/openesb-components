...
public class ParticipantSE1InOnlyConsumer extends AbstractInOnlyConsumer  {

	private static final Logger LOGGER = Logger.getLogger(ParticipantSE1InOnlyConsumer.class.getName());
	private Participant1Engine mEngine;
	
	private AcceptManager mAcceptManager;


	public ParticipantSE1InOnlyConsumer(Participant1Engine engine, AcceptManager acceptManager) {
		this.mEngine = engine;
