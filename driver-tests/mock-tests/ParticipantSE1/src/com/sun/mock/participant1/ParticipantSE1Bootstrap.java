...
public class ParticipantSE1Bootstrap implements Bootstrap {

    private static final Logger mLogger = Logger.getLogger(ParticipantSE1Bootstrap.class.getName());

    private InstallationContext mContext;
    private ObjectName mInstallerExtName;

    public ParticipantSE1Bootstrap() {
    }
