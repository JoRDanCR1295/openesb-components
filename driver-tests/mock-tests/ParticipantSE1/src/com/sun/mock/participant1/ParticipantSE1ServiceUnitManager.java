...
public class ParticipantSE1ServiceUnitManager implements ServiceUnitManager {
    private static final Logger mLogger = Logger.getLogger(ParticipantSE1ServiceUnitManager.class.getName());
    ...
    public ParticipantSE1ServiceUnitManager(Component component) {
    }
