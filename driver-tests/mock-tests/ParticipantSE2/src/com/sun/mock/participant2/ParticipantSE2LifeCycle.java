...
public class ParticipantSE2LifeCycle extends AbstractComponentManager {
    private static final Logger mLogger = Logger.getLogger(ParticipantSE2LifeCycle.class.getName());
    private ComponentContext mContext;
    private DeliveryChannel mChannel;
    private Participant2Engine mEngine;
    private Definition mDefinition;
    
    public ParticipantSE2LifeCycle() {
    }
    ...
    public void init(ComponentContext context) throws javax.jbi.JBIException {
        ...
        mDefinition = Util.initDefinition();
        
        mEngine = new Participant2Engine ();
        
        ParticipantSE2InOutProvider inOutProvider = new ParticipantSE2InOutProvider(this.mDefinition, mEngine, getAcceptManager() );  
        ...
        ParticipantSE2InOnlyConsumer inOnlyConsumer = new ParticipantSE2InOnlyConsumer(mEngine, getAcceptManager());
    ...
    public void start() throws javax.jbi.JBIException {
        ...
        super.start();
        try {
        	ServiceEndpoint serviceEndpoint = mContext.activateEndpoint(ServiceConstants.PARTICIPANT2_IN_OUT_SERVICE_NAME, ServiceConstants.PARTICIPANT2_IN_OUT_ENDPOINT_NAME);
        } catch(Exception ex) {
    ...
    protected ServiceUnitManager initServiceUnitManager() {
        return new ParticipantSE2ServiceUnitManager(this);
    }
