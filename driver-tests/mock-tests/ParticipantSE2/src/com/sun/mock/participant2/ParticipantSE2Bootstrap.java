...
public class ParticipantSE2Bootstrap implements Bootstrap {

    private static final Logger mLogger = Logger.getLogger(ParticipantSE2Bootstrap.class.getName());

    private InstallationContext mContext;
    private ObjectName mInstallerExtName;

    public ParticipantSE2Bootstrap() {
    }
