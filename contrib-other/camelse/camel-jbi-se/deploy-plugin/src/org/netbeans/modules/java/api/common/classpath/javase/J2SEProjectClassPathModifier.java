...
public class J2SEProjectClassPathModifier extends ProjectClassPathModifierImplementation {
                        ...
                        public Boolean run() throws Exception {
                            ...
                            for (int i=0; i< classPathRoots.length; i++) {
                                ...
                                if (performHeuristics) {
                                    f = J2SEProjectClassPathModifier.this.performSharabilityHeuristics(classPathRoots[i], helper.getAntProjectHelper());
                                } else {
                    ...
                    new Mutex.ExceptionAction<Boolean>() {
                        public Boolean run() throws IOException {
                            ...
                            for (int i=0; i< libraries.length; i++) {
                                ...
                                if (helper.getAntProjectHelper().isSharableProject()) {
    ...
    private String getClassPathProperty (final SourceGroup sg, final String type) {
        ...
        final String classPathProperty = J2SEProjectProperties.JAVAC_CLASSPATH;
