...
public class J2SESources implements Sources, PropertyChangeListener, ChangeListener  {
    ...
    private static final String BUILD_DIR_PROP = "${" + SEPluginProjectProperties.BUILD_DIR + "}";    //NOI18N
    private static final String DIST_DIR_PROP = "${" + SEPluginProjectProperties.DIST_DIR + "}";    //NOI18N
    ...
    private void register(SourceRoots roots) {
        ...
        for (int i = 0; i < propNames.length; i++) {
            ...
            String includes = "${" + SEPluginProjectProperties.INCLUDES + "}"; // NOI18N
            String excludes = "${" + SEPluginProjectProperties.EXCLUDES + "}"; // NOI18N
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (SourceRoots.PROP_ROOT_PROPERTIES.equals(propName) ||
            SEPluginProjectProperties.BUILD_DIR.equals(propName)  ||
            SEPluginProjectProperties.DIST_DIR.equals(propName)) {
            this.fireChange();
        }
    }
