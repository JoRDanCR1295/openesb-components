...
import org.netbeans.modules.java.api.common.classpath.javase.J2SEProjectClassPathExtender;
import org.netbeans.modules.java.api.common.classpath.javase.J2SEProjectClassPathModifier;
import org.openesb.components.camelse.nb.plugin.project.customizer.SEPluginProjectCustomizerProvider;
import org.netbeans.modules.java.api.common.SourceRoots;
import org.netbeans.modules.java.api.common.ant.UpdateHelper;
import org.netbeans.modules.java.api.common.classpath.javase.ClassPathProviderImpl;
import org.netbeans.modules.java.api.common.classpath.javase.queries.BinaryForSourceQueryImpl;
...
public final class SEPluginProject implements Project, AntProjectListener {
    ...
    public SEPluginProject(AntProjectHelper helper) throws IOException {
        ...
        this.refHelper = new ReferenceHelper(helper, aux, this.evaluator);
        this.genFilesHelper = new GeneratedFilesHelper(helper);
        this.updateHelper = new UpdateHelper(new UpdateProjectImpl(this, helper, aux), helper);
        
        this.cpProvider = new ClassPathProviderImpl(this.helper, getEvaluator(), getSourceRoots(),getTestSourceRoots()); //Does not use APH to get/put properties/cfgdata
        this.cpMod = new J2SEProjectClassPathModifier(this, this.updateHelper, getEvaluator(), refHelper);
    ...
    private FileBuiltQueryImplementation createFileBuiltQuery() {
        return QuerySupport.createFileBuiltQuery(helper, getEvaluator(), getSourceRoots(), getTestSourceRoots());
...
////                );
    ...
    private SharabilityQueryImplementation createSharabilityQuery() {
        return QuerySupport.createSharabilityQuery(helper, getEvaluator(), getSourceRoots(), getTestSourceRoots());
...
////                      );
    ...
    public synchronized SourceRoots getSourceRoots() {
        if (this.sourceRoots == null) { //Local caching, no project metadata access
            this.sourceRoots = SourceRoots.create(updateHelper, evaluator, refHelper, SEPluginProjectType.PROJECT_CONFIGURATION_NAMESPACE, "source-roots", false, "src.{0}{1}.dir");
        }
    ...
    public synchronized SourceRoots getTestSourceRoots() {
        if (this.testRoots == null) { //Local caching, no project metadata access
            this.testRoots = SourceRoots.create(updateHelper, evaluator, refHelper, SEPluginProjectType.PROJECT_CONFIGURATION_NAMESPACE, "test-roots", true, "test.{0}{1}.dir");
        }
...
////        sourcesHelper.addTypedSourceRoot(srcLoc, JavaProjectConstants.SOURCES_TYPE_JAVA,
////                srcLabel, null, null);     
...
////    }
    ...
    private Sources createSources() {
        return new J2SESources (this.helper, getEvaluator(), getSourceRoots(), getTestSourceRoots());
    }
    
    private Lookup createLookup(AuxiliaryConfiguration aux) {

        SubprojectProvider spp = refHelper.createSubprojectProvider();
        FileEncodingQueryImplementation encodingQuery = QuerySupport.createFileEncodingQuery(getEvaluator(), SEPluginProjectProperties.SOURCE_ENCODING);
        ...
        return Lookups.fixed(new Object[] {
            ...
            this.cpMod,
            encodingQuery,
            QuerySupport.createSourceLevelQuery(getEvaluator()),
            QuerySupport.createCompiledSourceForBinaryQuery(helper, getEvaluator(), getSourceRoots(), getTestSourceRoots()),
            QuerySupport.createTemplateAttributesProvider(helper, encodingQuery),
            new BinaryForSourceQueryImpl(getSourceRoots(), getTestSourceRoots(), this.helper,  getEvaluator())
...
// Private inner classes -------------------------------------------------------
        ...
        protected void projectOpened() {
            ...
            ProjectManager.mutex().writeAccess(new Mutex.Action() {
                public Object run() {                    
                    ...
                    if (!ep.containsKey(SEPluginProjectProperties.INCLUDES)) {
                        ep.setProperty(SEPluginProjectProperties.INCLUDES, "**"); // NOI18N

                    }
                    if (!ep.containsKey(SEPluginProjectProperties.EXCLUDES)) {
                        ep.setProperty(SEPluginProjectProperties.EXCLUDES, ""); // NOI18N
    ...
    private static final class RecommendedTemplatesImpl implements RecommendedTemplates, PrivilegedTemplates {
        ...
        private static final String[] PRIVILEGED_NAMES = new String[] {
            ...
            "Templates/Camel/AppRouteBuilder.java",    // NOI18N
