...
<xsl:stylesheet version="1.0"
                ...
                xmlns:jbiproject="http://www.netbeans.org/ns/jbimodules/camel-jbi-se/1"
  ...
  - cleanup
    ...
    ===================
            ...
            <target name="-do-compile">
                ...
                <javac srcdir="${{src.dir}}" destdir="${{build.classes.dir}}" classpath="${{javac.classpath}}" debug="true"
                source="${{javac.source}}" target="${{javac.target}}" encoding="${{source.encoding}}" />
                <xsl:comment> copy resources from source dir to build dir </xsl:comment>
                <copy todir="${{build.classes.dir}}" overwrite="true" >  <!-- copy resources from ${src} -->
    ...
    ===============
             ...
             <target name="mock-test">
                <xsl:attribute name="depends">init,jar</xsl:attribute>
                <xsl:attribute name="description">Runs the camel jbi module using Java SE without JBI environment.</xsl:attribute>
