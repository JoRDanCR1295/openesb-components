 ...
 * @author chikkala
 */
public class JBIBridgeComponent extends DefaultComponent<JBIBridgeExchange> {
    ...
    protected Endpoint<JBIBridgeExchange> createEndpoint(String uri, String remaining, Map parameters)
            throws Exception {
