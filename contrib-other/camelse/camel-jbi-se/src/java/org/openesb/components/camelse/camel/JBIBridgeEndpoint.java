 ...
 * @author chikkala
 */
public class JBIBridgeEndpoint extends DefaultEndpoint<JBIBridgeExchange> {
...
//        LOG.info("Setting endpoint operation " + operation);
     ...
     */
    public Producer<JBIBridgeExchange> createProducer() throws Exception {
     ...
     */
    public Consumer<JBIBridgeExchange> createConsumer(Processor proc) throws Exception {
