...
public class ProviderSEEndpoint extends ProviderEndpoint implements MessageExchangeListener {
    ...
    private XACMLService mPolicyService;
     ...
     * endpoint.
     */
    public XACMLService getPolicyService() {
        return this.mPolicyService;
    }
    /**
     ...
     */
    public XACMLFileLocator getXSLTFileLocator() {
    ...
    public void doInit() throws JBIException {
        ...
        this.mXACMLFileLocator = su.getXACMLFileLocator();
        this.mPolicyService = XACMLService.getInstance(this.getComponentContext(),this.getLogger());
    }
    /**
