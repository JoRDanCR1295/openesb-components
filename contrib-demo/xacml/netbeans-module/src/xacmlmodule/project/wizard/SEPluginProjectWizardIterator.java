 ...
 */
package xacmlmodule.project.wizard;
...
import xacmlmodule.project.SEPluginProjectGenerator;
import xacmlmodule.project.SEPluginProjectProperties;
...
// sblais nov 19th 2007, unused imports
...
public class SEPluginProjectWizardIterator implements WizardDescriptor.InstantiatingIterator {
    ...
    protected Set<Object> createProjectSpecificArtifacts(FileObject projectDirFO) throws IOException {
        ...
        try {
            ...
            String[] suArtifacts = {
                    //"SampleWSDL.wsdl", Commented out, should not change wiht the SUs.
                    "groupPolicy.xml", // XACML base policy file.
                    "XACMLRequestData.xsd", // Data format of the xacml request
                    "SampleXACMLAccess.wsdl", // XACML WSDL 
                    "xacmlmap.properties"}; // SU mapping of policies. Should this be 
                                            // be multiple to allow for multiple SUs?
        ...
        // TODO: add any additional default service unit artifacts here.
        // FileObject suArtifactFO = copyResource(srcDirFO, "su-artifact.xml", "resources/su-artifact.xml");
        // resultSet.add(suArtifactFO);
        // sblais 19 nov 2007, do we actually need to keep this?
