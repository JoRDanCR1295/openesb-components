...
public interface SUDescriptor {
    ...
    public static class SUDescriptorImpl implements SUDescriptor {
        ...
        private boolean mIsFor${artifactId};
        
        protected SUDescriptorImpl(boolean isFor${artifactId}) {
            this.mIsFor${artifactId} = isFor${artifactId};
        ...
        public boolean isFor${artifactId}() {
            return this.mIsFor${artifactId};
        }
