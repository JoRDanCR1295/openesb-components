/*
 * BindingComponent-archetypeTest.java
 */
package bindingtest;
import net.openesb.component.BindingComponent-archetype.test.JBIComponentTestClient;
import net.openesb.component.BindingComponent-archetype.test.JMXBindingTestClient;
