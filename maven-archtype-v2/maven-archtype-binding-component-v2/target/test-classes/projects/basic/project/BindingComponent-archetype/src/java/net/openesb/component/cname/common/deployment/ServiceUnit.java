...
import net.openesb.component.BindingComponent-archetype.common.deployment.SUDescriptor.Service;
...
public abstract class ServiceUnit {
    ...
    protected void loadServiceDefinitions() throws Exception {
        ...
        boolean isForBinding = this.getSUDescriptor().isForBindingComponent-archetype();
