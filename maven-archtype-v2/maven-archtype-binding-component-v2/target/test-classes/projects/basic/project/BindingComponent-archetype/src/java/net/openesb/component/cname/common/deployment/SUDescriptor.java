...
public interface SUDescriptor {
    ...
    boolean isForBindingComponent-archetype();
    ...
    public static class SUDescriptorImpl implements SUDescriptor {
        ...
        private boolean mIsForBindingComponent-archetype;
        
        protected SUDescriptorImpl(boolean isForBindingComponent-archetype) {
            this.mIsForBindingComponent-archetype = isForBindingComponent-archetype;
        ...
        public boolean isForBindingComponent-archetype() {
            return this.mIsForBindingComponent-archetype;
        }
