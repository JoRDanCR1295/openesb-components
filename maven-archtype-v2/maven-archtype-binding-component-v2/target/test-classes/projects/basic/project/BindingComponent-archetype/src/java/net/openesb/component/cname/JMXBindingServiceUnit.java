...
import net.openesb.component.BindingComponent-archetype.common.deployment.ConsumerEndpoint;
import net.openesb.component.BindingComponent-archetype.common.deployment.ProviderEndpoint;
import net.openesb.component.BindingComponent-archetype.common.deployment.SUDescriptor.Consumes;
import net.openesb.component.BindingComponent-archetype.common.deployment.SUDescriptor.Provides;
import net.openesb.component.BindingComponent-archetype.common.deployment.ServiceUnit;
