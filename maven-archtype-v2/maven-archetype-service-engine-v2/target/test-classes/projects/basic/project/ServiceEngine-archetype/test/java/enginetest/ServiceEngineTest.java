/*
 * ServiceEngine-archetypeTest.java
 */

package enginetest;

import net.openesb.component.ServiceEngine-archetype.test.JBIComponentTestClient;
import net.openesb.component.ServiceEngine-archetype.test.SOAPBindingTestClient;
