...
public class WSDLProcessor {
     ...
     */
    public Binding createServiceEngine-archetypeBinding(Definition wsdl, QName interfaceName) {
     ...
     * @return a Binding contains service engine binding that is created for the portType.
     */
    public Binding createServiceEngine-archetypeBinding(Definition wsdl, QName interfaceName, QName serviceName, String endpointName ) {
        Binding binding = null;
        ...
        if ( port != null ) {
            ...
            binding = createServiceEngine-archetypeBinding(wsdl, interfaceName);
