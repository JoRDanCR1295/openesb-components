...
import net.openesb.component.ServiceEngine-archetype.common.deployment.SUDescriptor.Consumes;
import net.openesb.component.ServiceEngine-archetype.common.deployment.SUDescriptor.Provides;
import net.openesb.component.ServiceEngine-archetype.common.deployment.SUDescriptor.Service;
import net.openesb.component.ServiceEngine-archetype.common.wsdl.WSDLProcessor;
import java.io.File;
    ...
    protected void loadServiceDefinitions() throws Exception {
        ...
        for ( Service service : services ) {
            ...
            if ( providerAtEngine ) {
                ...
                wsdlProcessor.createServiceEngine-archetypeBinding(def,
