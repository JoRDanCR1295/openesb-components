...
/**
 * Provides a constant for the RSS Namespace.
 * Author: cgallemore
 * Date: May 8, 2007
 */
public class RSSConstants {
    /**
     * The name space for the RSS Binding Component.
     */
    public static final String RSS_NS_URI = "http://schemas.sun.com/jbi/wsdl-extensions/rss/";
    public static final String RSS_EXT_NS_URI = "http://xml.netbeans.org/schema/1.0/extensions/rssbc";
}
