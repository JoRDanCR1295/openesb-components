 ...
 * @author aegloff
 */
public class UDDIOperationOutput implements ExtensibilityElement, Serializable {
    private static final long serialVersionUID = 1L;
    public static final QName QNAME_OPERATION_OUTPUT = new QName(UDDIConstants.UDDI_NS_URI,
    ...
    public QName getElementType() {
        return UDDIOperationOutput.QNAME_OPERATION_OUTPUT;
    }
    ...
    public String toString() {
        ...
        builder.append("\nUDDI operation (");
        builder.append(UDDIOperationOutput.QNAME_OPERATION_OUTPUT);
        builder.append("):");
        builder.append("\nRequired=");
