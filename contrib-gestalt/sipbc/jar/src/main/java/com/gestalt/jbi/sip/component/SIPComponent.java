 ...
 * @author : csturtz
 */
public class SIPComponent extends AbstractComponent {
    public AbstractComponentLifeCycle createComponentLifeCycle(
        AbstractComponent abstractComponent) {
        return new SIPComponentLifeCycle(this);
    }

    public AbstractServiceUnitManager createServiceUnitManager(
        AbstractComponent abstractComponent) {
        return new SIPServiceUnitManager(this,
            new AbstractDeployer[] { new SIPWSDLDeployer(this) });
    }
}
