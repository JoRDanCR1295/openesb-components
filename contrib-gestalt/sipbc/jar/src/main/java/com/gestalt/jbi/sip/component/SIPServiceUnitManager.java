 ...
 * @author : csturtz
 */
public class SIPServiceUnitManager extends AbstractServiceUnitManager {
    public SIPServiceUnitManager(AbstractComponent abstractComponent,
        AbstractDeployer[] abstractDeployers) {
        super(abstractComponent, abstractDeployers);
    }
