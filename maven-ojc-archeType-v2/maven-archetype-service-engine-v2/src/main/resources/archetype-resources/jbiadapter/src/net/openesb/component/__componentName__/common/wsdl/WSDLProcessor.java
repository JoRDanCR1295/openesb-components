...
public class WSDLProcessor {
     ...
     */
    public Binding create${componentName}Binding(Definition wsdl, QName interfaceName) {
     ...
     * @return a Binding contains service engine binding that is created for the portType.
     */
    public Binding create${componentName}Binding(Definition wsdl, QName interfaceName, QName serviceName, String endpointName ) {
        Binding binding = null;
        ...
        if ( port != null ) {
            ...
            binding = create${componentName}Binding(wsdl, interfaceName);
